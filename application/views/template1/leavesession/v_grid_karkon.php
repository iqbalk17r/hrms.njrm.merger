...
*/	
	...
	$list_karkon=$this->m_stspeg->q_list_karkon()->result();
?>
																	...
																	<table id="example2" class="table table-bordered table-striped" style="border:3px solid black;">
																		<thead>
																			<tr>
																				...
																				<th style="border:2px solid black; font-size: 14px;">Keterangan</th>																	
																				<th style="border:2px solid black; font-size: 14px;">Jumlah Hari</th>																	
																								
																			</tr>
																		</thead>
																		<tbody>
																			<?php $no=0; foreach($list_karkon as $lu): $no++;?>
																			<tr>										
																				...
																				<td style="border:2px solid black; font-size: 10px;"><?php echo $lu->keteranganhari;?></td>
																				<td style="border:2px solid black; font-size: 10px;"><?php echo $lu->kuranghari.' Hari';?></td>
