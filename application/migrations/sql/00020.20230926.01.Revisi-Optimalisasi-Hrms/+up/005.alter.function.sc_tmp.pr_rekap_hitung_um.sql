-- Function: sc_tmp.pr_hitung_rekap_um(character, date, date)

-- DROP FUNCTION sc_tmp.pr_hitung_rekap_um(character, date, date);

CREATE OR REPLACE FUNCTION sc_tmp.pr_hitung_rekap_um(
