...
BEGIN
    ...
    INSERT INTO sc_trx.uangmakan (
        SELECT
            ...
            ta.checkout,
            CASE
                WHEN kdcabang <> 'SMGDMK' THEN
                    CASE
                        WHEN  checkin IS NULL AND checkout IS NULL AND
                        ...
                        WHEN 
                            ...
                            THEN besaran
                        WHEN  td.nodok IS NOT NULL THEN NULL
                        WHEN  th.nodok IS NOT NULL THEN NULL
                        ...
                        WHEN  checkin < jam_masuk AND checkout IS NULL AND
