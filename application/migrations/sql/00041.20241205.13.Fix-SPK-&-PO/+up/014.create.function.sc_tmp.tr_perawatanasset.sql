...
begin    
	...
	IF TG_OP ='INSERT' THEN 
		...
		IF (new.status='I') THEN 
			...
			vr_lastdoc:=right(max(nodok), 9)::numeric from sc_his.perawatanasset WHERE LEFT(nodok, 4) = 'PAS0';
			update sc_mst.nomor set prefix='PAS', docno=vr_lastdoc where dokumen='PERAWATAN-ASSET';
