...
DECLARE
    ...
    -- Tambahan Kolom "nokk, kdwilayahnominal, kdlvlgp, pinjaman, kdgradejabatan, deviceid, callplan"
    vr_nik CHARACTER(30);
BEGIN
    ...
    IF(vr_nik > '0') THEN
        UPDATE SC_MST.KARYAWAN SET
            ...
            nokk = new.nokk,
            kdwilayahnominal = new.kdwilayahnominal,
            kdlvlgp = new.kdlvlgp,
            pinjaman = new.pinjaman,
            kdgradejabatan = new.kdgradejabatan,
