...
VALUES
    ('WA:RESEND:PERIOD', 'PERIODE JEDA WAKTU NOTIFIKASI WHATSAPP', 3, NULL, NULL, 'T', 'PERIODE JEDA WAKTU PENGIRIMAN ULANG NOTIFIKASI WHATSAPP SATUAN JAM ', 'RKM', NULL, NOW(), NULL, 'DINAS')
