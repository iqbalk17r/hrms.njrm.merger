...
$$
BEGIN
    IF NOT EXISTS (SELECT column_name FROM information_schema.columns WHERE table_schema = 'sc_rep' AND table_name = 'declaration_cashbon' ) THEN
        CREATE TABLE sc_rep.declaration_cashbon(
            fc_branch char (6),
            fc_nik char (6),
            ...
            CONSTRAINT declaration_cashbon_pkey PRIMARY KEY (fc_branch,fc_nik,fv_declarationid,fv_cashbonid)
        );
    END IF;
END
$$
