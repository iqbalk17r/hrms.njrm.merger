-- Function: sc_trx.pr_capture_approvals_system()

-- DROP FUNCTION sc_trx.pr_capture_approvals_system();

CREATE OR REPLACE FUNCTION sc_trx.pr_capture_approvals_system()
