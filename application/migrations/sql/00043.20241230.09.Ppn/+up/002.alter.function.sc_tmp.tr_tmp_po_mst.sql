...
begin    
	...
	ELSEIF TG_OP ='UPDATE' THEN
		...
		ELSEIF (new.status='' and old.status!='') THEN	
				...
				round(round(a.ttlbrutto-round(round(round(a.ttlbrutto)*a.disc1/100)+round(round(round(a.ttlbrutto)*a.disc1/100)*round(a.disc2/100))+round(round(round(round(a.ttlbrutto)*a.disc1/100)*round(a.disc2/100))*round(a.disc3/100))))/(n_ppn::numeric/10))
				else 0 end,
				ttlppn=
				case when coalesce(b.pkp,'')='YES' then
				round(round(round(a.ttlbrutto-round(round(round(a.ttlbrutto)*a.disc1/100)+round(round(round(a.ttlbrutto)*a.disc1/100)*round(a.disc2/100))+round(round(round(round(a.ttlbrutto)*a.disc1/100)*round(a.disc2/100))*round(a.disc3/100))))/(n_ppn::numeric/10))*(n_ppn::numeric/100))
				else 0 end,
				ttlnetto=
					case 
					when coalesce(b.pkp,'')='YES' and coalesce(b.exppn,'')='EXC' then
					round(b.ttlbrutto-round(round(round(b.ttlbrutto)*b.disc1/100)+round(round(round(b.ttlbrutto)*b.disc1/100)*round(b.disc2/100))+round(round(round(round(b.ttlbrutto)*b.disc1/100)*round(b.disc2/100))*round(b.disc3/100)))/(n_ppn::numeric/10)) +
					round(round(round(b.ttlbrutto-round(round(round(b.ttlbrutto)*b.disc1/100)+round(round(round(b.ttlbrutto)*b.disc1/100)*round(b.disc2/100))+round(round(round(round(b.ttlbrutto)*b.disc1/100)*round(b.disc2/100))*round(b.disc3/100))))/(n_ppn::numeric/10))*(n_ppn::numeric/100))
