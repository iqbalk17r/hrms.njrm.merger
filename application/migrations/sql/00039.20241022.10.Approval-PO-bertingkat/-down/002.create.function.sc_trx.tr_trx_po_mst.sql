...
begin    
    ...
    ELSEIF TG_OP ='UPDATE' THEN
        ...
        IF (new.status='E' and old.status='A') THEN
			...
			/*delete from sc_trx.po_mst where nodok=new.nodok;
			delete from sc_trx.po_dtl where nodok=new.nodok;
			delete from sc_trx.po_dtlref where nodok=new.nodok;*/
...
select * from sc_trx.po_mst
--truncate sc_trx.po_mst,sc_trx.po_mst
