...
class Fiky_version
{
    ...
    protected $_CI;
       ...
       function __construct(){
           ...
           $this->_CI->load->library(array('Fiky_string','Fiky_menu','Fiky_encryption','Fiky_wilayah'));
    ...
    function version($p1,$p2,$p3,$p4){
        $this->_CI->fiky_encryption->first_template_license();
        $this->_CI->fiky_encryption->onExpireMacLock();
        $this->_CI->fiky_encryption->onExpireLc();
        /* CODE UNTUK VERSI */
        //$kodemenu='I.P.F.4';
        $kodemenu=$p1;
