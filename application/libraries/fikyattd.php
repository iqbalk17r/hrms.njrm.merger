...
/* 	function __construct(){
		...
		$this->_CI->load->model(array('master/m_','master/'));
        $this->_CI->load->library(array('encrypt'));

    } */
		
        //public function __construct($ip=null, $port=null) {
        public function connectAttd($ip, $port) {
            //$this->_CI=&get_instance()
			$this->ip = $ip;
            $this->port = $port;
            ...
            include_once(dirname(__FILE__) ."/zklib/zkconst.php");
            include_once(dirname(__FILE__) ."/zklib/zkconnect.php");
            include_once(dirname(__FILE__) ."/zklib/zkversion.php");
            include_once(dirname(__FILE__) ."/zklib/zkos.php");
            include_once(dirname(__FILE__) ."/zklib/zkplatform.php");
            include_once(dirname(__FILE__) ."/zklib/zkworkcode.php");
            include_once(dirname(__FILE__) ."/zklib/zkssr.php");
            include_once(dirname(__FILE__) ."/zklib/zkpin.php");
            include_once(dirname(__FILE__) ."/zklib/zkface.php");
            include_once(dirname(__FILE__) ."/zklib/zkserialnumber.php");
            include_once(dirname(__FILE__) ."/zklib/zkdevice.php");
            include_once(dirname(__FILE__) ."/zklib/zkuser.php");
            include_once(dirname(__FILE__) ."/zklib/zkattendance.php");
            include_once(dirname(__FILE__) ."/zklib/zktime.php");
			//return 'KINTIL';
			log_message('debug', "Fikyattd Class");
        }
