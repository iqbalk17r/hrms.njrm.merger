...
if(isset($_SESSION['standby'])){
	...
	$ad_dir = dirname(__FILE__) .'/files';// directory with scripts
	...
	<div class="loading" style="margin-top: 11%;">
		...
		<div class="loading__msg"><center><b style="font-size: 22px;"><a href="#" target="_blank" style="color: black;">Proteksi Situs</a> sedang melakukan check....</b><br><br>Tenang... Pemeriksaan ini hanya berlaku 1 kali terhadap perangkat anda..!!!<br> situs anda akan normal setelah semua berakhir !<br> This security wall Under license BY: <a href="#" target="_blank"> IT Nusantara Group 2019 </a> </center></div>
	</div>
