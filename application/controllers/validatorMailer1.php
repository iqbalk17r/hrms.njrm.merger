...
class ValidatorMailer extends CI_Controller{
    ...
    function download_pdf(){
        ...
        file_put_contents('assets/attachment/pdf_payroll/Slip Gaji.pdf', $output);
        //$this->fiky_pdf->stream("Slip Gaji.pdf");
...
<!--—this is space of 15px to separate two paragraphs ---->
			   ...
			   <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Nomor Dokumen</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.trim($lr->docno).'</td>
              </tr>
              <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Tanggal Dokumen</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.trim($lr->docdate1).'</td>
              </tr>
			   <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Aplikasi</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.trim($lr->erptype).'</td>
              </tr>
			   <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Jenis Dokumen</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.trim($lr->doctypename).'</td>
              </tr>
			  <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Pemohon</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.trim($lr->nmlengkap).'</td>
              </tr>';


            if (trim($doctype)==='MCTI') {
              $mailmessage.='<tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Tanggal Cuti</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['tgl_awal'].' s/d '.$dtlx['tgl_akhir'].'</td>
              </tr>
			  <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Jumlah Cuti</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['jumlah_cuti'].' Hari</td>
              </tr>
               <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Pelimpahan Ke Sdr/i</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['nmpelimpahan'].'</td>
              </tr>
              <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Keterangan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['keterangan'].'</td>
              </tr>
              ';
            } else if (trim($doctype)==='MIJN') {
                $mailmessage.='<tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Tanggal Ijin</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['tgl_kerja'].'</td>
              </tr>
			  <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Kategori</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['kategori'].'</td>
              </tr>
               <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Type Ijin</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['type_ijin'].'</td>
              </tr>
              <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Keterangan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
                ...
                $mailmessage.='<tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Tanggal Dinas</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['tgl_mulai'].' s/d '.$dtlx['tgl_selesai'].'</td>
              </tr>
			  <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Kategori</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['nmkategori'].'</td>
              </tr>
               <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Tujuan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['tujuan'].'</td>
              </tr>
              <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Keperluan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['keperluan'].'</td>
              </tr>';
            } else if (trim($doctype)==='MLBR') {
                $mailmessage.='<tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Tanggal Lembur</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['tgl_jam_mulai_1'].'<strong> s/d </strong>'.$dtlx['tgl_jam_selesai_1'].'</td>
              </tr>
              <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Jenis Lembur</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['nmjenis_lembur'].'</td>
              </tr>
			  <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Kategori</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['kategori_lembur'].'</td>
              </tr>
              <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Keterangan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
                ...
                $mailmessage.='
              <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Nama Barang/Jasa</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['nmbarang'].'</td>
              </tr>
			  <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Qty</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['qty'].'</td>
              </tr>
              <tr>
				<td style="width: 40%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Satuan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
				<td style="width: 58%; height: 19.4px;font-family:\'Times\'; font-size:12px;">'.$dtlx['satuan'].'</td>
              </tr>
              <tr>
				<td style="width: 20%; height: 19.4px;font-family:\'Times\'; font-size:12px;">Keterangan</td>
				<td style="width: 2%; height: 19.4px;font-family:\'Times\'; font-size:12px;">:</td>
