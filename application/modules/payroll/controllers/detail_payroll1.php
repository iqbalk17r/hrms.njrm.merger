...
class Detail_payroll extends MX_Controller{
	...
	function harap_tunggu1($kdgroup_pg,$kddept,$periode,$keluarkerja){
			...
			//header( "Refresh:3; url=http://localhost/nbi/payroll/detail_payroll/generate_pph/$kdgroup_pg/$kddept/$periode/$keluarkerja", true, 303);
			//header( "Refresh:2;  url=generate_pph/$kdgroup_pg/$kddept/$periode/$keluarkerja");
