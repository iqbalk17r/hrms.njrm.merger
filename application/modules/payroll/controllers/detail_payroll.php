 ...
 */
    ...
    function excel_report_detail(){
        $nodok = $this->fiky_encryption->dekript($this->uri->segment(4));
        $dtl_rekap=$this->m_detail->capture_tmp_payroll_rekap($nodok)->row_array();
        $periode_akhir = date('Ym',strtotime($dtl_rekap['periode_akhir']));
        $datane=$this->m_detail->q_report_payrolldetail($nodok,$periode_akhir);
