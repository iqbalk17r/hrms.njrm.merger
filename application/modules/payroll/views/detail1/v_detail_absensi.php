		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/detail_payroll/detail/$nik/$kdgroup_pg/$kddept/$periode/$keluarkerja");?>" class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
