				...
				<div class="row">
					...
					<?php echo $message;?>
						<div class="box">
							<div class="box-header">
								<div class="col-xs-12">
									<h4>Report Detail PPH Bulanan Semua Karyawan </h4>
								</div>
							</div>
                            <div class="box-body">
								<div class="form-horizontal">
									<form action="<?php echo site_url('payroll/report/excel_pphdetailbulanan');?>" name="form" role="form" method="post">										
					...
					<?php echo $message;?>
						<div class="box">
							<div class="box-header">
								<div class="col-xs-12">
									<h4>Report SPT Tahunan </h4>
								</div>
							</div>
                            <div class="box-body">
								<div class="form-horizontal">
									<form action="<?php echo site_url('payroll/report/excel_pph_detail');?>" name="form" role="form" method="post">										
