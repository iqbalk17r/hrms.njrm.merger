					...
					<?php echo $message;?>
						<div class="box">
							<div class="box-header">
								<div class="col-xs-12">
									<h4>Lihat Pelaporan modul PPH 21 Form 1721-A1 Sebelum Final</h4>
								</div>
							</div>
                            <div class="box-body">
								<div class="form-horizontal">
									<form action="<?php echo site_url('payroll/generate/alltmp_p1721');?>" name="form" role="form" method="post">										
										<!--area-->
