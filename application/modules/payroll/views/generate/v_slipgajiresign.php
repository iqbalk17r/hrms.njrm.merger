...
<table width="100%" border="0" cellpadding="0" cellspacing="1">									
			 ...
			 <tr>
				<td style="border: 0px;"  align="center"><span class="style2"><strong><h2 style="font-weight:big;">PT.    NUSANTARA BUILDING INDUSTRIES</h2></strong></span></td>
			</tr>
				<tr>
			<td>================================================================================</td>
			</tr>	
			...
			<tr>
			<td><label class="col-sm-4">Potongan : Rp. <?php echo $dt->potongan;?></label></td>	
			<td></td>
			</tr>

			<tr>
			<td><label class="col-sm-4">Total PPH21 : Rp. <?php echo $dt->ttl_pph21;?></label></td>	
			<td></td>
			</tr>	
		
			<tr>
			<td><label class="col-sm-4">Total PPH Pesangon : Rp. <?php echo $dt->ttl_pph_resign;?></label></td>	
			<td></td>
			</tr>	
...
<table>
 <tr>
		...
		<td colspan="4"><span class="style2">Demak, <?php echo $dt->tgl_bayar ;?> </span></td>
</tr>
<tr>
		<td><br/><br/>
		</td>
...
<tr>
 ...
 <tr>
		<td style="border: 0px;" colspan="23"><span class="style2"></span></td>
		<td colspan="4"><span class="style2">Personalia</span></td>
</tr>
 </table>  
