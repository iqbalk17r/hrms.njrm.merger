				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td>
								<!--<a href="<?php $nik=trim($lu->nik); echo site_url("payroll/cuti/detail_cuti/$nik")?>" class="btn btn-default  btn-sm">
									<i class="fa fa-edit"></i> Detail Cuti/Absen 
								</a>-->
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">FILTER DETAIL CUTI/ABSEN</h4>
      </div>
	  <form action="<?php echo site_url('payroll/cuti/detail_cuti')?>" method="post">
