	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					<a href="<?php echo site_url('payroll/gaji_pokok/karyawan');?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				...
				<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>							
							...
							<th>Nama</th>
							<th>NIK</th>
							<th>Golongan/Grade</th>
							<th>Gaji Pokok</th>
							
						</tr>
					</thead>
					<tbody>
						<?php $no=0; foreach ($list_gp as $la): $no++ ?>
							<tr>																					
								<td><?php echo $no;?></td>																
								<td><?php echo $la->nmlengkap;?></td>																
								<td><?php echo $la->nik;?></td>								
								<td><?php echo $la->grade_golongan;?></td>								
								<td><?php echo $la->gajipokok;?></td>								
