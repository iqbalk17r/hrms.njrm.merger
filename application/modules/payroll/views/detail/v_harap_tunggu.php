<script type="text/javascript">
			...
			function gr_payroll() {
				...
				console.log("<?php echo site_url('/payroll/generate/generate_tmp')?>/"+param1+'/'+param2+'/'+param3+'/'+param4+'/'+param5);	
			     $.ajax({
					url : "<?php echo site_url('/payroll/generate/generate_tmp')?>/"+param1+'/'+param2+'/'+param3+'/'+param4+'/'+param5,
					type: "POST",
					dataType: "JSON",
					success: function(data)
					{
			 		   ...
			 		   if (data.status==true){
							  ...
							  <?php if (empty($vkddept) or $vkddept=='') { ?>
							   window.location.replace("<?php echo site_url('/payroll/detail_payroll/master')?>/"+param4+'/'+param4+'/'+param6+'/'+param7);
							  <?php } else { ?>
...
<legend><?php //echo $title;?></legend>
        ...
        <div class="form-group input-sm ">		
			...
			<div class="form-group">
				<div class="col-sm-8">    
					 <input type="hidden"  class="form-control input-sm rs" id="tgl" value="<?php echo trim($tgl); ?>" readonly>
					 <input type="hidden"  class="form-control input-sm rs" id="tglawalfix" value="<?php echo trim($tglawalfix); ?>" readonly>
					 <input type="hidden"  class="form-control input-sm rs" id="tglakhirfix" value="<?php echo trim($tglakhirfix); ?>" readonly>
					 ...
					 <input type="hidden"  class="form-control input-sm rs" id="periodeakhir" value="<?php echo trim($keluarkerja); ?>" readonly>
				</div>
			</div>		
		</div>
<br/>
