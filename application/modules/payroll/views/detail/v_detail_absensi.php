		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/detail_payroll/detail/$enc_nik/$enc_kdgroup_pg/$enc_kddept/$enc_periode/$enc_keluarkerja");?>" class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
			...
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						<?php $no=0; foreach($detail_absensi as $lu) {;?>
						<tr>										
							<td><?php echo $lu->nodok;?></td>																							
							<td><?php echo $lu->nik;?></td>
							<td><?php echo $lu->tgl_kerja;?></td>
							<td align="right"><?php echo $lu->cuti_nominal1;?></td>
							<td>
...
<!-- modal edit data -->
<?php foreach ($detail_absensi as $lu) { ?>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Edit Detail Potongan Absensi</h4>
      </div>
	  <form action="<?php echo site_url('payroll/detail_payroll/update_detail_absen')?>" method="post">
						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="text" id="nik" name="nominal"  placeholder="<?php echo trim($lu->cuti_nominal1);?>"  data-inputmask='"mask": "99999999"' data-mask="" class="form-control"   >
