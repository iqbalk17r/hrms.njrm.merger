		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<form action="<?php echo site_url("payroll/detail_payroll/master_pph/$kdgroup_pg/$kddept/$periode/$keluarkerja");?>" method="post">
				...
				<div class="col-sm-12">
				<a href="<?php echo site_url("payroll/detail_payroll/excel_pph_detail/$nik/$nodok")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
				</div>
			</div><!-- /.box-header -->
				...
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td width="10%"><?php echo $lu->keterangan;?></td>
							<td align="right" width="10%"><?php echo $lu->uraian;?></td>
							<td align="right" width="10%"><?php echo $lu->nominal1;?></td>
							<!--<td width="20">
							...
							<?php } ?>	
							<?php if (trim($lu->tipe<>'OTOMATIS'))  { ?>
							<?php if (trim($lu->no_urut)<>'1')  { ?>
							<?php if (trim($lu->no_urut)<>'4')  { ?>
							<?php if (trim($lu->no_urut)<>'6')  { ?>
							<?php if (trim($lu->no_urut)<>'10')  { ?>
							<?php if (trim($lu->no_urut)<>'11')  { ?>
								<a href="#" data-toggle="modal" data-target="#<?php echo $lu->no_urut;?>" class="btn btn-warning  btn-sm">
									<i class="fa fa-edit"></i> Edit
								</a>
