		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/final_payroll/utama_setahun");?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
					<a href="<?php echo site_url("payroll/final_payroll/excel_pph_detail/$nik")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
				</div>
			...
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						<?php $no=0; foreach($list_detail_setahun as $lu): $no++;?>
						<tr>										
