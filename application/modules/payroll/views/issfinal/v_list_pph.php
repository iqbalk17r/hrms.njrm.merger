		...
		<div class="box">
			...
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/final_payroll/index_pph")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
					<a href="<?php echo site_url("payroll/final_payroll/excel_report_pph/$nodok")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
					<a href="<?php echo site_url("payroll/final_payroll/download_exceldetailnyamping/$nodok")?>"  class="btn btn-warning" style="margin:10px;">Export Detail Excel</a>
					...
					<tbody>
						...
						<tr>										
							...
							<td>
								...
								<a href="<?php $nodok=trim($lu->nodok); echo site_url("payroll/final_payroll/detail_pph/$nodok/$lu->nik")?>" class="btn btn-primary  btn-sm">
