		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/final_payroll/master_pph/$nodok");?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
					<a href="<?php echo site_url("payroll/final_payroll/excel_pph_detailbulanan/$nik/$nodok")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
				</div>
