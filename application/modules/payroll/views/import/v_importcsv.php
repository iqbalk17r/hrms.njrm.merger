...
<div class="col-xs-6">
						...
						<div class="box">
							<div class="box-header">
								<div class="col-xs-12">
									<h4>IMPORT DATA CSV all</h4>
								</div>
							</div>
                            <div class="box-body">
								<div class="form-horizontal">
								
									<form action="<?php echo site_url('payroll/import/i_csvall')?>" method="post">
									<div class="modal-body">										
										
										</div>	
										<div> 
											<!--a href="<?php echo site_url('master/import/i_csv');?>" type="button" class="btn btn-default"/> Kembali</a-->
					...
					<div class="col-xs-6">
						...
						<div class="box">
							<div class="box-header">
								<div class="col-xs-12">
									<h4>IMPORT DATA LIST</h4>
								</div>
							</div>
                            <div class="box-body">
								<div class="form-horizontal">
								
									<form action="<?php echo site_url('master/import/i_csv_detailcsv')?>" method="post">
														...
														<div class="box-body">
															<div class="form-horizontal">							
																...
																<div class="form-group">
																	<label class="col-sm-4">PILIH DATA YANG DITERIMA</label>	
																	<div class="col-sm-8">    
										...
										<div> 
											<!--a href="<?php echo site_url('payroll/import/i_csv');?>" type="button" class="btn btn-default"/> Kembali</a-->
											<button type="submit"  class="btn btn-primary">PROSES</button>
										</div>
									</form>
									</div>
