...
<div class="nav-tabs-custom">
	<ul class="nav nav-tabs">					
		<li class="active"><a href="#tab_1" data-toggle="tab"><b>IMPORT GAJI KARYAWAN</b></a></li>
		...
		<li><a href="#tab_5" data-toggle="tab"><b>IMPORT TUNJANGAN HARI RAYA</b></a></li>-->	
	</ul>
</div>
			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">IMPORT GAJI THR</h3>
					</div><!-- /.box-header -->
					<!-- form start -->
					<form action="<?php echo site_url('payroll/import/import_thr')?>" method="post" enctype="multipart/form-data" role="form">
						<div class="box-body">					
	...
	<div class="tab-pane" id="tab_5" style="position: relative; height: 300px;" >
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">IMPORT TUNJANGAN HARI RAYA</h3>
					</div><!-- /.box-header -->
					<!-- form start -->
					<form action="<?php echo site_url('payroll/import/import_thr')?>" method="post" enctype="multipart/form-data" role="form">
						<div class="box-body">					
