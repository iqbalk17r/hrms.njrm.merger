	...
	<div class="col-sm-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo site_url("payroll/harianpayroll/lihat_absen/$tglawal/$tglakhir/$kddept")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				<a href="<?php echo site_url("payroll/harianpayroll/excel_sum_absendtl/$nik/$tglawal/$tglakhir")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
				</div>
				</div>
			</div><!-- /.box-header -->
