	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					<a href="<?php echo site_url("payroll/harianpayroll/lihat_shift");?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				<a href="<?php echo site_url("payroll/harianpayroll/excel_sumshift/$tglawal/$tglakhir/$kddept/$nik")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
				...
				<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
						<?php $no=0; foreach ($list_shift as $la): $no++ ?>
							<tr>																					
								<td><?php echo $no;?></td>																
								<td><a <?php $nik=trim($la->nik);?> href="<?php echo site_url("payroll/harianpayroll/lihat_dtl_shift/$nik/$kddept/$tglawal/$tglakhir");?>"> <?php echo trim($la->nik);?></a></td>						
								<td><?php echo $la->nmlengkap;?></td>																								
								<td><?php echo $la->nmdept;?></td>																								
