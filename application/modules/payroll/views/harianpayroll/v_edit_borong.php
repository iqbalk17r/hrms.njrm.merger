	...
	<div class="col-sm-12">
		<div class="box">
			<div class="box-header">
				<a <?php $nodok2=trim($this->session->userdata('nik'));?> href="<?php echo site_url("payroll/harianpayroll/lihat_borong_detail/$tglawal/$tglakhir/$nik/$kddept")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				<a href="<?php echo site_url("payroll/harianpayroll/excel_edit_borong/$nodok_ref")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
			</div><!-- /.box-header -->
