...
<style>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" class="formcreatedeclarationcomponent" action="<?php echo site_url('kasbon_umum/declarationcashbondinas/docreatecomponentpopup/'.bin2hex(json_encode(array('branch' => $employee->branch, 'employeeid' => $employee->nik, 'dutieid' => $dinas->nodok, 'cashbonid' => isset($cashbon->cashbonid) ? $cashbon->cashbonid : '', 'perday' => $perday, ))))?>" method="post">
