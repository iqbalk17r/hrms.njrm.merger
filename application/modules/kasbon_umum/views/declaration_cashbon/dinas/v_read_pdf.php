...
<table class="bordernone" style="table-layout: fixed; width: 100%">
    ...
    <tr>
        ...
        <td class="fontsize12" colspan="9"><span> : </span><span class="paddingleft paddingleft"><b><?php echo $declaration->declarationid ?></b></span></td>
...
<table class="bordernone" style="width: 100%">
    ...
    <tr>
        <td class="borderleft borderright fontsize12 paddingall" colspan="12"><b>Dokumen Dinas</b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="borderleft borderright fontsize12 paddingall" colspan="12"><b>Rincian Harian</b></td>
    </tr>
    <tr>
        <td class="borderleft borderright fontsize12" colspan="12">
            <table class="bordernone" style="width: 100%">
                ...
                <tbody>
                <tr>
                    <td class="bordertop borderright borderbottom fontsize12 paddingall"><b>No. Dinas</b></td>
                ...
                <?php foreach ($days as $index => $day) { ?>
                    <tr>
                        <td class="bordertop borderright borderbottom fontsize12 paddingall"><?php echo $day->dutieid ?></td>
                        ...
                        <?php foreach ($components as $indexs => $component) { ?>
                            <td class="borderall fontsize12 paddingall textright"><?php echo (!is_null($data[$day->day][$component->componentid]->nominalformat) && !is_nan($data[$day->day][$component->componentid]->nominalformat) && $data[$day->day][$component->componentid]->calculated == 't') ? '' : '' ?> <?php echo ($data[$day->day][$component->componentid]->nominalformat > 0 ? $data[$day->day][$component->componentid]->nominalformat : '-') ?></td>
                            <?php
                ...
                <?php } ?>
                <tr>
                    <td class="bordertop borderright borderbottom fontsize12 paddingall" colspan="2"><b>Total Deklarasi</b></td>
                    ...
                    <?php } ?>
                    <td class="borderall fontsize12 paddingall textright"><b>Rp<?php echo number_format($data['total'],2,',','.') ?></b></td>
