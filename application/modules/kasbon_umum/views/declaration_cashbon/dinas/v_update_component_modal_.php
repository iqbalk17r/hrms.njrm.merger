                ...
                <div class="form-horizontal">
                    <?php foreach ((count($declarationcomponents) > 0 ? $declarationcomponents : $declarationcomponentsempty) as $index => $row ) { ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="nominal[]" class="form-control text-right autonumeric" value="<?php echo (!is_nan($row->nominal) && !is_null($row->nominal)) ? $row->nominal : ( $row->componentid == 'UD' && $achieved == 0  ? 10000 :$row->defaultnominal ) ?>" <?php echo ($row->readonly == 't' ? 'readonly' : '') ?> autocomplete="off"/>
                            </div>
                            <div class="col-sm-6">
