...
<style>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" class="formupdatedeclarationcomponent" action="<?php echo site_url('kasbon_umum/declarationcashbon/doupdatecomponentpopup/'.bin2hex(json_encode(array('branch' => $employee->branch, 'employeeid' => $employee->nik, 'dutieid' => $cashbon->dutieid, 'cashbonid' => isset($cashbon->cashbonid) ? $cashbon->cashbonid : '', 'declarationid' => $declaration->declarationid, 'perday' => $perday, ))))?>" method="post">
