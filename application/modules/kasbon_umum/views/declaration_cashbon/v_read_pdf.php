...
<table class="bordernone" style="width: 100%">
    ...
    <tr>
        <td class="borderleft borderright textleft textmiddle paddingall fontsize14 fontbold" colspan="12">FORMULIR DEKLARASI KASBON</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="borderall fontsize12 paddingall textcenter backgreen" colspan="10"><?php echo $cashbon->formattype ?></td>
    </tr>
    ...
    <tr>
        <td class="borderleft borderright bordertop fontsize12 paddingall" colspan="12">Biaya Deklarasi sejumlah : <b><?php echo (isset($declaration->totaldeclaration) ? $declaration->totaldeclarationformat : 0) ?>,-</b> Kasbon yang diberikan sejumlah : <b><?php echo (isset($declaration->totalcashbon) ? $declaration->totalcashbonformat : 0) ?>,-</b>
            <?php
