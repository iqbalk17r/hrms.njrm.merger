        ...
        <div class="col-sm-12">
            <?php
                if ($category == 'DECLARATION'){
                    echo '<a href="'.site_url('kasbon_umum/declarationcashbon').'" class="btn btn-warning ml-3 pull-right">Kembali</a>';
                }
                if ($category == 'CASHBON'){
                    echo '<a href="'.site_url('kasbon_umum/cashbon').'" class="btn btn-warning ml-3 pull-right">Kembali</a>';
                }
            ?>
