...
<style>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <form role="form" class="formcreatecashboncomponent" action="<?php echo site_url('kasbon_umum/cashbondinas/docreatecomponentpopup/'.bin2hex(json_encode(array('branch' => $employee->branch, 'employeeid' => $employee->nik, 'dutieid' => $dutieid ))))?>" method="post">
