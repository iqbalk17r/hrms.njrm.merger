...
<style>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" class="formupdatecashboncomponent" action="<?php echo site_url('kasbon_umum/cashbon/doupdatecomponentpopup/'.bin2hex(json_encode(array('branch' => $employee->branch, 'employeeid' => $employee->nik, 'dutieid' => $cashbon->dutieid, 'cashbonid' => $cashbon->cashbonid ))))?>" method="post">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="description[]" class="form-control text-uppercase" value="<?php echo $row->description ?>" <?php echo ($row->componentid == 'BPO' || $row->readonly == 't' ? 'readonly' : '') ?> autocomplete="off"/>
                        </div>
                    </div>
                    <?php } ?>
                </div>
