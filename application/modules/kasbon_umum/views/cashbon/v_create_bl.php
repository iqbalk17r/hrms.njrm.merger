                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="documenttype" class="form-control" value="<?php echo $formattype ?>" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
<!--                                    <input type="text" name="totalcashbon" value="" readonly class="form-control autonumeric" placeholder="0"/>-->
    ...
    <div class='col-sm-6'>${repo.text}</div>
        ...
        $('form.formcreatecashbon').submit(function(e){
            ...
            submitHandler: function(form) {
                $.ajax({
                    url: '<?php echo site_url('kasbon_umum/cashbon/checkcomponenttemporary/'.bin2hex(json_encode(array('cashbonid'=>$cashbon->cashbonid,'schema'=>'temporary', 'type'=> (isset($cashbon->type)) ? $cashbon->type : $type)))); ?>',
                    method: 'POST',
