<?php
class M_smscenter extends CI_Model{
	
	function q_listhpkaryawan(){
		return $this->db->query("select nik,replace(trim(nohp1),'08','+62') as hpya from sc_mst.karyawan where coalesce(statuskepegawaian,'')<>'KO' order by nik");
	}
