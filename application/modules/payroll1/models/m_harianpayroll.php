<?php
class M_harianpayroll extends CI_Model{
	...
	function q_transready_shift($tglawal,$tglakhir,$nik){
	...
	function q_transready_absen_gt($tglawal,$tglakhir,$kdgroup_pg,$kddept){
		return $this->db->query("select * from 
								...
								left outer join sc_mst.karyawan b on a.nik=b.nik 
								where to_char(a.tgl,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'
								and b.grouppenggajian='$kdgroup_pg' and b.bag_dept='$kddept' and b.gajitetap is null
								) as t1
								where ketsts='TIDAK MASUK KERJA'
								order by tgl asc   
								");
	...
	function q_sum_shift($kddept){
		return $this->db->query("select a.nik,b.nmlengkap,c.nmdept,b.bag_dept,to_char(round(sum(a.nominal),0),'999G999G999G990D00') as  nominal1 from sc_tmp.cek_shift a
								left outer join sc_mst.karyawan b on a.nik=b.nik
								left outer join sc_mst.departmen c on b.bag_dept=c.kddept
								where b.bag_dept='$kddept'
								group by a.nik,b.nmlengkap,c.nmdept,b.bag_dept
								order by b.nmlengkap");
	
	}
	
	function q_shift($kddept,$nik){
		return $this->db->query("select b.nmlengkap,c.nmdept,a.*,to_char(round(nominal,0),'999G999G999G990D00') as nominal1 from sc_tmp.cek_shift a
								left outer join sc_mst.karyawan b on a.nik=b.nik
								left outer join sc_mst.departmen c on b.bag_dept=c.kddept
								 where c.kddept='$kddept' and a.nik='$nik'
								");
		
	
	}
	
	function total_nominal_shift($nik){
		return $this->db->query("select to_char(round(sum(nominal),0),'999G999G999G990D00') as total_nominal  from sc_tmp.cek_shift where nik='$nik'");
	...
	function q_lembur_gt($tglawal,$tglakhir,$kdgroup_pg,$kddept){
		return $this->db->query("select *,cast(to_char(tgl_jam_absen,'HH24:mi:ss') as time) as jam_absen  from (
								...
								left outer join sc_mst.karyawan c on a.nik=c.nik
								where a.status='P' and to_char(a.tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'
								and c.grouppenggajian='$kdgroup_pg' and c.bag_dept='$kddept' and gajitetap is  null
								group by a.nik,a.nodok,a.tgl_dok,a.kdlembur,a.tgl_jam_mulai,a.tgl_jam_selesai,
								a.durasi,a.tgl_kerja) as t1
								");
	...
	function q_sum_absen($tglawal,$tglakhir,$kddept){
		return $this->db->query("select b.nik,b.nmlengkap,sum(cuti_nominal)as cuti_nominal from sc_tmp.cek_absen a
									left outer join sc_mst.karyawan b on a.nik=b.nik
									where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'  and b.bag_dept='$kddept'
									group by b.nmlengkap,b.nik
									order by b.nmlengkap asc");
		
	}
	function q_cek_absen($nik,$tglawal,$tglakhir){
		return $this->db->query("select b.nmlengkap,
								...
								left outer join sc_mst.karyawan b on a.nik=b.nik
								where b.nik='$nik' and to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' 
								order by tgl_kerja asc");
	
	
	}

    function q_sum_absen_trx($tglawal,$tglakhir,$kddept){
        return $this->db->query("select b.nik,b.nmlengkap,sum(cuti_nominal)as cuti_nominal from sc_trx.cek_absen a
									left outer join sc_mst.karyawan b on a.nik=b.nik
									where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'  and b.bag_dept='$kddept'
									group by b.nmlengkap,b.nik
									order by b.nmlengkap asc");
    ...
    function q_cek_absen_trx($nik,$tglawal,$tglakhir){
        return $this->db->query("select b.nmlengkap,
								case
								when a.cuti_nominal=null then 'BERMASALAH'
								when a.cuti_nominal=0 then 'POTONG CUTI'
    ...
    function q_sum_absen_nik($tglawal,$tglakhir,$nik){
        return $this->db->query("select b.nik,b.nmlengkap,sum(cuti_nominal)as cuti_nominal from sc_tmp.cek_absen a
									left outer join sc_mst.karyawan b on a.nik=b.nik
									where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'  and b.nik='$nik'
									group by b.nmlengkap,b.nik
									order by b.nmlengkap asc");

    }
    function q_cek_absen_nik($nik,$tglawal,$tglakhir){
        return $this->db->query("select b.nmlengkap,
								case
								when a.cuti_nominal=null then 'BERMASALAH'
								when a.cuti_nominal=0 then 'POTONG CUTI'
    ...
    function q_sum_absen_trx_nik($tglawal,$tglakhir,$nik){
        return $this->db->query("select b.nik,b.nmlengkap,sum(cuti_nominal)as cuti_nominal from sc_trx.cek_absen a
									left outer join sc_mst.karyawan b on a.nik=b.nik
									where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'  and b.nik='$nik'
									group by b.nmlengkap,b.nik
    ...
    function q_cek_absen_trx_nik($nik,$tglawal,$tglakhir){
        return $this->db->query("select b.nmlengkap,
								case
								when a.cuti_nominal=null then 'BERMASALAH'
								when a.cuti_nominal=0 then 'POTONG CUTI'
    ...
    function q_report_absen_trx($tglawal,$tglakhir){
	    return $this->db->query("select b.nik,b.nmlengkap,sum(cuti_nominal)as cuti_nominal from sc_trx.cek_absen a
                                    left outer join sc_mst.karyawan b on a.nik=b.nik
                                    where to_char(tgl_kerja,'dd-mm-yyyy') between '$tglawal' and '$tglakhir' 
                                    group by b.nmlengkap,b.nik
                                    order by b.nmlengkap asc");
    }
    function q_report_absen_tmp($tglawal,$tglakhir){
        return $this->db->query("select b.nik,b.nmlengkap,sum(cuti_nominal)as cuti_nominal from sc_tmp.cek_absen a
                                    left outer join sc_mst.karyawan b on a.nik=b.nik
                                    where to_char(tgl_kerja,'dd-mm-yyyy') between '$tglawal' and '$tglakhir' 
                                    group by b.nmlengkap,b.nik
	...
	function q_sumlembur($tglawal,$tglakhir,$kddept){ //tmp
		return $this->db->query("select a.nik,b.nmlengkap,a.nodok,b.grouppenggajian,
								to_char(round(sum(a.nominal),0),'999G999G999G990D00') as nominal
								from sc_tmp.cek_lembur a 
								left outer join sc_mst.karyawan b on a.nik=b.nik
								where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' and b.bag_dept='$kddept'
								group by a.nik,b.nmlengkap,nodok,b.grouppenggajian
								order by b.nmlengkap desc");
	}
	
	function q_sumlemburtrx($tglawal,$tglakhir,$kddept){ //trx detail lembur
		return $this->db->query("select a.nik,b.nmlengkap,a.nodok,b.grouppenggajian,
								to_char(round(sum(a.nominal),0),'999G999G999G990D00') as nominal
								from sc_trx.cek_lembur a 
								left outer join sc_mst.karyawan b on a.nik=b.nik
								where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' and b.bag_dept='$kddept'
								group by a.nik,b.nmlengkap,nodok,b.grouppenggajian
								order by b.nmlengkap desc");
	...
	function q_sumlembur_nik($tglawal,$tglakhir,$nik){
		return $this->db->query("select a.nik,b.nmlengkap,a.nodok,b.grouppenggajian,
								to_char(round(sum(a.nominal),0),'999G999G999G990D00') as nominal
								from sc_tmp.cek_lembur a 
								left outer join sc_mst.karyawan b on a.nik=b.nik
								where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' and a.nik='$nik'
								group by a.nik,b.nmlengkap,nodok,b.grouppenggajian
								order by b.nmlengkap desc");
	}
	
	function q_sumlembur_niktrx($tglawal,$tglakhir,$nik){
		return $this->db->query("select a.nik,b.nmlengkap,a.nodok,b.grouppenggajian,
								to_char(round(sum(a.nominal),0),'999G999G999G990D00') as nominal
								from sc_trx.cek_lembur a 
								left outer join sc_mst.karyawan b on a.nik=b.nik
	...
	function list_lembur_nominal($nik,$tglawal,$tglakhir){
		return $this->db->query("select to_char(a.tgl_nodok_ref,'dd-mm-yyyy')as tgl_dok1,
								...
								to_char(round(a.nominal,0),'999G999G999G990D00') as nominal1, b.grouppenggajian
								from sc_tmp.cek_lembur a 
								left outer join sc_mst.karyawan b on a.nik=b.nik
								where a.nik='$nik' and to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' 
								order by a.tgl_kerja asc");
	
	
	}
	
	function q_sliplembur($nik,$tglawal,$tglakhir){
		return $this->db->query("select * from
								(select to_char(a.tgl_nodok_ref,'dd-mm-yyyy')as tgl_dok1,
										to_char(a.tgl_kerja,'dd-mm-yyyy')as tgl_kerja1,
										a.status,to_char(a.jam_mulai_absen,'HH24:mi:ss') as jam_mulai_absen1,
										to_char(a.jam_selesai_absen,'HH24:mi:ss') as jam_selesai_absen1,	
										to_char(a.jam_selesai,'HH24:mi:ss') as jam_selesai1,	
										...
										a.nodok,a.nik,a.nodok_ref,a.tplembur,a.tgl_kerja,a.jumlah_jam,a.jam_mulai_absen,a.jam_selesai_absen,b.nmlengkap,c.nmdept,d.nmjabatan,
										cast(cast(floor(jumlah_jam/60.) as integer)as character(12))|| ' Jam '||
										cast(cast((jumlah_jam-(floor(jumlah_jam/60.)*60)) as integer)as character(12))||' Menit' as jam,
										cast(cast(floor(jumlah_jam_absen/60.) as integer)as character(12))|| ' Jam '||
										cast(cast((jumlah_jam_absen-(floor(jumlah_jam_absen/60.)*60)) as integer)as character(12))||' Menit' as jam2,
										...
										where a.nik='$nik' and to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' 								
								union all
								select null as tgl_dok1,
										null as tgl_kerja1,
										null as status,null as jam_mulai_absen1,
										null as jam_selesai_absen1,	
										null as jam_selesai1,	
										null as jam_mulai1,	
										null as ketsts,
										null as nodok,a.nik,'TOTAL ' as nodok_ref,null as tplembur, null as tgl_kerja,null as jumlah_jam,null as jam_mulai_absen, null as jam_selesai_absen,b.nmlengkap,null,null,
										null as jam,
										null as jam2,
										to_char(round(sum(a.nominal),0),'999G999G999G990D00') as nominal1, null as grouppenggajian
										from sc_tmp.cek_lembur a 
										left outer join sc_mst.karyawan b on a.nik=b.nik
										
										
																where a.nik='$nik' and to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir' 
																group by a.nik,b.nmlengkap) as x
								");
	}
	
	
	
	/*function list_lembur_nominal_1($tglawal,$tglakhir,$nodok){
		return $this->db->query("select to_char(a.tgl_nodok_ref,'dd-mm-yyyy')as tgl_dok1,
								to_char(a.tgl_kerja,'dd-mm-yyyy')as tgl_kerja1,
								a.status,to_char(a.jam_mulai_absen,'HH24:mi:ss') as jam_mulai_absen1,
								to_char(a.jam_selesai_absen,'HH24:mi:ss') as jam_selesai_absen1,	
	...
	function q_cek_borong($tglawal,$tglakhir,$kddept){
	
		return $this->db->query("select a.nik,b.nmlengkap,sum(a.total_upah)as total_upah,to_char(round(sum(a.total_upah),0),'999G999G999G990D00') as total_upah1 
									from sc_tmp.cek_borong a
									left outer join sc_mst.karyawan b on a.nik=b.nik
									where to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir'
									and b.bag_dept='$kddept'
									group by b.nmlengkap,a.nik,a.periode
									order by b.nmlengkap asc");
								
	}	
	function q_cek_borong_detail($tglawal,$tglakhir,$nik,$kddept){
	
		return $this->db->query("select b.nmlengkap,a.*,to_char(round(a.total_upah,0),'999G999G999G990D00') as total_upah1 
								from sc_tmp.cek_borong a
								left outer join sc_mst.karyawan b on a.nik=b.nik	
								where (to_char(tgl_kerja,'YYYY-MM-DD') between '$tglawal' and '$tglakhir')
								and a.nik='$nik' and b.bag_dept='$kddept'
								order by a.nodok_ref desc");
	...
	function q_absenbelum($tglbelum,$kdgroup_pg,$kddept){
		...
		return $this->db->query("select a.* from sc_tmp.cek_absen a 
								left outer join sc_mst.karyawan b on a.nik=b.nik
								where to_char(tgl_kerja,'YYYY-MM-DD')='$tglbelum' and b.grouppenggajian='$kdgroup_pg'
								and b.bag_dept='$kddept'");
	}
	...
	function q_upah_borong_detail($nodok_ref){
		return $this->db->query("select a.*,b.nmlengkap,c.nmborong,d.nmsub_borong,d.metrix,d.satuan,d.tarif_satuan,e.total_target
								...
								where a.nodok='$nodok_ref' 
								order by a.no_urut desc");
			
	}
	
	function q_report_lembur($tgl1,$tgl2){
	
		return $this->db->query("select a.nik,a.nodok_ref,b.nmlengkap,c.nmdept,a.tgl_kerja,cast(cast(floor(a.jumlah_jam/60.) as integer)as character(12))|| ' Jam '||
								cast(cast((jumlah_jam-(floor(a.jumlah_jam/60.)*60)) as integer)as character(12))||' Menit' as jam,
								cast(cast(floor(a.jumlah_jam_absen/60.) as integer)as character(12))|| ' Jam '||
								cast(cast((a.jumlah_jam_absen-(floor(a.jumlah_jam_absen/60.)*60)) as integer)as character(12))||' Menit' as jam2,
								cast(d.durasi_istirahat as char(12))||' Menit' as break,
								to_char(round(a.nominal,0),'999G999G999G990') as nominal,
								d.keterangan,b.grouppenggajian from sc_tmp.cek_lembur a
								left outer join sc_mst.karyawan b on a.nik=b.nik
								left outer join sc_mst.departmen c on b.bag_dept=c.kddept
								left outer join sc_trx.lembur d on a.nodok_ref=d.nodok
								where a.tgl_kerja between '$tgl1' and '$tgl2'
								order by b.bag_dept,a.tgl_kerja");
	
	}
	function q_report_lemburtrx($tgl1,$tgl2){
		...
		return $this->db->query("select a.nik,a.nodok_ref,b.nmlengkap,c.nmdept,a.tgl_kerja,cast(cast(floor(a.jumlah_jam/60.) as integer)as character(12))|| ' Jam '||
								...
								cast(d.durasi_istirahat as char(12))||' Menit' as break,
								to_char(round(a.nominal,0),'999G999G999G990') as nominal,
								d.keterangan,b.grouppenggajian from sc_trx.detail_lembur a
								left outer join sc_mst.karyawan b on a.nik=b.nik
								left outer join sc_mst.departmen c on b.bag_dept=c.kddept
								left outer join sc_trx.lembur d on a.nodok_ref=d.nodok
								where a.tgl_kerja between '$tgl1' and '$tgl2'
