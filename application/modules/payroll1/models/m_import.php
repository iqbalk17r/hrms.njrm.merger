...
class M_import extends CI_Model{
	...
	function e_csvcek_absen($date,$patch){
		return $this->db->query("drop table sc_im.cek_absen;
	...
	function e_csvcek_borong($date,$patch){
		return $this->db->query("drop table sc_im.cek_borong;
	...
	function e_csvcek_lembur($date,$patch){
		return $this->db->query("drop table sc_im.cek_lembur;
	...
	function e_csvcek_shift($date,$patch){
		return $this->db->query("drop table sc_im.cek_shift;
	...
	function e_csvjadwal_kerja($patch){
		return $this->db->query("drop table sc_im.dtljadwalkerja;
	...
	function e_csvmstkaryawan($patch){   /*MST0001*/
		return $this->db->query("drop table sc_im.karyawan;
	...
	function e_csvmststatpeg($patch){   /*MST0002*/
		return $this->db->query("drop table sc_im.status_kepegawaian;
	...
	function e_csvmstbpjs($patch){      /*MST0003*/
		return $this->db->query("drop table sc_im.bpjs_karyawan;
	...
	function e_csvmstriwkel($patch){     /*MST0004*/
		return $this->db->query("drop table sc_im.riwayat_keluarga;
	...
	function e_csvmstriwkes($patch){     /*MST0005*/
		return $this->db->query("drop table sc_im.riwayat_kesehatan;
	...
	function e_csvmstriwkompt($patch){     /*MST0006*/
		return $this->db->query("drop table sc_im.riwayat_kompetensi;
	...
	function e_csvmstriwpend($patch){     /*MST0007*/
							return $this->db->query("drop table sc_im.riwayat_pendidikan;
	...
	function e_csvmstriwpend_nf($patch){     /*MST0008*/
		return $this->db->query("drop table sc_im.riwayat_pendidikan_nf;
	...
	return $this->db->query("drop table sc_im.riwayat_pengalaman;
	...
	return $this->db->query("drop table sc_im.riwayat_rekam_medis;
    ...
    function e_csvmstjabatan($patch){       /*MST0011*/
        return $this->db->query("drop table sc_im.jabatan;
							/*insert into sc_im.riwayat_rekam_medis select * from sc_trx.riwayat_rekam_medis;*/
    ...
    function e_transready($patch){       /*006*/
        return $this->db->query("drop table sc_im.transready;
							select * into sc_im.transready from sc_trx.transready;
							copy  sc_im.transready to '$patch' using delimiters ';' csv header;
							");
    }
    function e_jadwalkerja($patch){       /*005*/
        return $this->db->query("drop table sc_im.jadwalkerja;
							select * into sc_im.jadwalkerja from sc_trx.jadwalkerja;
							copy  sc_im.jadwalkerja to '$patch' using delimiters ';' csv header;
							");
    }
    function e_cekabsen($patch){       /*001*/
        return $this->db->query("drop table sc_im.cek_absen;
							select * into sc_im.cek_absen from sc_tmp.cek_absen;
							copy  sc_im.cek_absen to '$patch' using delimiters ';' csv header;
							");
    }
    function e_cekborong($patch){       /*002*/
        return $this->db->query("drop table sc_im.cek_borong;
							select * into sc_im.cek_borong from sc_tmp.cek_borong;
							copy  sc_im.cek_borong to '$patch' using delimiters ';' csv header;
							");
    }
    function e_ceklembur($patch){       /*003*/
        return $this->db->query("drop table sc_im.cek_lembur;
							select * into sc_im.cek_lembur from sc_tmp.cek_lembur;
							copy  sc_im.cek_lembur to '$patch' using delimiters ';' csv header;
							");
    }
    function e_cekshift($patch){       /*004*/
        return $this->db->query("drop table sc_im.cek_shift;
							select * into sc_im.cek_shift from sc_tmp.cek_shift;
							copy  sc_im.cek_shift to '$patch' using delimiters ';' csv header;
							");
    }
    //PAYROLL FROM
    function e_m_lvlgp($patch){       /*PY0001*/
        return $this->db->query("drop table sc_im.m_lvlgp;
    ...
    function e_m_masakerja($patch){       /*PY0002*/
        return $this->db->query("drop table sc_im.m_masakerja;
    ...
    function e_m_wilayah($patch){       /*PY0003*/
        return $this->db->query("drop table sc_im.m_wilayah;
    ...
    function e_m_wilayah_nominal($patch){       /*PY0004*/
        return $this->db->query("drop table sc_im.m_wilayah_nominal;
    ...
    function jobgrade($patch){       /*PY0005*/
        return $this->db->query("drop table sc_im.jobgrade;
