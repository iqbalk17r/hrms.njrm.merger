	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					<a href="<?php echo site_url("payroll/generate/detail_1721/$tahun/$kddept/$kdgroup_pg");?>" class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
						<a href="<?php echo site_url("payroll/generate/hitung_ulangp1721nik/$tahun/$kddept/$kdgroup_pg/$nik")?>"  class="btn btn-warning" style="margin:10px; color:#ffffff;">Hitung Ulang</a>
				...
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<!--?php// } ?-->	
							<?php if (($lu->no_urut==13)or ($lu->no_urut==18) or
						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="text" name="nominal"  placeholder="<?php echo trim($lu->nominal);?>"  data-inputmask='"mask": "999999999"' data-mask="" class="form-control"   >
