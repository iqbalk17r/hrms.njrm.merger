...
<div class="modal fade" id="<?php echo trim($lu->urut);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	  ...
	  <form action="<?php echo site_url('payroll/detail_payroll/update_detail_tunjangan')?>" method="post">
						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="text" id="nik" name="nominal"  placeholder="<?php echo trim($lu->cuti_nominal);?>"  data-inputmask='"mask": "99999999"' data-mask="" class="form-control"   >
