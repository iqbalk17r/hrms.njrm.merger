	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				...
				<div class="col-sm-6">
				<a <?php $test=trim($nodok); ?>href="<?php echo site_url("payroll/harianpayroll/lihat_borong/$tglawal/$tglakhir/$kddept")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				<a href="<?php echo site_url("payroll/harianpayroll/excel_dtl_borong/$tglawal/$tglakhir/$kddept")?>"  class="btn btn-default" style="margin:10px;">Export Excel</a>
				</div>
				</div>
				...
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td><a <?php echo $nodok_ref=trim($lu->nodok_ref);$nik=trim($lu->nik);?> href="<?php echo site_url("payroll/harianpayroll/vedit_borong/$tglawal/$tglakhir/$nodok_ref/$nik/$kddept");?>"><?php echo $lu->nodok_ref;?></a></td>
...
<div class="modal fade" id="dtl<?php echo trim($lb->nodok_ref); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	  ...
	  <form action="<?php echo site_url('payroll/harianpayroll/edit_borong')?>" method="post">
