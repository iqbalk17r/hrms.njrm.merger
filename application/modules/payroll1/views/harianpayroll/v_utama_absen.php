...
<div class="row">
    <div class="col-xs-6">
        <div class="box">
            <div class="box-header">
                <div class="col-xs-12">
                    <h4>LIHAT ABSEN PER DEPARTEMENT</h4>
                </div>
            </div>
            <div class="box-body">
                <div class="form-horizontal">
                    <form action="<?php echo site_url('payroll/harianpayroll/lihat_absen');?>" name="form" role="form" method="post">
                        <!--area-->
    ...
    <div class="col-xs-6">
        ...
        <div class="box">
            <div class="box-header">
                <div class="col-xs-12">
                    <h4>LIHAT ABSEN PER KARYAWAN</h4>
                </div>
            </div>
            <div class="box-body">
                <div class="form-horizontal">
                    <form action="<?php echo site_url('payroll/harianpayroll/lihat_absen_nik');?>" name="form" role="form" method="post">
                        <!--area-->
                        <!--div class="form-group ">
                            <label class="label-form col-sm-3">Group Penggajian</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="label-form col-sm-3">Periode</label>
                            <div class="col-sm-9">
                                <input type="text" name="tgl" id="tgl2" class="form-control pull-right">
                            </div>
                        </div>
    ...
    <div class="col-xs-6">
        <div class="box">
            <div class="box-header">
                <div class="col-xs-12">
                    <h4>DOWNLOAD REPORT POTONGAN ABSEN KARYAWAN</h4>
                </div>
            </div>
            <div class="box-body">
                <div class="form-horizontal">
                    <form action="<?php echo site_url('payroll/harianpayroll/report_absen');?>" name="form" role="form" method="post">
                        <div class="form-group ">
                            <label class="label-form col-sm-3">Type Transaksi</label>
                            <div class="col-sm-9">
                                <select type="text" class="form-control" name="tptr" id="tptr">
