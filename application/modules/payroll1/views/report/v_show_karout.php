		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/report/excel_karout/$periode")?>"  class="btn btn-warning" style="margin:10px; color:#ffffff;">Download Excel</a>
				</div>
			</div><!-- /.box-header -->
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						<?php $no=0; foreach($list_karout as $lu): $no++;?>
						<tr>										
							<td width="2%"><?php echo $no;?></td>																							
							<td><?php echo $lu->nik;?></td>
							<td><?php echo $lu->nmlengkap;?></td>
							<td><?php echo $lu->nmdept;?></td>
							<td><?php echo $lu->tglkeluarkerja;?></td>
					...
					<tfoot>
						<tr>
						<td class="right" colspan="5">Jumlah Karyawan:</td><td class="right"><?php echo $jumlah;?></td>
