		...
		<div class="box">
			...
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						<?php $no=0; foreach($detail_upah as $lu) {;?>
						<tr>										
...
<div class="modal fade" id="<?php echo trim($lu->urut); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	  ...
	  <form action="<?php echo site_url('payroll/detail_payroll/update_detail_borong')?>" method="post">
						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="text" id="nik" name="nominal"  placeholder="<?php echo trim($lu->total_upah1);?>"  data-inputmask='"mask": "99999999"' data-mask="" class="form-control"   >
