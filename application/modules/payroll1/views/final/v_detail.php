		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/final_payroll/master/$nodok");?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
					<a href="<?php echo site_url("payroll/final_payroll/excel_payroll_detail/$nik/$nodok")?>"  class="btn btn-default" style="margin:10px;">Download Excel</a>
					<a href="<?php echo site_url("payroll/final_payroll/download_pdf/$nik/$nodok")?>"  class="btn btn-danger" style="margin:10px;">Download PDF</a>
				</div>
