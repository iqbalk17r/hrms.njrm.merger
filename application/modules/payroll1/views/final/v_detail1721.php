...
<div class="row">
				<div class="col-sm-12">		
					<a href="<?php echo site_url("payroll/final_payroll/alltrx_p1721/$tahun/$kdgroup_pg")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td><a href="<?php $nike=trim($lu->nik); echo site_url("payroll/final_payroll/detail_nik1721/$tahun/$nike/$kddept/$kdgroup_pg")?>"><?php echo $lu->nik; ?></td>
							...
							<td><a href="<?php $nike=trim($lu->nik); echo site_url("payroll/final_payroll/template_form1721/$nike/$kddept/$kdgroup_pg")?>"><?php echo $lu->nomor_pelaporan; ?></td>
