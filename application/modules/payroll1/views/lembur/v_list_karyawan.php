				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td>
								<a href="<?php $nik=trim($lu->nik); echo site_url("payroll/lembur/detail_lembur/$nik")?>" class="btn btn-default  btn-sm">
									<i class="fa fa-edit"></i> Detail Lembur 
								</a>
							</td>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Input Master Upah Borong Karyawan</h4>
      </div>
	  <form action="<?php echo site_url('trans/lembur/add_lembur')?>" method="post">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="gaji" name="periode" placeholder="YYYYMM" value="<?php echo date('Ym'); ?>"  class="form-control" data-inputmask='"mask": "999999"' data-mask="" readonly>
								</div>
							</div>	
							<div class="form-group">
