		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<form action="<?php echo site_url("payroll/detail_payroll/master/$kdgroup_pg/$kddept/$periode/$keluarkerja");?>" method="post">
						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="text" id="nik" name="nominal"  placeholder="<?php echo trim($lu->nominal1);?>"  class="form-control"   >
