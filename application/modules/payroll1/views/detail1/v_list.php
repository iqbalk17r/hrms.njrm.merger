		...
		<div class="box">
			...
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="<?php echo site_url("payroll/detail_payroll/clear_tmp/$nodok/$kddept")?>"  class="btn btn-primary" onclick="return confirm('Anda Yakin Menghapus Data ini?')" style="margin:10px; color:#ffffff;">CLEAR</a>
