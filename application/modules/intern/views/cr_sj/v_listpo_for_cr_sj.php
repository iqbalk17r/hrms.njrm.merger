...
<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("intern/cr_sj/form_cr_sj")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
<div class="col-sm-12">
	<div class="nav-tabs-custom">
	<ul class="nav nav-tabs">					
		<li class="active"><a href="#tab_1" data-toggle="tab">LIST OUTSTANDING PO </a></li>
					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_transaksi_vw_tw_pomst as $row): $no++;?>
								<tr>
									
									<td width="2%"><?php echo $no;?></td>
									<td width="5%">
										<a href="<?php 
										$enc_fc_pono=$this->fiky_hexstring->b2h($this->encrypt->encode(trim($row->fc_pono)));
										echo site_url("intern/cr_sj/input_cr_sj/$enc_fc_pono");?>" class="btn btn-warning  btn-sm"><i class="fa fa-edit"></i> LOAD </a>
										<!--a href="<?php echo site_url("ga/permintaan/input_bbm/$enc_fc_pono");?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL </a--->
									</td>
									<td><?php echo $row->fc_pono;?></td>
									<td width="8%"><?php if (empty($row->fv_podate)) { echo ''; } else { echo date('d-m-Y', strtotime(trim($row->fv_podate))); }?></td>
									<td><?php echo STRTOUPPER(TRIM($row->tipe));?></td>
									<td><?php echo $row->fc_locaname;?></td>
									<td><?php echo $row->fv_suppname;?></td>
									<td><?php echo $row->fv_suppcity;?></td>
									<td><?php echo $row->ft_note;?></td>
