...
<script type="text/javascript">
            $(function() {
		      ...
		      table = $('#example2').DataTable({ 
				...
				"ajax": {
					"url": "<?php echo site_url('intern/cr_sj/cr_sj_pagination')?>",
					"type": "POST"
				},
...
<div class="modal-body">										
					...
					<div class="box-body">
						<div class="form-horizontal">	
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">PILIH TIPE LOAD</label>	
									<div class="col-sm-8">  
									<select class="form-control input-sm " name="inputfill" required>
									 <option value="POB"> PEMBELIAN LANGSUNG KIRIM</option> 
									 <option value="POA"> PEMBELIAN LOKAL GUDANG</option> 
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit"  class="btn btn-primary">Pilih</button>
      </div>
	  </form>
</div></div></div>
