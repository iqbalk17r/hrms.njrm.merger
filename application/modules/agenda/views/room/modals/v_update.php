            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4">ID Ruangan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control text-uppercase" name="room_id" placeholder="Nama Ruangan" value="<?php echo $transaction->room_id ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4">Nama Ruangan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control text-uppercase" name="room_name" placeholder="Nama Ruangan" value="<?php echo $transaction->room_name ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4">Kapasitas</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control text-uppercase" name="capacity" placeholder="Maksimal kapasitas" value="<?php echo $transaction->capacity ?>">
                        </div>
                    </div>
                </div>
            </div>
