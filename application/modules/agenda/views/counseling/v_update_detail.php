...
<form id="update-counseling-detail" class="form update-counseling-detail" action="<?php echo $formAction ?>" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="problem" id="problem" class="form-control text-uppercase" cols="30" rows="9"><?php echo $detail->problem ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="solution" id="solution" class="form-control text-uppercase" cols="30" rows="9"><?php echo $detail->solution ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function () {
        ...
        $('form.update-counseling-detail').submit(function (e) {
            e.preventDefault();
        }).bind('reset', function () {
            Swal.mixin({
                customClass: {
            ...
            submitHandler: function (form) {
                Swal.mixin({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: $('form.update-counseling-detail').attr('action'),
                            data: $('form.update-counseling-detail').serialize(),
                            type: 'POST',
