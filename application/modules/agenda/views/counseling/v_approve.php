...
<form id="approve-counseling" class="form approve-counseling" action="<?php echo $formAction ?>" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="description" id="description" class="form-control text-uppercase" cols="30" rows="9" disabled><?php echo $transaction->description?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="btn-toolbar">
                            <button type="submit" class="btn btn-md btn-success pull-right margin-right-10">Setujui
                            </button>
...
<script>
    $(document).ready(function () {
        ...
        $('form.approve-counseling').submit(function (e) {
            e.preventDefault();
        }).bind('reset', function () {
            Swal.mixin({
                customClass: {
            ...
            submitHandler: function (form) {
                Swal.mixin({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: $('form.approve-counseling').attr('action'),
                            data: $('form.approve-counseling').serialize(),
                            type: 'POST',
