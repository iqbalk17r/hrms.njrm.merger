...
<form id="create-counseling" class="form create-counseling" action="<?php echo $formAction ?>" method="post">
...
<script>
    $(document).ready(function () {
        ...
        $('form.create-counseling').submit(function (e) {
            e.preventDefault();
        }).bind('reset', function () {
            Swal.mixin({
                customClass: {
            ...
            submitHandler: function (form) {
                Swal.mixin({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: $('form.create-counseling').attr('action'),
                            data: $('form.create-counseling').serialize(),
                            type: 'POST',
...
<div class='row' style='width: 800px'>
    ...
    <div class='col-sm-5'>${repo.nmjabatan}</div>
</div>`;
            },
