...
<div class="modal-dialog <?php echo(isset($modalSize) ? $modalSize : 'modal-md') ?>" role="document">
    <form id="update-schedule" class="form update-schedule" action="<?php echo $formAction ?>" method="post">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" style="width: 50%" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Ubah Jadwal</a></li>
                        <li role="presentation" style="width: 50%" class="history"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Riwayat Perubahan</a></li>
                    </ul>
                                ...
                                <div class="box-body">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control text-uppercase" name="session_date" value="<?php echo $transaction->session_date ?>" placeholder="Pilih tanggal">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4">Jam Mulai</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control text-uppercase" name="begin_time" value="<?php echo $transaction->begin_time ?>" placeholder="Pilih jam mulai">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4">Jam Selesai</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control text-uppercase" name="end_time" value="<?php echo $transaction->end_time ?>" placeholder="Pilih jam selesai">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4">Lokasi</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control text-uppercase" name="location" value="<?php echo $transaction->location ?>" placeholder="Lokasi">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4">Alasan</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control text-uppercase" name="reason" value="" placeholder="Alasan">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function (){
        ...
        $('form.update-schedule').submit(function (e) {
            e.preventDefault();
        }).bind('reset', function () {
            ...
            submitHandler: function (form) {
                Swal.mixin({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: $('form.update-schedule').attr('action'),
                            data: $('form.update-schedule').serialize(),
                            type: 'POST',
        ...
        $('li.history').on('click', function (){
            $('table#table-schedule-history').DataTable().draw();
        })
