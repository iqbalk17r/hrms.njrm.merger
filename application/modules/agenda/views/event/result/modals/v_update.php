                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pretest" id="pretest"  value="<?php echo $result->pretest ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4">Posttest</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="posttest" id="posttest"  value="<?php echo $result->posttest ?>">
                                </div>
                            </div>
                            <div class="form-group hide">
                                <label class="col-sm-4">Nilai</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="score" id="score"  value="<?php echo $result->score ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4">Hasil</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control text-uppercase" name="result_text" id="result_text"  value="<?php echo $result->result_text ?>">
                                </div>
                            </div>
                            <?php if($transaction->agenda_type == 'COACH') { ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="text-warning" for="">Biarkan kosong jika tidak ingin mengganti</label>
                                        <input type="file" class="form-control" id="customFile" name="sertificate" accept="application/pdf">
                                        <label><h4><a target="_blank" href="<?php echo base_url($result->sertificate ) ?>" >Lihat sertifikat</a></h4></label>
                                    </div>
                                </div>
                            <?php }?>
                        </div>
