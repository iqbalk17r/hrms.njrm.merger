                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control text-uppercase" name="agenda_id" id="agenda_id" disabled value="<?php echo $transaction->agenda_id ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4">Nama Agenda</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control text-uppercase" name="agenda_name" id="agenda_name" value="<?php echo $transaction->agenda_name ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="agenda_type" id="agenda_type">
                                        <?php if (isset($agendaType) && count($agendaType) > 0) {
                                            foreach ($agendaType as $index => $row) { ?>
                                                <option value="<?php echo $row->id ?>" <?php echo ($transaction->agenda_type == $row->id ? 'selected' : '') ?> ><?php echo $row->text ?></option>
                                            <?php }
                                        } else { ?>
                                            <option></option>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="organizer_type" id="organizer_type">
                                        <?php if (isset($organizerType) && count($organizerType) > 0) {
                                            foreach ($organizerType as $index => $row) { ?>
                                                <option value="<?php echo $row->id ?>" <?php echo ($transaction->organizer_type == $row->id ? 'selected' : '') ?> ><?php echo $row->text ?></option>
                                            <?php }
                                        } else { ?>
                                            <option></option>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control text-uppercase" name="organizer_name" id="organizer_name" value="<?php echo $transaction->organizer_name ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4">Tanggal mulai</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="begin_date" id="begin_date" value="<?php echo $transaction->begin_date ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4">Tanggal selesai</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="end_date" id="end_date" value="<?php echo $transaction->end_date ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="location" id="location">
                                        <?php if (isset($roomData) && count($roomData) > 0) {
                                            foreach ($roomData as $index => $row) { ?>
                                                <option value="<?php echo $row->id ?>" <?php echo ($transaction->location == $row->id ? 'selected' : '') ?> ><?php echo $row->text ?></option>
                                            <?php }
                                        } else { ?>
                                            <option></option>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control " name="link" id="link" value="<?php echo $transaction->link ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4">Keterangan</label>
                                <div class="col-sm-8">
                                    <textarea name="description" id="description" class="form-control text-uppercase" cols="30" rows="9" ><?php echo $transaction->description ?></textarea>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        if ($('select[name=\'organizer_type\']').val() == 'IN'){
            ...
            ajax: {
                ...
                data: function (params) {
                    return {
                        ...
                        agendaid : $('input[name="agenda_id"]').val(),
                        search: params.term,
                        page: params.page,
                        perpage: 7
                    };
