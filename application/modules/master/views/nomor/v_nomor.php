					   ...
					   <button class="btn btn-primary" data-toggle="modal" data-target="#myModal1" style="margin:10px"><i class="glyphicon glyphicon-plus"></i> INPUT</a>
                            ...
                            <div class="box-body">
								...
								<tr>
									...
									<td>
									<a href="<?php echo site_url('master/nomor/hps_nomor').'/'.$row->dokumen;?>" class="btn btn-default  btn-sm" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->dokumen);?>?')">
  ...
  <div class="modal-dialog modal-md">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">INPUT MASTER NOMOR</h4>
	  </div>
	  
		<div class="modal-body">
		<form role="form" action="<?php echo site_url('master/nomor/add_nomor');?>" method="post">
			<div class="row">
			<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
						...
						<input type="text" id="nmdept"  name="modul" maxlength="20" style="text-transform:uppercase" class="form-control" >
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
						<input type="text" id="nmdept" placeholder="YYYYMM" value="<?php echo date('Ym');?>" name="periode"  class="form-control" readonly>
...
<div class="modal fade" id="<?php echo trim($lk->dokumen);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">EDIT MASTER NOMOR</h4>
	  </div>
	  
		<div class="modal-body">
		<form role="form" action="<?php echo site_url('master/nomor/edit_nomor');?>" method="post">
			<div class="row">
			<div class="col-sm-6">
			<div class="form-group">
				 <label class="col-sm-12">Dokumen</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
						...
						<input type="text" id="nmdept"  value="<?php echo trim($lk->part);?>" name="part"  maxlength="10" style="text-transform:uppercase" class="form-control" >
			...
			<div class="form-group">
				...
				<input type="text" id="inputby" name="inputby"  value="<?php echo trim($lk->userid);?>" maxlength="12" style="text-transform:uppercase" class="form-control">
			...
			<div class="form-group">
				 <label class="col-sm-12">Periode</label>
				<div class="col-sm-12">
						<input type="text" id="nmdept" placeholder="YYYYMM" value="<?php echo trim($lk->periode);?>" name="periode"  style="text-transform:uppercase" class="form-control" readonly>
