	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					 <form action="<?php echo site_url('master/regu/simpan_oprdtljadwal')?>" method="post">						
							...
							<div>&nbsp </div>
								  ...
								  <div class="form-body">
									<div class="form-group input-sm">
										...
										<div class="col-md-5">
											<!--<select class="form-control input-sm" name="nik" id="pilihkaryawan" required readonly>
												  <!--option value="">--PILIH KARYAWAN--</option
												  <?php foreach($list_nik as $listkan){?>
												  <option value="<?php echo trim($listkan->nik);?>" <?php if (trim($nik)==trim($listkan->nik)) { echo 'selected';}?> ><?php echo $listkan->nmlengkap;?></option>	
												  <?php }?>
											</select>-->
											<input type="text" value="<?php echo trim($nik); ?>" id="kddept" name="nik"  class="form-control"  >
										</div>
									</div>
									...
									<div class="form-group input-sm">
									  ...
									  <div class="col-md-5">
												...
												<input type="text" value="<?php echo trim($kdregu); ?>" id="kddept" name="kdregu"  class="form-control"  >
									  </div>
									</div>
									<div class="form-group input-sm ">		
								...
								<div class="col-sm-3">
									...
									<a href="<?php echo site_url("master/regu/regu_opr")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
									</div>
