					   ...
					   <button class="btn btn-primary" data-toggle="modal" data-target="#myModal1" style="margin:10px"><i class="glyphicon glyphicon-plus"></i> INPUT</a>
                            ...
                            <div class="box-body">
								...
								<tr>
									...
									<td><?php echo $row->eosf_index;?></td>
									<td><?php echo $row->eosf_val;?></td>
									<td><?php echo $row->eor_val;?></td>
		...
		<form role="form" action="<?php echo site_url('master/regu/add_regu');?>" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
					...
					<select class="form-control input-sm" name="kdmesin" id="kdmesin">
			...
			<div class="form-group">
				 <label class="col-sm-12">KD Template</label>
				<div class="col-sm-12">

					<select class="form-control input-sm" name="kd_opt" id="kd_opt">
							  <?php foreach($list_setup as $listkan){?>
							  <option value="<?php echo trim($listkan->kd_opt);?>" ><?php echo $listkan->kd_opt.''.$listkan->nm_opt;?></option>						  
							  <?php }?>
					</select>
			...
			<div class="form-group">
				 <label class="col-sm-12">Eosf Index</label>
				<div class="col-sm-12">
					<input type="text" id="eosf_index" name="eosf_index"  maxlength="40" style="text-transform:uppercase" class="form-control">
					<!-- /.input group -->
				</div>
			</div>
						<div class="form-group">
				 <label class="col-sm-12">Eosf Val</label>
				<div class="col-sm-12">
					<input type="text" id="eosf_val" name="eosf_val"  maxlength="40" style="text-transform:uppercase" class="form-control">
					
					<!-- /.input group -->
				</div>
			</div>
						<div class="form-group">
				 <label class="col-sm-12">Eor Val</label>
				<div class="col-sm-12">
				<input type="text" id="eor_val" name="eor_val"  maxlength="40"  style="text-transform:uppercase" class="form-control">
	...
	<div class="modal-content">
	  <div class="modal-header">
		...
		<form role="form" action="<?php echo site_url('master/regu/edit_regu');?>" method="post">
				...
				<div class="col-sm-12">
					...
					<select class="form-control input-sm" name="kdmesin" id="kdmesin">
							  <?php foreach($list_mesin as $listkan){?>
								...
								<option <?php if(trim($lk->kdmesin)==trim($listkan->kdmesin)) { echo 'selected';}?> value="<?php echo trim($listkan->kdmesin);?>" ><?php echo $listkan->kdmesin.''.$listkan->nmmesin;?></option>							  							  
							  <?php }?>
					</select>
			...
			<div class="form-group">
				 <label class="col-sm-12">Option Template</label>
				<div class="col-sm-12">

					<select class="form-control input-sm" name="kd_opt" id="kd_opt">
							  <?php foreach($list_setup as $listkan){?>
							  <option <?php if(trim($lk->kd_opt)==trim($listkan->kd_opt)) { echo 'selected';}?> value="<?php echo trim($listkan->kd_opt);?>" ><?php echo $listkan->kd_opt.''.$listkan->nm_opt;?></option>							  
							  <?php }?>
					</select>
			...
			<div class="form-group">
				 <label class="col-sm-12">Eosf Index</label>
				<div class="col-sm-12">
					<input type="text" id="eosf_index" name="eosf_index"  maxlength="40" value="<?php echo trim($lk->eosf_index);?>" style="text-transform:uppercase" class="form-control">
					<!-- /.input group -->
				</div>
			</div>
						<div class="form-group">
				 <label class="col-sm-12">Eosf Val</label>
				<div class="col-sm-12">
					<input type="text" id="eosf_val" name="eosf_val"  maxlength="40" value="<?php echo trim($lk->eosf_val);?>" style="text-transform:uppercase" class="form-control">
				 ...
				 <label class="col-sm-12">Eor Val</label>
				<div class="col-sm-12">
				<input type="text" id="eor_val" name="eor_val"  maxlength="40" value="<?php echo trim($lk->eor_val);?>" style="text-transform:uppercase" class="form-control">
