						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="top" value="<?php echo $list_tb['target1'];?>" name="target1"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="top" value="<?php echo $list_tb['target2'];?>" name="target2"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
						...
						<div class="form-horizontal">	
							<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<input type="number" id="top" value="<?php echo $list_tb['target3'];?>" name="target3"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
									<!-- /.input group -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-12">
									<input type="number" id="top" value="<?php echo $list_tb['target4'];?>" name="target4"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
									<!-- /.input group -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" value="<?php echo $list_tb['target5'];?>" name="target5"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target6" value="<?php echo $list_tb['target6'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target7" value="<?php echo $list_tb['target7'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
						...
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target8" value="<?php echo $list_tb['target8'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target9" value="<?php echo $list_tb['target9'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target10" value="<?php echo $list_tb['target10'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target11" value="<?php echo $list_tb['target11'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<input type="number" id="nmdept" name="target12" value="<?php echo $list_tb['target12'];?>"  onFocus="startCalc();" onBlur="stopCalc();" style="text-transform:uppercase" class="form-control" required>
