...
class Eg_jabatan extends MX_Controller{
    ...
    function __construct(){
		...
		$this->load->model(array('m_eg_jabatan','m_department','m_jabatan'));
	...
	function index(){
		...
		$data['title']="List Master Eligibility Jabatan";
		...
		if($this->uri->segment(4)=="kode_failed")
            ...
            $data['message']='';
		$data['list_jabatan']=$this->m_eg_jabatan->q_jabatan()->result();
		$data['list_department']=$this->m_eg_jabatan->q_department()->result();
		$data['list_subdepartment']=$this->m_eg_jabatan->q_subdepartment()->result();
