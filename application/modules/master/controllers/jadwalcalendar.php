...
//class Jadwalcalendar extends MX_Controller{

class Jadwalcalendar extends MX_Controller {
	function __construct(){
		parent::__construct();
		$this->load->model('m_jadwalcalendar', 'evencal');
		//$this->load->library('template','calendar', $this->_setting());
		$this->load->library(array('form_validation','calendar','template','upload','pdf',$this->_setting())); 
	}
	...
	function index($year = null, $month = null, $day = null){
		...
		$this->template->display('jadwalcalendar/v_jadwalcalendar', $data);
	}
