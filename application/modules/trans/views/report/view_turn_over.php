...
<div class="row">
						...
						<a href="<?php echo site_url("hrd/report/excel_turnover/$periode/$kantor");?>"><i class='fa fa-file-text-o'></i> <label>Excel 2007</label></a></p>
						<div class="box">
                                ...
                                <div class="box-body table-responsive" style='overflow-x:scroll;'>
                                    <table class="table table-bordered">
                                        <thead>
											<tr style="background-color:#c3bcbc">
												<th align="justify" bgcolor="#00CCFF">No</th>
											  <th align="justify" bgcolor="#00CCFF">Nama</th>
											  <th align="justify" bgcolor="#00CCFF">NIP</th>
											  <th align="justify" bgcolor="#00CCFF">Departement</th>
											  <th align="justify" bgcolor="#00CCFF">Jabatan</th>
												<th align="justify" bgcolor="#00CCFF">Masuk Kerja </th>
												<th align="justify" bgcolor="#00CCFF">Keluar Kerja </th>
												<th align="justify" bgcolor="#00CCFF">Pendidikan </th>
												<th align="justify" bgcolor="#00CCFF">Alamat </th>
												<th align="justify" bgcolor="#00CCFF">Usia </th>																						
											</tr>
										</thead>
                                        <tbody>
                                            <?php
												 //Menampilkan data turn over yang ada
												 if(empty($list_turnover))
												 {
												 echo "<tr><td colspan=\"6\">Data tidak tersedia</td></tr>";
												 }else
												 { $no=1;
												 foreach($list_turnover as $to)
												 {
												?>
											  <tr 
												<?php if ($to->urut=='1') { echo 'style="background-color:#c3bcbc" ><td colspan="10" align="justify"><center><b>'.$to->desc_cabang.'</b></center></td>';} 
												else if ($to->urut=='1A.MASUK') { echo '><td colspan="10" align="justify"><b><font color="red">MASUK</font></b></td>';} 												
												else if ($to->urut=='2A.KELUAR') { echo '><td colspan="10" align="justify"><b><font color="red">KELUAR</font></b></td>';}												
												else if ($to->urut=='3') { echo 'style="background-color:#FFFF00" ><td colspan="10" align="justify"><center><b><font color="blue">'.$to->nmlengkap.'= '.$to->nip.'</font></b></center></td>';}
												else if ($to->urut=='4') { echo 'style="background-color:#FFFF00" ><td colspan="10" align="justify"><center><b><font color="blue">'.$to->nmlengkap.'= '.$to->nip.'</font></b></center></td>';}
												else { echo '>'; ?>
												<td><?php echo $no; $no++;?></td>
												<td><?php if ($to->urut=='1') { echo $to->desc_cabang;} else {echo $to->nmlengkap;}?></td>
												<td><?php echo $to->nip;?></td>
												<td><?php echo $to->deskripsi;?></td>
												<td><?php echo $to->deskripsi;?></td>
												<td><?php echo $to->masuk;?></td>
												<td><?php echo $to->keluar;?></td>
												<td><?php echo $to->desc_pendidikan;?></td>
												<td><?php echo $to->alamat;?></td>
												<td><?php
													$kta_awal = array('years','year','mons','mon','days','day');
													$kta_akhir = array('tahun','tahun','bulan','bulan','hari','hari');
													$pesan= str_replace($kta_awal,$kta_akhir,$to->usia);
													echo $pesan;?>
												</td>
												<?php }?>
											  </tr>	
						...
						<div class="col-lg-5">
							<div class="input-group">
								<span class="input-group-addon">
									...
									<?php
										foreach($qarea as $to){						
										echo '<option value="'.$to->nip.'">'.$to->nip.'</option>';
										} ?>
							...
							<div class="input-group">
								<span class="input-group-addon">
									...
									<select class='form-control' name="kategori">
										...
										{
											foreach($qkategori as $to)
											{
											?>
											<option value="<?php echo $to->FC_TGTKATEGORI; ?>"><?php echo $to->FV_TGTNAME; ?></option>
											<?php }} ?>
									</select>
                            </div><!-- /input-group -->
                        </div><!-- /.col-lg-6 -->						
