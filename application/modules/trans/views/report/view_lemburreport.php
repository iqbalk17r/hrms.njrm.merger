...
<div class="row">
						...
						<p align='right' style='margin-right:10px'>Download Laporan lembur :
						<!--<a href="<?php echo site_url('trans/report/pdf');?>"><i class='fa fa-file-text-o'></i> <label>PDF</label></a>
						<a href="<?php echo site_url('trans/report/excel03');?>"><i class='fa fa-file-text-o'></i> <label>Excel 2003</label></a>-->
						<a href="<?php echo site_url("trans/report/excel_lembur/$periode");?>"><i class='fa fa-file-text-o'></i> <label>Excel 2007</label></a></p>
						<div class="box">
                                ...
                                <div class="box-body table-responsive" style='overflow-x:scroll;'>
                                    <table  id="example2" class="table table-bordered table-striped" >
                                        <thead>
											<tr>
												<th align="justify">Nama Lengkap</th>
												<th align="justify">Department</th>
												<th align="justify">No. Dokumen</th>
												<th align="justify">Tanggal Lembur</th>
												<th align="justify">Jam Mulai</th>
												<th align="justify">Jam Selesai</th>
												<th align="justify">Durasi(Menit)</th>
												<th align="justify">Keterangan Lembur</th>										
											</tr>
										</thead>
                                        <tbody>
                                            <?php
											  ...
											  <tr>
												...
												<td><?php  if (trim($column->kode)=='B') { echo '<b>TOTAL DOKUMEN IJIN: '.$column->total.'</b>';}
												else { echo $column->nodok; } ?></td>
												<td><?php echo $column->tgl_kerja;?></td>
												<td><?php echo $column->jammulai;?></td>
												<td><?php echo $column->jamselesai;?></td>
