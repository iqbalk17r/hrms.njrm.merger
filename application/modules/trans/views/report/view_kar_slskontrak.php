...
<div class="row">
						...
						<!--<p align='right' style='margin-right:10px'>Download Laporan Karyawan Selesai Kontrak:
						...
						<div class="box">
                                ...
                                <div class="box-body table-responsive" style='overflow-x:scroll;'>
                                    <table <?php if(!empty($list_karslskontrak))
												 {
												 echo 'id="example1"';
												 } 
                                        ...
                                        <thead>
											<tr>
												...
												<th align="justify">Jenis Kontrak</th>
												<th align="justify">Tanggal Selesai Kontrak</th>
                                        ...
                                        <tbody>
                                            <?php
												 ...
												 if(empty($list_karslskontrak))
												 {
												 echo "<tr><td colspan=\"6\">Data tidak tersedia</td></tr>";
												 }else
												 $no=1;
												 {
												 foreach($list_karslskontrak as $column)
												 {
												?>
											  <tr>
												...
												<td><?php echo $column->desc_kontrak;?></td>
