...
<div class="row">
                        <div class="col-xs-12">  
						<a href="<?php echo site_url('hrd/report');?>" class="btn btn-primary" style=" margin:10px"><i class="glyphicon glyphicon-plus"></i><font color="#fffff"><b>FILTER</b></font></a>                                
                                        ...
                                        <thead>
											...
											<tr>
											  ...
											  <th colspan="4" align="justify"><div align="center">Pendidikan </div></th>
												...
												<th colspan="2" align="justify"><div align="center">NASIONAL</div></th>
                                        ...
                                        <tbody>
                                            <?php
											  ...
											  <tr>
												...
												<td><?php echo $mp->nasm;?></td>
												<td><?php echo $mp->nasf;?></td>
									            <td>&nbsp;</td>
									            <td>&nbsp;</td>
									            <td>&nbsp;</td>
