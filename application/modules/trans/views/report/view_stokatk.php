...
<div class="row">
						...
						<!--<p align='right' style='margin-right:10px'>Download Laporan Stock ATK:
                                    ...
                                    <table <?php if(!empty($list_stockatk))
                                        ...
                                        <thead>
											<tr>
												...
												<th align="justify">Nama & Jenis Barang</th>
												<th align="justify">Satuan</th>
												<th align="justify">Harga</th>
												<th align="justify">Stock Awal</th>
												<th align="justify">In</th>
												<th align="justify">Out</th>
												<th align="justify">Stock Akhir</th>
                                        ...
                                        <tbody>
                                            <?php
											  ...
											  <tr>
												...
												<td><?php echo $column->stokawal;?></td>
												<td><?php echo $column->stokakhir;?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Filter Stock ATK</h4> 
      </div>
