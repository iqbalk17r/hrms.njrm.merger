...
<?php echo $message;?>
<form action="<?php echo site_url('trans/upah_borong/add_upah_borong')?>" method="post">
<div class="modal-body">										
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="dateinput<?php echo trim($lb->nik);?>" name="tgl_kerja" data-date-format="dd-mm-yyyy"  class="form-control" required>
								</div>
							</div>
							...
							<!--<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="gaji" name="periode" placeholder="YYYYMM" value="<?php echo date('mY'); ?>"  class="form-control" data-inputmask='"mask": "999999"' data-mask="" readonly>
								</div>
							</div>-->	
							<div class="form-group">
      ...
      <div class="modal-footer">
        <a type="button" class="btn btn-default" href="<?php $nik=trim($lb->nik);echo site_url("trans/upah_borong/delete_master/$nik");?>">Reset</a>
