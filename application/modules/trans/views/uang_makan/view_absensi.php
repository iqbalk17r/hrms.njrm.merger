                        ...
                        <?php foreach($list_um as $v): ?>
                            ...
                            <tr <?= $v->group_nmlengkap == 0 && $v->group_keterangan == 0 ? "" : "class=\"text-bold\"" ?>>
                                ...
                                <td class="text-nowrap">
                                 ...
                                 <td class="text-nowrap">
                                    <?php echo (is_null($v->rest_time) && $v->urut == '1' ? $v->rest_time : '' ); ?>
                                        <?php if(!is_null($v->rest_time) || !is_null($v->rest_time)): ?>
                                        <span style="width: 50px; float: left;"><?= $v->rest_time ?: "&nbsp;" ?></span>
                                    <?php endif; ?>
                                </td>
                                <?php if($callplan == "t"): ?>
