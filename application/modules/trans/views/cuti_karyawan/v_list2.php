		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<?php if (trim($aksesapprovene['aksesinput']=='t')){?>
				...
				<?php }?>
				<!--?php if (trim($aksesapprovene['aksesapprove']=='t') and (trim($aksesatasan1>=1) or (trim($aksesdept>=1)))) { ?-->
				<!--div --------------FILTER APPROVAL >
				...
				<?php //} ?>
				<?php //if (trim($aksesapprovene['aksesapprove2']=='t')and (trim($aksesatasan2>=1) or (trim($aksesdept>=1)))) { ?>
				<!--div>
				<form action="<?php/// echo site_url('trans/cuti_karyawan/index')?>" method="post">
					<!--a href="<?php// $status='P'; echo site_url("trans/cuti_karyawan/index/$status")?>" name="status"class="btn btn-primary"> Approval 1</a>
					<!--input type="hidden" id="status" name="status"  value="I" class="form-control" style="text-transform:uppercase" maxlength="40" readonly-->
				...
				<?php //} ?>
				<?php// if (trim($aksesapprovene['aksesapprove3']=='t') and (trim($aksesdept>=1))) { ?>
				<div>
				<form action="<?php echo site_url('trans/cuti_karyawan/index')?>" method="post">
					<!--a href="<?php// $status='P'; echo site_url("trans/cuti_karyawan/index/$status")?>" name="status"class="btn btn-primary"> Approval 1</a>
					<!--input type="hidden" id="status" name="status"  value="I" class="form-control" style="text-transform:uppercase" maxlength="40" readonly-->
					...
					<tbody>
						...
						<tr>										
							...
							<td>
								...
								<a href="<?php echo site_url("trans/cuti_karyawan/detail/$lu->nodok")?>"  class="btn btn-primary">Detail</a>	
								<?php if (trim($lu->status)<>'C' and trim($lu->status)<>'P' and trim($lu->status)<>'D' and trim($lu->status)<>'F' ) {?>
								<a href="<?php echo site_url("trans/cuti_karyawan/edit/$lu->nodok")?>"  class="btn btn-success">Edit</a>
								</a>
