...
<div class="row">
		<!--a data-toggle="modal" data-target=".baru" class="btn btn-warning" style="margin:5px"><i class="glyphicon glyphicon-process"></i> Hitung Ulang Cuti</a!-->				
			<a href="cutilalu" class="btn btn-info" style="margin:5px"> Kembali</a>
	...
	<div class="modal fade baru"  role="dialog" >
	  <div class="modal-dialog modal-sm-12">
		<div class="modal-content">
			<form class="form-horizontal" action="<?php echo site_url('trans/cuti_karyawan/cutilaludtl');?>" method="post">
