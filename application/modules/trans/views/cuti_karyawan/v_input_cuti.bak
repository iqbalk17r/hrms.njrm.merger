				...
				(day<10 ? '0' : '') + day;
					...
					$('#jumlah_cuti1').on('blur', function(){
						...
						if(((sisacuti<jumlah_cuti1) && (tpecuti=="A") && (statusptg=="A1"))){
							...
							console.log($('#tglmulai').val());
							console.log($('#tgl7_2').val());
						...
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" <?php $date = date('d-m-Y'); $date = strtotime($date); $date = strtotime("+6 day", $date);?> id="tgl7_2" value="<?php echo date('d-m-Y', $date);?>" class="form-control" >
