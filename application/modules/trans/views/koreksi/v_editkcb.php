				...
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">
                            <input value='EDIT' name='type' type="hidden"  class="form-control" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm" name="doctype" id="doctype">
							...
							<div class="form-group">
								<label class="col-sm-4">Tanggal Mulai</label>	
								<div class="col-sm-8">    
									<input type="text" id="tgl_awal" name="tgl_awal" data-date-format="dd-mm-yyyy"   value="<?php echo date('d-m-Y', strtotime(trim($dtl['tgl_awal'])));?>" class="form-control tgl" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Tanggal Selesai</label>	
								<div class="col-sm-8">    
									<input type="text" id="tgl_akhir" name="tgl_akhir" data-date-format="dd-mm-yyyy"  value="<?php echo date('d-m-Y', strtotime(trim($dtl['tgl_akhir'])));?>" class="form-control tgl" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Jumlah Cuti</label>	
								<div class="col-sm-8">    
									<input align="right" type="text" name="jumlahcuti" class="form-control"  value="<?php echo trim($dtl['jumlahcuti']);?>" required>
								</div>	
							</div>
                            <div class="form-group">
