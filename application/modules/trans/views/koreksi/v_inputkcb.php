				...
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">
                            <input value='INPUT' name='type' type="hidden"  class="form-control" >
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm" name="doctype" id="doctype">
                                        ...
                                        <?php foreach ($lTypeKoreksi as $lk) { ?>
                                            <option value="<?php echo trim($lk->kdtrx); ?>"><?php echo trim($lk->uraian); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="tgl_awal" name="tgl_awal" data-date-format="dd-mm-yyyy"  class="form-control tgl" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Tanggal Selesai</label>	
								<div class="col-sm-8">    
									<input type="text" id="tgl_akhir" name="tgl_akhir" data-date-format="dd-mm-yyyy"  class="form-control tgl" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Jumlah Cuti</label>	
								<div class="col-sm-8">    
									<input align="right" type="text"  class="form-control" name="jumlahcuti" required>
								</div>	
							</div>
                            <div class="form-group">
