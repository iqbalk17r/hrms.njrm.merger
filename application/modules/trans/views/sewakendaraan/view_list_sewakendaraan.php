...
$(function() {
    ...
    t_rencana = $("#rencana-table").DataTable({
        ajax: {
            url: "<?= site_url('trans/sewakendaraan/rencana_callplan')?>",
            type: "POST",
            data: function(d) {
    ...
    t_realisasi = $("#realisasi-table").DataTable({
        ajax: {
            url: "<?= site_url('trans/sewakendaraan/realisasi_callplan')?>",
            type: "POST",
            data: function(d) {
...
<legend>Daftar Sewa Kendaraan Tanggal <?= $tgl ?></legend>

<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <a href="<?= site_url("trans/sewakendaraan") ?>" class="btn btn-default" style="margin: 5px;"><i
                        class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
                <a href="<?= site_url("trans/sewakendaraan/excel_sewakendaraan/$kdcabang/$tgl1/$tgl2/$callplan") ?>"
                    class="btn btn-primary" style="margin: 5px;"><i class="fa fa-file-excel-o"></i>&nbsp; XLS</a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <?php endif; ?>
                            <th>Keterangan</th>
                            <th>Uang Sewa Kendaraan</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i = 1; ?>
                        <?php foreach($list_sewakendaraan as $v): ?>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Filter Laporan Sewa Kendaraan</h4>
            </div>
            <form action="<?php echo site_url('trans/sewakendaraan/list_sewakendaraan');?>" name="form" role="form"
                method="post">
