...
<div class="form-horizontal" id="detailku">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">					
				...
				<li><a href="#tab_4" data-toggle="tab">Jabatan</a></li>									
				<li><a href="#tab_5" data-toggle="tab">Riwayat Keluarga</a></li>									
				<li><a href="#tab_6" data-toggle="tab">Riwayat Kesehatan</a></li>									
				<li><a href="#tab_7" data-toggle="tab">Riwayat Pengalaman Kerja</a></li>									
				<li><a href="#tab_8" data-toggle="tab">Riwayat Pendidikan</a></li>									
			</ul>
		</div>
							...
							<div class="box-body" style="padding:5px;">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">    
										<select name="nik_atasan" class="form-control col-sm-12" disabled readonly>										
											<option value="-" <?php if (''==trim($dtl['nik_atasan'])) { echo 'selected';}?> ><?php echo '----PILIH KARYAWAN --------';?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">    
										...
										<option value="-" <?php if (''==trim($dtl['nik_atasan2'])) { echo 'selected';}?> ><?php echo '----PILIH KARYAWAN --------';?></option>
											<?php foreach ($list_opt_atasan as $loan){ ?>
