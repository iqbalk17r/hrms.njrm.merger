...
<div class="nav-tabs-custom">
	<ul class="nav nav-tabs">					
		<li class="active"><a href="#tab_1" data-toggle="tab"><b>DATA KARYAWAN AKTIF</b></a></li>
		<li><a href="#tab_2" data-toggle="tab"><b>DATA KARYAWAN RESIGN</b></a></li>
		<li><a href="#tab_3" data-toggle="tab"><b>DATA KARYAWAN BORONG</b></a></li>		
	</ul>
</div>
							...
							<div class="box box-primary" >
								...
								<div class="box-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-sm-9">
										<input name="tgllahir"   class="form-control" id="tgl" placeholder="Tanggal Lahir" data-date-format="dd-mm-yyyy" type="text">
									  </div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Agama</label>	
										<div class="col-sm-8">    
											<select type="text" name="kd_agama" class="form-control col-sm-12">										
				...
				<div class="col-sm-12">
				  <h3> Step 5</h3>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="nohp1" style="text-transform:uppercase;" placeholder="Nomor Hp Utama" class="form-control" type="number" maxlength="13">
					  </div>
					</div>												
					<div class="form-group">
...
<div class="tab-pane" id="tab_3" style="position: relative; height: 300px;" >
	...
	<!-- form start -->
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
			<table id="borong" class="table table-striped table-bordered" cellspacing="0" width="100%">
			<thead>
			<tr>
			<th>No.</th>
			<th>NIK</th>
