					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="grade_golongan" id='jobgrade' class="form-control col-sm-12" >
								...
								<option value="<?php echo trim($logjab->kdgrade);?>" class="<?php echo trim($logjab->golongan);?>"><?php echo trim($logjab->nmgrade);?></option>																																																			
								<?php };?>
							</select>
						</div>
					</div>
		...
		<div class="box box-primary">
			...
			<!-- form start -->
				...
				<table id="resign" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
					<!--?php// $no=0; foreach($list_resign as $ls): $no++; ?>
					<tr>
						<td><?php //echo $no;?></td>
						...
						<td><?php //echo $ls->inputdate;?></td> <!-- salah cok hahah-->
