					...
					<div class="box box-info col-sm-6">
						<div class="box-body" style="padding:5px;">
							...
							<div class="form-group">
								...
								<a href="#" type="button" class="btn btn-warning" data-toggle="modal" data-target=".gantigambar">Ganti Foto</a>	
								<div class="col-sm-10"></div>
							</div><br/>
						</div>
						<div class="box-footer">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="nav-tabs-custom">
					<!-- Tabs within a box -->
					<ul class="nav nav-tabs">
						<li class="active"><a href="#kesehatan<?php echo str_replace('.','',trim($lp['nik'])).trim($listkes->nomor);?>tab_1" data-toggle="tab">View Data</a></li>
						<li><a href="#kesehatan<?php echo str_replace('.','',trim($lp['nik'])).trim($listkes->nomor);?>tab_2" data-toggle="tab">Edit Data</a></li>
					</ul>
					<div class="tab-content no-padding">
						<!-- Morris chart - Sales -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="nav-tabs-custom">
					<!-- Tabs within a box -->
					<ul class="nav nav-tabs">
						<li class="active"><a href="#kerjaku<?php echo str_replace('.','',trim($lp['nik'])).trim($listker->pglmke);?>tab_1" data-toggle="tab">View Data</a></li>
						<li><a href="#kerjaku<?php echo str_replace('.','',trim($lp['nik'])).trim($listker->pglmke);?>tab_2" data-toggle="tab">Edit Data</a></li>
					</ul>
					<div class="tab-content no-padding">
						<!-- Morris chart - Sales -->
