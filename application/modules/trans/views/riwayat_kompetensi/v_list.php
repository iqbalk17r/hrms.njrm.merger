	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				...
				<?php } ?>	
					<a href="<?php echo site_url("trans/riwayat_kompetensi/karyawan")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				</div>
				<div class="col-sm-6">
			...
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example2" class="table table-bordered table-striped" >
					...
					<tbody>
						<?php $no=0; foreach($list_riwayat_kompetensi as $lu): $no++;?>
						<tr>										
							<td width="2%"><?php echo $no;?></td>																							
							<!--<td><?php echo $lu->nik;?></td>
							<td><?php echo $lu->nmlengkap;?></td>-->
							<td><?php echo $lu->nmkom;?></td>
							<td><?php echo $lu->uraian;?></td>
							<td><?php echo $lu->keterangan;?></td>
							
							<td>
								<!--<a href='<?php  $nik=trim($lu->nik); echo site_url("trans/riwayat_kompetensi/detail/$nik/$lu->no_urut")?>' class="btn btn-default  btn-sm">
								...
								<a  href="<?php $nik=trim($lu->nik); echo site_url("trans/riwayat_kompetensi/hps_riwayat_kompetensi/$nik/$lu->no_urut")?>" onclick="return confirm('Anda Yakin Hapus Data ini?')" class="btn btn-default  btn-sm">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Input Riwayat Kompetensi <?php echo $nik.'|'.$list_lk['nmlengkap'];?></h4>
      </div>
	  <form action="<?php echo site_url('trans/riwayat_kompetensi/add_riwayat_kompetensi')?>" method="post">
				...
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								<label class="col-sm-4">Nama Kompetensi</label>	
								<div class="col-sm-8">    
									<select class="form-control input-sm" name="kdkom" id="kdkom">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<script type="text/javascript" charset="utf-8">
							  $(function() {	
								$("#lvl_indikator").chained("#kdkom");		
											
							  });
							</script>
							<div class="form-group">
								<label class="col-sm-4">Level Indikator</label>	
								<div class="col-sm-8">    
									<select class="form-control input-sm" name="lvl_indikator" id="lvl_indikator" readonly>
									  <?php foreach($list_kompetensi as $listkan){?>
									  <option value="<?php echo trim($listkan->lvl_indikator);?>" class="<?php echo trim($listkan->kdkom);?>"><?php echo $listkan->uraian;?></option>						  
									  <?php }?>
									</select>
								</div>
							</div>	
...
<?php foreach ($list_riwayat_kompetensi as $lb){?>
<div class="modal fade" id="<?php echo trim($lb->no_urut); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Edit Riwayat kompetensi</h4>
      </div>
	  <form action="<?php echo site_url('trans/riwayat_kompetensi/edit_riwayat_kompetensi')?>" method="post">
<div class="modal-body">										
		<div class="row">
			<div class="col-sm-6">
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								<label class="col-sm-4">Nama Kompetensi</label>	
								<div class="col-sm-8">    
									<input type="text" id="kdkom1" name="kdkom"  value="<?php echo trim($lb->nmkom);?>"class="form-control" readonly>
								</div>
							</div>	
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								<label class="col-sm-4">level Indikator</label>	
								<div class="col-sm-8">    
									<input type="text" id="kdkom1" name="lvl_indikator"  value="<?php echo trim($lb->uraian);?>"class="form-control" readonly>
								</div>
							</div>															
							<div class="form-group">
								<label class="col-sm-4">Keterangan</label>	
