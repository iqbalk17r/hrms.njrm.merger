...
<form role="form" class="formupdatecashbon" action="<?php echo site_url('trans/cashbon/doupdate/'.bin2hex(json_encode(array('branch' => $employee->branch, 'employeeid' => $employee->nik, 'dutieid' => $dinas->nodok, 'cashbonid' => $cashbon->cashbonid, ))))?>" method="post">
<div class="box">
