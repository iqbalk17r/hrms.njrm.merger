            ...
            <div class="box-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" placeholder="KETERANGAN PERINGATAN / ALASAN TEGURAN" style="text-transform: uppercase; resize: none;" rows="5" disabled><?= $dtl->description ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Solusi / Perbaikan</label>
                        <textarea class="form-control" id="solusi" name="solusi" placeholder="SOLUSI / PERBAIKAN" style="text-transform: uppercase; resize: vertical;" rows="5" disabled><?= $dtl->solusi ?></textarea>
                    </div>
                    <div class="form-group">
