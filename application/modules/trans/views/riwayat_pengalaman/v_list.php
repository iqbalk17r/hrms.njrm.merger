	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				...
				<?php } ?>	
					<a href="<?php echo site_url("trans/riwayat_pengalaman/karyawan")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				</div>
				<div class="col-sm-6">
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td>
								<a data-toggle="modal" data-target="#dtl<?php echo trim($lu->no_urut);?>" href='#' class="btn btn-default  btn-sm">
...
<!--Modal untuk Input Input Pengalaman Kerja-->
<div class="modal fade" id="input" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	  ...
	  <form action="<?php echo site_url('trans/riwayat_pengalaman/add_riwayat_pengalaman')?>" method="post">
...
<div class="modal fade" id="<?php echo trim($ld->no_urut); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  ...
	  <form action="<?php echo site_url('trans/riwayat_pengalaman/edit_riwayat_pengalaman')?>" method="post">
<div class="modal-body">										
		<div class="row">
			<div class="col-sm-6">
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								<label class="col-sm-4">Bulan/Tahun Masuk</label>	
								<div class="col-sm-8">    
									<input type="text" id="dateinput2" name="tahun_masuk"   value="<?php echo trim($ld->tahun_masuk1);?>" data-date-format="dd-mm-yyyy" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Bulan/Tahun Keluar</label>	
								<div class="col-sm-8">    
									<input type="text" id="dateinput3" name="tahun_keluar" value="<?php echo trim($ld->tahun_keluar1);?>"  data-date-format="dd-mm-yyyy" class="form-control" required>
								</div>
							</div>
						</div>
					</div><!-- /.box-body -->													
...
<?php foreach ($list_riwayat_pengalaman as $lc){?>
<div class="modal fade" id="dtl<?php echo trim($lc->no_urut); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Detail Riwayat Pengalaman Kerja</h4>
      </div>
	  <form action="<?php echo site_url('trans/riwayat_pengalaman/edit_riwayat_pengalaman')?>" method="post">
<div class="modal-body">										
		<div class="row">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<label class="col-sm-4">Nama Perusahaan</label>	
								<div class="col-sm-8">    
									<input type="text" id="kddept" name="nmperusahaan"  value="<?php echo trim($lc->nmperusahaan);?>" class="form-control" style="text-transform:uppercase" maxlength="50" readonly>
								</div>
							</div>		
							<div class="form-group">
								<label class="col-sm-4">Bidang Usaha</label>	
								<div class="col-sm-8">    
									<input type="text" id="kddept" name="bidang_usaha"  value="<?php echo trim($lc->bidang_usaha);?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>
								</div>
							</div>		
							...
							<div class="form-group">
								<label class="col-sm-4">Bulan/Tahun Masuk</label>	
								<div class="col-sm-8">    
									<input type="text" id="dateinput" name="tahun_masuk"   value="<?php echo trim($lc->tahun_masuk1);?>" data-date-format="dd-mm-yyyy" class="form-control" readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Bulan/Tahun Keluar</label>	
								<div class="col-sm-8">    
									<input type="text" id="dateinput1" name="tahun_keluar" value="<?php echo trim($lc->tahun_keluar1);?>"  data-date-format="dd-mm-yyyy" class="form-control" readonly>
								</div>
							</div>
						</div>
					</div><!-- /.box-body -->													
				...
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">							
								...
								<label class="col-sm-4">Bagian</label>	
								<div class="col-sm-8">    
									<input type="text" id="kddept" name="bagian"  value="<?php echo trim($lc->bagian);?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>
								</div>
							</div>
							<div class="form-group">	
								<label class="col-sm-4">Jabatan</label>	
								<div class="col-sm-8">    
									<input type="text" id="kddept" name="jabatan" value="<?php echo trim($lc->jabatan);?>"  class="form-control" style="text-transform:uppercase" maxlength="40" readonly >
								</div>
							</div>
							<div class="form-group">	
								<label class="col-sm-4">Nama Atasan</label>	
								<div class="col-sm-8">    
									<input type="text" id="kddept" name="nmatasan" value="<?php echo trim($lc->nmatasan);?>" class="form-control" style="text-transform:uppercase" maxlength="50" readonly>
								</div>
							</div>
							<div class="form-group">	
								<label class="col-sm-4">Jabatan Atasan</label>	
								<div class="col-sm-8">    
									<input type="text" id="kddept" name="jbtatasan"  value="<?php echo trim($lc->jbtatasan);?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>
								</div>
							</div>	
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="tgl1" name="tgl"  value="<?php echo date('d-m-Y H:i:s');?>"class="form-control" readonly>
									<input type="hidden" id="inputby" name="inputby"  value="<?php echo $this->session->userdata('nik');?>" class="form-control" readonly>
									<input type="hidden" id="inputby" name="no_urut"  value="<?php echo trim($lc->no_urut);?>" class="form-control" readonly>
								</div>
							</div>		
