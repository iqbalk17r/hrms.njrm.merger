...
<?php foreach ($list_lembur_dtl as $lb){?>
    <form action="<?php echo site_url('trans/lembur/approval')?>" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm" name="lintashari" id="lintashari" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm" name="kdlembur" id="kdgrade" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm" name="jenis_lembur" id="jenis_lembur" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="tgl_kerja" value="<?php echo trim($lb->tgl_kerja1); ?>" name="tgl_kerja" data-date-format="dd-mm-yyyy" class="form-control tgl_kerja" onchange="changeLintasHari()" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="jam_awal" name="jam_awal" data-inputmask='"mask": "99:99:99"' data-mask="" onchange="checkConflict()" value="<?php echo trim($lb->jam_awal); ?>" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4">Jam Selesai</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="jam_selesai" name="jam_selesai" data-inputmask='"mask": "99:99:99"' data-mask="" onchange="checkConflict()" value="<?php echo trim($lb->jam_akhir); ?>" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-sm" name="kdtrx" id="kdtrx" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea type="text" id="nmdept" name="keterangan" style="text-transform: uppercase; resize: none;" class="form-control" rows="3" readonly><?php echo trim($lb->keterangan); ?></textarea>
        ...
        <div class="modal-footer">
            ...
            <?php if(trim($lb->status) == 'A' && ($cekatasan > 0)) { ?>
                <button type="submit" name="submit" class="btn btn-success" value="approve" onclick="return confirm('Anda Yakin Melakukan Approve <?php echo trim($lb->nodok); ?> ?')"><i class="fa fa-check"></i>&nbsp;Approve</button>
                <button type="submit" name="submit" class="btn btn-danger" value="cancel" onclick="return confirm('Anda Yakin Membatalkan <?php echo trim($lb->nodok); ?> ?')"><i class="fa fa-times"></i>&nbsp;Batal</button>
            <?php } ?>
        </div>
    </form>
<?php } ?>
