                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="tgl1" name="tgl_dok" value="<?php echo date('d-m-Y'); ?>" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="tgl_kerja" name="tgl_kerja" data-date-format="dd-mm-yyyy" class="form-control tgl_kerja" onchange="changeLintasHari()" required>
                                    </div>
                                </div>
                                <div class="form-group tgllin">
                                    <label class="col-sm-4">Tanggal Kerja Lintas Hari</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="tgllin" name="tgllin" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="durasi_istirahat" name="durasi_istirahat" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea type="text" id="nmdept" name="keterangan" style="text-transform: uppercase; resize: vertical;" class="form-control" rows="3" required></textarea>
