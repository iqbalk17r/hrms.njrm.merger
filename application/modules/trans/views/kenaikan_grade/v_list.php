					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								<label class="col-sm-4">Tanggal SK</label>	
								<div class="col-sm-8">    
									<input type="text" id="dateinput<?php echo trim($lb->nodok); ?>" name="tgl_sk"  value="<?php echo trim($lb->tgl_sk1); ?>" data-date-format="dd-mm-yyyy" class="form-control" required>
								</div>
							</div>
			<script type="text/javascript">
            $(function() { 
