 ...
 */ ?>
    ...
    <div class="box-footer">
        <div class="col-sm-12">
            <a href="<?php echo site_url('trans/sberitaacara') ?>" class="btn btn-default dropdown-toggle " style="margin:0px; color:#000000;" type="button"><i class="fa fa-arrow-left"></i> Kembali </a>

            <?php if (trim($dtl['status']) === 'B') { ?>
             <button class="btn btn-success dropdown-toggle pull-right" style="margin:0px; color:#ffffff;" type="button" id="btnApprove" onclick="approveHrd();"> Proses <i class="fa fa-arrow-right"></i></button>
            <a  href="<?php echo site_url('trans/sberitaacara/cancel').'?docno='.$docno ?>"  class="btn btn-danger dropdown-toggle  pull-right" style="margin-right:15px; color:#ffffff;" type="button">TOLAK</a>
            <?php } ?>
            </div>
    </div>
</div><!-- /.box -->
...
//read editable/input
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                $('[name="saksi"]').val(json.dataTables.items[0].saksi);
