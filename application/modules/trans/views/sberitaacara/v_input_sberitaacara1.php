 ...
 */ ?>
    ...
    <div class="box-footer">
        <div class="col-sm-12">
            ...
            <?php if (trim($dtl['status']) === 'A') { ?>
             <button class="btn btn-success dropdown-toggle pull-right" style="margin:0px; color:#ffffff;" type="button" id="btnApprove" onclick="approve();"> Proses <i class="fa fa-arrow-right"></i></button>
...
//read editable/input
        ...
        $.ajax({
            ...
            $('[name="peringatan"]').val(json.dataTables.items[0].peringatan || 'n');
