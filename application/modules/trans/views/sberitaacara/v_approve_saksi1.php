 ...
 */ ?>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <textarea class="form-control zz" name="solusi" id="solusi" placeholder="Solusi / Perbaikan" style="text-transform:uppercase" disabled></textarea>
                </div>
    ...
    <div class="box-footer">
        <div class="col-sm-12">
            ...
            <?php if (trim($dtl['status']) === 'S1' && trim($dtl['saksi1']) === $nama) { ?>
          ...
          <!--   <a class="btn btn-sm btn-default" href='."'". base_url('trans/sberitaacara/detail').'/'.'?docno='.trim($lm->docno)."'".' title="Detail Berita Acara" ><i class="fa fa-bars"></i> </a> -->
