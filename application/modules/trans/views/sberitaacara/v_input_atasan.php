 ...
 */ ?>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-addon">
                     ...
                     <select class="form-control laporankj" style="width: 100%;" name="laporan" id="laporankj">
                    </select>
                    <!-- <textarea class="form-control zz" name="laporan" id="laporan" placeholder="Isi Jika Lain-Lain" style="text-transform:uppercase" ></textarea> -->
                    <!-- <select class="form-control col-sm-12 zz" name="laporan" id="laporan" placeholder="Laporan Kejadian" > -->
                  <!--   <select class="form-control select2 zz" style="width: 100%;" name="doctype">
          ...
          <!--   <div class="form-group">
                <label>* Isi Jika Lain - Lain</label>
                <div class="input-group">
                    <div class="input-group-addon">
                        <i class="fa fa-pencil"></i>
                    </div>
                    <textarea class="form-control zz" name="keterangan" id="keterangan" placeholder="Isi Jika Lain-Lain" style="text-transform:uppercase" ></textarea>
                    </select>
                </div>
                <!-- /.input group -->
   <!--          </div> -->
        ...
        <div class="col-lg-4">
            <!-- <div class="form-group">
                ...
                <div class="col-sm-9">
                <select  name="saksi" id="saksi" style="text-transform:uppercase;"  class="form-control" type="text" required>
                <option value="f">TIDAK</option>
               <option value="t1">YA</option>
                </select>
                </div>
            </div> -->
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select  name="saksi" id="saksi" style="width: 100%;"  class="form-control saksi" required>
                        <option value="f">TIDAK</option>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select  name="peringatan" id="peringatan" style="text-transform:uppercase;"  class="form-control" type="text" required>
            ...
            <script type="text/javascript" charset="utf-8">
                $(function() {
                    ...
                    $('#tindakan').removeAttr('required');
                   
                    $('#peringatan').change(function(){

                        var peringatan=$(this).val();
                        if(peringatan=='n'){
                            $('.tindakan').hide();
                            $('.tindaklanjut').show();
                        ...
                        } else if(peringatan=='y'){
                            $('.tindakan').show();
                            $('.tindaklanjut').hide();
                            $('#tindaklanjut').removeAttr('required');
            ...
            <div class="form-group tindakan">
                ...
                <div class="input-group">
                    <div class="input-group-addon">
                        ...
                        <select class="form-control doctypeba" style="width: 100%;" name="doctype" id="doctypeba">
                        </select>
            ...
            <div class="form-group tindaklanjut">
                ...
                <div class="input-group">
                    ...
                    <textarea class="form-control zz" name="tindaklanjut" id="tindaklanjut" placeholder="tindaklanjut" style="text-transform:uppercase" ></textarea>
                </div>
...
//read editable/input
        $.ajax({
            ...
            $.ajax({
                ...
                var option = new Option(datax.items[0].nmkejadian, true, true);
               ...
               // $('[name="laporan"]').val(json.dataTables.items[0].laporan);
                ...
                // $.ajax({
                //     type: 'GET',
                //     url: HOST_URL + 'trans/sberitaacara/list_mst_opsi' + '?var=' + json.dataTables.items[0].saksi,
                //     dataType: 'json',
                //     delay: 250,
                // }).then(function (datax) {

                //     var option = new Option(datax.items[0].nmopsi, datax.items[0].kdopsi, true, true);
                //     saksi.append(option).trigger('change');
              ...
              $('[name="peringatan"]').val(json.dataTables.items[0].peringatan);
            ...
            $.ajax({
             ...
             $('[name="tindaklanjut"]').val(json.dataTables.items[0].tindaklanjut);
