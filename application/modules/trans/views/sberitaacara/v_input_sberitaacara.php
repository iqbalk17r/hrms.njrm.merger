                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" id="nik" name="nik" placeholder="--- PENANGGUNG JAWAB ---" required>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>Perihal</label>
                                <input type="text" class="form-control" name="subjek" value="<?= $dtl->subjek ?>">
                            </div>
                            <div class="form-group">
                                <label>Kepada</label>
                                <select class="form-control" id="todepartmen" name="todepartmen" placeholder="--- DEPARTMEN ---" required>
                                    <option value="" class=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="lokasi" name="lokasi" placeholder="LOKASI KEJADIAN" style="resize: vertical;" rows="5" required><?= trim($dtl->lokasi) ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Uraian Kejadian</label>
                                <textarea class="form-control" id="uraian" name="uraian" placeholder="URAIAN KEJADIAN" style="resize: vertical;" rows="5" required><?= trim($dtl->uraian) ?></textarea>
                            </div>
                            <div class="form-group">
