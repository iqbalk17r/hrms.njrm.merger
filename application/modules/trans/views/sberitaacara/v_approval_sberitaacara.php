                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Dokumen</label>
                                <input type="text" class="form-control" id="docno" name="docno" value="<?= $dtl->docnotmp ?>" disabled>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group saksi01 xx">
                                <label>Saksi 1</label>
                            ...
                            <div class="form-group saksi02 xx">
                                <label>Saksi 2</label>
                            ...
                            <?php if(in_array(trim($dtl->status), ['AP', 'BP'])): ?>
                                ...
                                <div class="form-group tindaklanjut">
                                    ...
                                    <textarea class="form-control zz" id="tindaklanjut" name="tindaklanjut" placeholder="TINDAKLANJUT" style=" resize: none;" rows="5" required><?= trim($dtl->tindaklanjut) ?></textarea>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
