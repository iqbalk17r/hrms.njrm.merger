...
<script type="text/javascript">
            $(function() {
				...
				$("#nodokdinas").chained("#nikum");	
				//$("#nodokdinas").selectize();	
				$("#nikum").selectize();
				$("#nik").selectize();
			...
			function addCommas(nStr){
				...
				//nomor1=addCommas(parseInt($('#uangmuka').val()));
				
				$(".nomor").keyup(function(){	
					nomor1=addCommas(parseInt($('.nomor').val()));
					//alert (nomor1); uangmukastr
	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
				<a href="<?php echo site_url("trans/dinas/index_deklarasi")?>"  class="btn btn-default" style="margin:10px; color:#00000;">Kembali</a>
					<a href="#" data-toggle="modal" data-target="#inputuangmuka" class="btn btn-primary" style="margin:10px; color:#ffffff;">Input UM</a>
					
					<!---a href="<?php echo site_url("trans/dinas/input_deklarasi_mst")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Input</a--->
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td>
								<a href="<?php $nodok=trim($lu->nodok_ref); $nik=trim($lu->nik); echo site_url("trans/dinas/view_input_tmp/$nodok/$nik")?>">
									 <?php echo $lu->nodok_ref; ?> 
								</a>
							</td>
							...
							<td>
							<a  href="<?php $nodok=trim($lu->nodok); $nik=trim($lu->nik); $nodok_ref=trim($lu->nodok_ref); echo site_url("trans/dinas/final_deklarasi/$nodok/$nik/$nodok_ref")?>" onclick="return confirm('Anda Yakin Simpan Final Data ini?')" class="btn btn-default  btn-sm">
							<i class="fa fa-trash-o"></i> Final
							</a>
							</td>
...
<div class="modal fade" id="filter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	  ...
	  <form action="<?php echo site_url('trans/dinas/deklarasi_dinas_tmp')?>" method="post">
...
<div class="modal fade" id="input" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Input Master Deklarasi</h4>
      </div>
      ...
      <div class="modal-body">
	  	<div class="row">
							<div class="form-group input-sm">
								...
								<div class="col-md-8">     
									<select class="form-control input-sm" name="nikum" id="nikum" required>
									 <option value="" ><?php echo '-- PILIH NIK/NAMA KARYAWAN ---';?></option>	
									  <?php foreach($list_karyawan as $listkan){?>					  
									  <option value="<?php echo trim($listkan->nik);?>" ><?php echo $listkan->nik.' || '.$listkan->nmlengkap;?></option>						  
									  <?php }?>
							...
							<div class="form-group input-sm">
								...
								<div class="col-md-8">    
									<input type="numeric" id="uangmuka" name="uangmuka" class="form-control nomor" required>
									<input type="text" id="uangmukastr" name="uangmukastr" class="form-control nomor" readonly>
