                        ...
                        <div class="box-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="jenis_tujuan" class="select2 form-control " id="jenis_tujuan">
                                            <?php if (isset($default->destinationtype) && count($default->destinationtype) > 0) {
                                                foreach ($default->destinationtype as $index => $row) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="kdkategori" class="select2 form-control " id="kdkategori">
                                            <?php if (isset($default->kategori) && count($default->kategori) > 0) {
                                                foreach ($default->kategori as $index => $row) { ?>
                                                    <option value="<?php echo $row->id ?>" selected ><?php echo $row->text ?></option>
                                                <?php }
                                            } else { ?>
                                                <option></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="tgl_mulai" class="form-control" id="tgl_mulai" value="<?php echo date('d-m-Y H:i', strtotime($default->temporary->tgl_mulai.' '.$default->temporary->jam_mulai)) ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="transportasi" class="select2 form-control " id="transportasi">
                                            <?php if (isset($default->transportasi) && count($default->transportasi) > 0) {
                                                foreach ($default->transportasi as $index => $row) { ?>
                                                    <option value="<?php echo $row->id ?>" selected ><?php echo $row->text ?></option>
                                                <?php }
                                            } else { ?>
                                                <option></option>
