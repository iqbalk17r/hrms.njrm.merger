		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<a href="#" data-toggle="modal" data-target="#input" class="btn btn-primary" style="margin:10px; color:#ffffff;">Input Absen</a>
...
<form action="<?php echo site_url('trans/absensi/input_absensi')?>" method="post">
 ...
 <?php foreach ($list_absen as $ld) { ?> 
  <form action="<?php echo site_url('trans/absensi/edit_absensi')?>" method="post">
  <div class="modal fade" id="<?php echo $ld->id; ?>" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <script type="text/javascript">
								$(function() {                         
									$("#dateinput<?php echo $ld->id;?>").datepicker();                               
								});
			</script>	
		  ...
		  <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                ...
                <input name="nik"  class="form-control" value="<?php echo trim($nik);?>" type="hidden" readonly>
			...
			<div class="form-group">
              <label class="control-label col-md-3">Tanggal</label>
              <div class="col-md-9">
                <input name="tanggal" id="dateinput<?php echo $ld->id;?>" data-date-format="dd-mm-yyyy" class="form-control" value="<?php echo trim($ld->tgl);?>" type="text">
              </div>
            </div>
			<div class="form-group">
              <label class="control-label col-md-3">Jam Masuk</label>
