		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<button  href="#" data-toggle="modal" data-target="#input" class="btn btn-primary" style="margin:10px; color:#ffffff;"><i class="glyphicon glyphicon-plus"></i> Input Jadwal Karyawan</button>
				</div>
			</div><!-- /.box-header -->
					...
					<tbody>
						<?php $no=1; foreach ($list_jadwal as $la){ ?>
							<tr>																					
								...
								<td>
								<a  data-toggle="modal" data-target="#<?php echo $la->id;?>" href='#' onclick="return confirm('Anda Yakin Edit Data ini?')" class="btn btn-default  btn-sm">
