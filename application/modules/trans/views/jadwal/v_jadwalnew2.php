		...
		<div class="box">
			<div class="box-header">
				<div class="col-sm-12">		
					...
					<button href="#" data-toggle="modal" data-target="#gr_jadwal" class="btn btn-primary disabled" style="margin:10px; color:#ffffff;">Generate Jadwal</button>
