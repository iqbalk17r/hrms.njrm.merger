								...
								<script type="text/javascript" charset="utf-8">
									$(function() {	
												$('.oli').on('change', function(){
												 ...
												 $.ajax({
													url : "<?php echo site_url('trans/jadwal_new/ajax_cekjadwalinput')?>/" + idtahun + "/" + idbulan + "/" + kdregu,
													type: "GET",
													dataType: "JSON",
								...
								<div class="form-group input-sm">
								  ...
								  <div class="col-sm-5">
											<select class="form-control input-sm" name="tgl1" required>
												...
												<option value="<?php echo trim($ld->kdjam_kerja);?>"><?php echo trim($ld->kdjam_kerja).' || '.$ld->nmjam_kerja;?></option>
												<?php } ?>																																					
											</select>
								  </div>
