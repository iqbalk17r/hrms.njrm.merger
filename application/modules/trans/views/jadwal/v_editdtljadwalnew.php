<!-- Bootstrap modal -->
 ...
 <form action="<?php echo site_url('trans/jadwal_new/proses_edit_detail')?>" method="post">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form">
			 ...
			 <div class="form-group">
              ...
              <div class="col-md-9">
						<select class="form-control input-sm" id="kdjamkerja1" name="kdjamkerja" required>
							...
							<option <?php if (trim($dtl_jadwal['kdjamkerja'])==trim($ld->kdjam_kerja)) { echo 'selected';} ?> value="<?php echo trim($ld->kdjam_kerja);?>"><?php echo $ld->nmjam_kerja;?></option>
							<?php } ?>																																					
						</select>
              </div>
            </div>
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo site_url('trans/jadwal_new/index');?>"  class="btn btn-danger" >Cancel</a>
			</div>
          </div>
        </div><!-- /.modal-content -->
