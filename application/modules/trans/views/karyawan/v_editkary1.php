					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<select  name="jk" style="text-transform:uppercase;"  class="form-control" type="text" >
							...
							<option value="W" <?php if (trim($dtl['jk'])=='W') { echo 'selected';}?>>WANITA</option>
						</select>
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">								
						<select name="stastus_pernikahan" style="text-transform:uppercase;" placeholder="Nama Panggilan" class="form-control" type="text" >																		
							...
							<option value="<?php echo trim($lonikah->kdnikah);?>" <?php if (trim($dtl['stastus_pernikahan'])==trim($lonikah->kdnikah)) { echo 'selected';}?> ><?php echo trim($lonikah->nmnikah);?></option>																																																			
							<?php };?>									
						</select>
					  </div>
					</div>
				...
				<div class="col-sm-12">
				  <h3> Step 5</h3>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="nohp1" value="<?php echo $dtl['nohp1'];?>" style="text-transform:uppercase;" placeholder="Nomor Handphone Utama" class="form-control" type="text" >
					  </div>
					</div>												
					<div class="form-group">
					  <label class="control-label col-sm-3">NO HP kedua</label>
					  <div class="col-sm-9">
						<input name="nohp2" value="<?php echo $dtl['nohp2'];?>" style="text-transform:uppercase;" placeholder="Nomor Handphone Lainnya" class="form-control" type="text" >
					  </div>
					</div>											
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="npwp" value="<?php echo $dtl['npwp'];?>" style="text-transform:uppercase;" placeholder="Nomor NPWP" class="form-control" type="text" >
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">Tanggal NPWP</label>
					  <div class="col-sm-9">
						<input name="tglnpwp" value="<?php echo $dtl['tglnpwp'];?>" style="text-transform:uppercase;" placeholder="Tanggal NPWP" id="tglnpwp" data-date-format="dd-mm-yyyy" class="form-control" type="text" >
					  </div>
					</div>				  
				</div>
			  </div>
				...
				<div class="col-sm-12">
				  <h3> Step 6</h3>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="grade_golongan" id='jobgrade' class="form-control col-sm-12" >
								<option value="">-KOSONG-</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="nik_atasan" class="form-control col-sm-12" >										
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="nik_atasan2" class="form-control col-sm-12" >										
								<?php foreach ($list_opt_atasan as $loan){ ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="status_ptkp" class="form-control col-sm-12" >										
								...
								<option value="<?php echo trim($lptkp->kodeptkp);?>" <?php if (trim($dtl['status_ptkp'])==trim($lokec->kodekec)) { echo 'selected';}?> ><?php echo trim($lptkp->kodeptkp).' | '.trim($lptkp->besaranpertahun);?></option>																																																			
								<?php };?>
							</select>
						</div>
					</div>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="tglmasukkerja" value="<?php echo $dtl['tglmasukkerja'];?>" style="text-transform:uppercase;" placeholder="Tanggal Masuk Karyawan" id="tglmasuk" data-date-format="dd-mm-yyyy" class="form-control" type="text" >
					  </div>
					</div>				  
				</div>
			  </div>
				...
				<div class="col-sm-12">
				  <h3> Step 7</h3>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="gajipokok" value="<?php echo $dtl['gajipokok'];?>" style="text-transform:uppercase;" placeholder="Gaji Pokok" class="form-control" type="text" >
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">Gaji BPJS</label>
					  <div class="col-sm-9">
						<input name="gajibpjs" value="<?php echo $dtl['gajibpjs'];?>" style="text-transform:uppercase;" placeholder="Gaji BPJS" class="form-control" type="text" >
					  </div>
					</div>
					<div class="form-group">
				...
				<div class="col-sm-12">
				  <h3> Step 8</h3>
					<div class="form-group">
					  <label class="control-label col-sm-3">ID Absensi</label>
					  <div class="col-sm-9">
						<input name="idabsen" style="text-transform:uppercase;" value="<?php echo $dtl['idabsen'];?>" placeholder="Nomor ID Absensi" class="form-control" type="text" required>
					  </div>
					</div>
					<div class="form-group">
					 ...
					 <select type="text" class="form-control" name="idmesin" id="idmesin">
							<option  <?php if(trim($dtl['idmesin'])=='1') { echo 'selected';} ?> value="1"> 1</option>
							<option  <?php if(trim($dtl['idmesin'])=='2') { echo 'selected';} ?> value="2"> 2</option>
							<option  <?php if(trim($dtl['idmesin'])=='3') { echo 'selected';} ?> value="3"> 3</option>
							<option   <?php if(trim($dtl['idmesin'])=='4') { echo 'selected';} ?> value="4"> 4</option>
							<option  <?php if(trim($dtl['idmesin'])=='5') { echo 'selected';} ?> value="5"> 5</option>
							<option   <?php if(trim($dtl['idmesin'])=='6') { echo 'selected';} ?> value="6"> 6</option>
							<option  <?php if(trim($dtl['idmesin'])=='7') { echo 'selected';} ?> value="7"> 7</option>
					</select>
					  </div>
					</div>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="cardnumber" style="text-transform:uppercase;" value="<?php echo $dtl['cardnumber'];?>" maxlength="12" placeholder="Card Number" class="form-control" type="text">
					  </div>
					</div>
