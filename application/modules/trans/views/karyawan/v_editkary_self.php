...
<div class="row">
	<div class="col-sm-12">
	<form action="<?php echo site_url('trans/karyawan/update_self_person'); ?>" method='post' id="form"> 
<div class="form-horizontal">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">					
				<li><a href="#tab_1" data-toggle="tab">Profile Karyawan</a></li>
				...
				<li class="active"><a href="#tab_5" data-toggle="tab">Kontak</a></li>					
				<li><a href="#tab_6" data-toggle="tab">Jabatan Pekerjaan</a></li>					
				<li><a href="#tab_7" data-toggle="tab">Sallary</a></li>				
				...
				<div class="col-sm-12">
				  <h3> Step 1</h3>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="nmlengkap" style="text-transform:uppercase;" value="<?php echo $dtl['nmlengkap'];?>" placeholder="Nama Lengkap" class="form-control" type="text" readonly>
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">Nama Panggilan</label>
					  <div class="col-sm-9">
						<input name="callname" style="text-transform:uppercase;" placeholder="Nama Panggilan" value="<?php echo $dtl['callname'];?>" class="form-control" type="text" readonly>
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="tgllahir" style="text-transform:uppercase;" value="<?php echo $dtl['tgllahir'];?>" data-date-format="dd-mm-yyyy" placeholder="Tanggal Lahir" class="form-control" id="tgl" type="text" readonly>
					  </div>
					</div>
					<div class="form-group">
				...
				<div class="col-sm-12">
				  <h3> Step 2</h3>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="kdcabang" id='kanwil' class="form-control col-sm-12" disabled>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="tglmasukkerja" value="<?php echo $dtl['tglmasukkerja'];?>" style="text-transform:uppercase;" placeholder="Tanggal Masuk Karyawan" id="tglmasuk2" data-date-format="dd-mm-yyyy"  class="form-control" type="text" disabled>
						</div>
					</div>
				</div>
			  </div>
				...
				<div class="col-sm-12">
				  <h3> Step 3</h3>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="noktp" style="text-transform:uppercase;" placeholder="No Ktp" value="<?php echo $dtl['noktp'];?>" class="form-control" type="text" readonly>
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">KTP Dikeluaran di</label>
					  <div class="col-sm-9">
						<input name="ktpdikeluarkan" style="text-transform:uppercase;" value="<?php echo $dtl['ktpdikeluarkan'];?>" placeholder="Kota KTP di keluarkan" class="form-control" type="text" readonly>
					  </div>
					</div>							
					<div class="form-group">
					  <label class="control-label col-sm-3">Tanggal KTP Dikeluaran</label>
					  <div class="col-sm-9">
						<input name="tgldikeluarkan" style="text-transform:uppercase;" value="<?php echo $dtl['tgldikeluarkan'];?>" placeholder="Tanggal KTP Di keluarkan" data-date-format="dd-mm-yyyy" class="form-control" id="tgl2" type="text" readonly>
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">							  
						<div id="f" class="ktpseumurhidupku" style="display:none">
						  ...
						  <div class="col-sm-9">
							<textarea name="tglberlaku" id="tglktp"  style="text-transform:uppercase;" value="<?php echo $dtl['tglberlaku'];?>" data-date-format="dd-mm-yyyy" class="form-control" readonly ></textarea>
						  </div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">								
						<select name="status_pernikahan" style="text-transform:uppercase;" placeholder="Nama Panggilan" class="form-control" type="text" disabled>
			  ...
			  <div class="col-sm-12 ">
				<div class="col-sm-12">
				  ...
				  <div class="form-group">
								...
								<div class="col-sm-8">    
									<select name="negktp" id='almnegara' class="form-control col-sm-12" readonly >										
										<?php foreach ($list_opt_neg as $lon){ ?>
							...
							<div  class="form-group"  >							  
							  ...
							  <div class="col-sm-9">
								<textarea name="alamatktp" style="text-transform:uppercase;" placeholder="Alamat sesuai dengan KTP" class="form-control" readonly><?php echo $dtl['alamatktp'];?></textarea>
							  </div>							  
							</div>							
							<div class="form-group">
							...
							<div  class="form-group"  >							  
							  ...
							  <div class="col-sm-9">
								<textarea name="alamattinggal" style="text-transform:uppercase;" placeholder="Alamat sesuai dengan KTP" class="form-control" readonly ><?php echo $dtl['alamattinggal'];?></textarea>
							  </div>							  
							</div>				  
				</div>
			  </div>
				...
				<div class="col-sm-12">
				  <h3> Step 5</h3>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="npwp" value="<?php echo $dtl['npwp'];?>" style="text-transform:uppercase;" placeholder="Nomor NPWP" class="form-control" type="input" readonly>
					  </div>
					</div>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						...
						<input name="tglnpwp" style="text-transform:uppercase;" value="<?php echo $dtl['tglnpwp'];?>" data-date-format="dd-mm-yyyy" placeholder="Tanggal NPWP" class="form-control" id="tglnpwp2" type="text" readonly>
					  </div>
					</div>				  
				</div>
			  </div>
				...
				<div class="col-sm-12">
				  <h3> Step 6</h3>
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="bag_dept_" id='dept' class="form-control col-sm-12" disabled>										
								<?php foreach ($list_opt_dept as $lodept){ ?>
								<option value="<?php echo trim($dtl['bag_dept']);?>" <?php if (trim($dtl['bag_dept'])==trim($lodept->kddept)) { echo 'selected';}?> ><?php echo trim($lodept->nmdept);?></option>																																																			
								<?php };?>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8" >    
							<select name="subbag_dept_" id='subdept' class="form-control col-sm-12" disabled>
								<option value="">-KOSONG-</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="jabatan_" id='jabatan' class="form-control col-sm-12" disabled>	
								<option value="">-KOSONG-</option>
					...
					<!--<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="lvl_jabatan_" id='lvljabatan' class="form-control col-sm-12" disabled>										
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="nik_atasan" id="nikatasan1" class="form-control col-sm-12" disabled >										
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="nik_atasan2" id="nikatasan2" class="form-control col-sm-12" disabled>										
								<?php foreach ($list_opt_atasan as $loan){ ?>
				...
				<div class="col-sm-12">
				  <h3> Step 7</h3>
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="grouppenggajian" class="form-control col-sm-12" readonly>										
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<select name="namabank" id='dept' class="form-control col-sm-12" readonly >										
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="namapemilikrekening" value="<?php echo $dtl['namapemilikrekening'];?>" style="text-transform:uppercase;" placeholder="Nama Pemilik Rekening" class="form-control" type="text" readonly >
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">Nomor Rekening</label>
					  <div class="col-sm-9">
						<input name="norek" value="<?php echo $dtl['norek'];?>" style="text-transform:uppercase;" placeholder="Nomor Rekening" class="form-control" type="text" readonly>
					  </div>
					</div>
					<!--<div class="form-group">
				...
				<div class="col-sm-12">
				  <h3> Step 8</h3>
					<div class="form-group">
					  <label class="control-label col-sm-3">ID Absensi</label>
					  <div class="col-sm-9">
						<input name="idabsen" style="text-transform:uppercase;" value="<?php echo trim($dtl['idabsen']);?>" placeholder="Nomor ID Absensi" class="form-control" type="text" readonly>
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
								 <select type="text" class="form-control" name="borong" id="borong" disabled>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
								 <select type="text" class="form-control" name="shift" id="shift" disabled>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
								 <select type="text" class="form-control" name="lembur" id="lembur" disabled>
...
<div class="row">
	<div class="col-sm-6">		
		<a href="<?php echo site_url('trans/karyawan/karyawan_self');?>" class="btn btn-primary" style="margin:10px">Kembali</a>
