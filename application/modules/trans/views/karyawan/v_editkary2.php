				...
				<div class="col-sm-12">
				  <h3> Step 6</h3>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="grade_golongan_" id='jobgrade' class="form-control col-sm-12" disabled>
								<option value="">-KOSONG-</option>
				...
				<div class="col-sm-12">
				  <h3> Step 8</h3>
					<div class="form-group">
					  <label class="control-label col-sm-3">ID Absensi</label>
					  <div class="col-sm-9">
						<input name="idabsen" style="text-transform:uppercase;" value="<?php echo $dtl['idabsen'];?>" placeholder="Nomor ID Absensi" class="form-control" type="text" >
					  </div>
					</div>
					<div class="form-group">
