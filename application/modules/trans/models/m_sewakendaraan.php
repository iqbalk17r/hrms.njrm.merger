<?php
class m_sewakendaraan extends CI_Model{

    function q_sewakendaraan_regu($kdcabang, $awal, $akhir, $callplan, $borong) {
        return $this->db->query("
            SELECT ROW_NUMBER() OVER () AS no, a.nik, a.tgl, CASE WHEN GROUPING(b.nmlengkap) = 0 THEN b.nmlengkap ELSE 'GRAND TOTAL UANG SEWA KENDARAAN' END AS nmlengkap, 
