        ...
        return $this->db->query("
            SELECT 
				...
				LEFT JOIN LATERAL(
                        select
                           CASE
								WHEN tr.jam_istirahat_in IS NOT NULL
								AND tr.jam_istirahat_out IS NOT NULL
								THEN
									to_char(tr.jam_istirahat_in::time, 'HH24:MI:SS')
									|| ' | ' ||
									to_char(tr.jam_istirahat_out::time, 'HH24:MI:SS')
								ELSE NULL
							END AS rest_time
