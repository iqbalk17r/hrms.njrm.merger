...
<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/pembelian/clear_tmp_po/$enc_nik")?>"  onclick="return confirm('PERINGATAN KEMBALI AKAN MENGHAPUS SEMUA INPUTAN YG TELAH ANDA BUAT, TEKAN (OK) JIKA ANDA SETUJU, JIKA TIDAK TEKAN (BATAL)')" class="btn btn-default" style="margin:10px; color:#000000;"><i class="fa fa-arrow-left"></i> Kembali</a>
			
		</div>
		<a href="<?php echo site_url("ga/pembelian/final_batal_po/$enc_nik")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat Akan Dibatalkan?')" class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;"><i class="fa fa-trash-o"></i> Batal PO</a>
	<div class="col-xs-12">                            
		<div class="box">
			<div class="box-header"  align="center">
			<h5><b><strong><?php echo 'MASTER PEMBELIAN BARANG';?></strong></b></h5>
			</div><!-- /.box-header -->	
					...
					<thead>
						...
						<tr>
							...
							<a href="<?php 
									...
									echo site_url("ga/pembelian/detail_supplier_po_mst_tmp/$enc_nodok");?>" onclick="return confirm('Detail Supplier')" class="btn btn-default  btn-sm-1"><i class="fa fa-check-square"></i></a>	
							</td>
						</tr>
						<?php endforeach;?>	
							</tbody>		
					...
					<thead>
						...
						<tr>
							...
							<td width="5%">
									...
									echo site_url("ga/pembelian/detail_po_dtl_tmp/$enc_rowid");?>" onclick="return confirm('Anda Akan Masuk Ke Menu Mapping Satuan Rekap?')" class="btn btn-default  btn-sm-1"><i class="fa fa-cogs"></i></a>	
										...
										<table id="example3" class="table table-bordered table-striped" >
											...
											<tbody>
												...
												<tr>										
													...
													<td>
													<a href="#" data-toggle="modal" data-target="#DTLREVITEMQUERY<?php echo trim($lu->rowid);?>"  onclick="return confirm('Lihat Detail ?')" class="btn btn-default  btn-sm-1"><i class="fa fa-edit"></i></a>
													</td>							
												</tr>
												<?php endforeach;?>
											</tbody>
										...
										<tbody>
											...
											<tr>										
												...
												<td>
													...
													<a href="#" data-toggle="modal" data-target="#APPMAPING<?php echo trim($lu->rowid);?>"   class="btn btn-warning  btn-sm-1"><i class="fa fa-check-square"></i></a>			
													<?php } else if (trim($lu->stockcode)<>'' and trim($lu->status)=='M') { ?>
													<a href="#" data-toggle="modal" data-target="#DTLREVITEM<?php echo trim($lu->rowid);?>"  class="btn btn-success  btn-sm-1"><i class="fa fa-check-square"></i></a>
													<?php } ?>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
					<div class="form-horizontal">
						<form action="<?php echo site_url('ga/pembelian/edit_po_atk').'/'.$enc_nodok;?>" name="form" role="form" method="post">										
