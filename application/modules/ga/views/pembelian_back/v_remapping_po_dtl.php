					...
					<div class="box-body">
						...
						<!--?php } else { ?--->
							...
							<div class="form-group row">
								...
								<div class="col-sm-4"> 
									<input type="number"  id="unitprice" name="unitprice"  value="<?php echo str_replace('.',',',trim($po_dtl['unitprice']));?>"  placeholder="0" class="form-control ratakanan" required>
								</div>
							</div>	
						<!---?php } ?---->	
							...
							<div class="form-group row">
								...
								<div class="col-sm-4"> 
									<input type="number"  id="ttlbrutto" name="ttlbrutto"  value="<?php echo str_replace('.',',',trim($po_dtl['ttlbrutto']));?>"  placeholder="0" class="form-control ratakanan" readonly>
								</div>
								<span class="col-sm-4"> 
							...
							<div class="form-group row diskonform">
								...
								<span class="col-sm-2"> 
									...
									<input type="number"  value="<?php echo str_replace('.',',',trim($po_dtl['disc1']));?>" id="disc1" name="disc1" placeholder="0" value="0" class="form-control col-sm-1 ratakanan" >
								</span>	                                                                                          
								<span class="col-sm-2">                                                                           
									<label class="col-sm-4">2+</label>                                                
									<input type="number"  value="<?php echo str_replace('.',',',trim($po_dtl['disc2']));?>" id="disc2" name="disc2" placeholder="0" value="0" class="form-control col-sm-1 ratakanan" >
								</span>	                                                                                           
								<span class="col-sm-2">                                                                            
									<label class="col-sm-4">3+</label>                                                 
									<input type="number"  value="<?php echo str_replace('.',',',trim($po_dtl['disc3']));?>"  id="disc3" name="disc3" placeholder="0" value="0" class="form-control col-sm-1 ratakanan" >
								</span>									
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-4">    
									...
									<input type="number" value="<?php echo trim($po_dtl['ttldpp']);?>"  id="ttldpp" name="ttldpp" placeholder="0" class="form-control ratakanan" readonly >
								</div>	
								<span class="col-sm-4"> 	
