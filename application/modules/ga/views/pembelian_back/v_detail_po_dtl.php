...
<div class="box-body">										
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group drst">
								<label class="col-sm-4" for="inputsm">Kode Group Barang</label>	
									<div class="col-sm-8">  
									<select class="form-control input-sm ch" name="kdgroup" id="mpkdgroup" disabled readonly>
						...
						<!--?php } else { ?--->
								...
								<div class="col-sm-8">
									<select class="form-control input-sm"  name="satminta" id="satminta" disabled readonly>
									 <option  value="">---PILIH KDSATUAN || NAMA SATUAN--</option> 
									  ...
									  <option <?php if (trim($sc->kdtrx)==trim($po_dtl['satminta'])) { echo 'selected';}?>  value="<?php echo trim($sc->kdtrx);?>"><?php echo trim($sc->uraian).' || '.trim($sc->kdtrx);?></option>						  
									  <?php }?>
									</select>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-4"> 
									<input type="input"  id="unitprice" name="unitprice"  value="<?php echo trim($po_dtl['unitprice']);?>"  onkeyup="formatangkaobjek(this)" placeholder="0" class="form-control ratakanan" readonly>
								</div>
							</div>	
						<!---?php } ?---->	
							...
							<div class="form-group row">
								...
								<div class="col-sm-4"> 
									<input type="input"  id="ttlbrutto" name="ttlbrutto"  value="<?php echo trim($po_dtl['ttlbrutto']);?>"  onkeyup="formatangkaobjek(this)" placeholder="0" class="form-control ratakanan"  disabled readonly>
								</div>
								<!--span class="col-sm-4"> 
							...
							<div class="form-group row diskonform">
								...
								<span class="col-sm-2"> 
									...
									<input type="input"   value="<?php echo trim($po_dtl['disc1']);?>" id="disc1" name="disc1" placeholder="0" value="0" class="form-control col-sm-1 ratakanan"  disabled readonly>
								</span>	                                                                                          
								<span class="col-sm-2">                                                                           
									<label class="col-sm-4">2+</label>                                                
									<input type="input"  value="<?php echo trim($po_dtl['disc2']);?>" id="disc2" name="disc2" placeholder="0" value="0" class="form-control col-sm-1 ratakanan"  disabled readonly>
								</span>	                                                                                           
								<span class="col-sm-2">                                                                            
									<label class="col-sm-4">3+</label>                                                 
									<input type="input"  value="<?php echo trim($po_dtl['disc3']);?>"  id="disc3" name="disc3" placeholder="0" value="0" class="form-control col-sm-1 ratakanan"  disabled readonly>
								</span>									
							</div>
							<div class="form-group row">
							...
							<div class="form-group">
								...
								<span class="col-sm-4"> 	
									...
									<span class="col-sm-6"> 
									<input type="hidden" name="exppn" value="<?php echo trim($po_mst['exppn']); ?>"  disabled readonly>
									<select class="form-control col-sm-12" name="exppn" id="checkexppn"  disabled readonly>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<textarea type="text" id="keterangan" name="keterangan"   style="text-transform:uppercase" class="form-control" disabled readonly><?php echo trim($po_dtl['keterangan']);?></textarea>
								</div>
							</div>		
      ...
      <div class="box-footer">
			...
			echo site_url("ga/pembelian/detail_po_atk/$enc_nodoktmp");?>" type="button" class="btn btn-default"/> Kembali</a>
