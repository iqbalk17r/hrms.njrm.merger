...
<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("ga/pembelian/form_sppb")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_sppb_trx_mst as $row): $no++;?>
								<tr>
									...
									<td><?php if (isset($row->approvaldate)) { echo date('d-m-Y', strtotime(trim($row->approvaldate))); } else { echo '';} ?></td>
									<!--td>
					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example2" class="table table-bordered table-striped" >
							<thead>
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_sppb_trx_dtl as $row): $no++;?>
								<tr>
									...
									<td width="6%">
										<a href="#" data-toggle="modal" data-target="#DTL<?php echo str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-default  btn-sm"><i class="fa fa-default"></i> Detail </a>						
