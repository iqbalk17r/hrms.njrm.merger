...
<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/pembelian/clear_tmp_po/$enc_nik")?>"  onclick="return confirm('PERINGATAN KEMBALI AKAN MENGHAPUS SEMUA INPUTAN YG TELAH ANDA BUAT, TEKAN (OK) JIKA ANDA SETUJU, JIKA TIDAK TEKAN (BATAL)')" class="btn btn-default" style="margin:10px; color:#000000;" title="KEMBALI"><i class="fa fa-arrow-left"></i> Kembali </a>
			
		</div>
    <a href="<?php echo site_url("ga/pembelian/final_input_po/$enc_nik")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;" title="SIMPAN PURCHASE ORDER"><i class="fa fa-save"></i> </a>
	<div class="col-xs-12">                            
		<div class="box">
			<div class="box-header"  align="center">
			<h5><b><strong><?php echo 'MASTER PEMBELIAN BARANG INPUT SUPPLIER';?></strong></b></h5>
			</div><!-- /.box-header -->	
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example1" class="table table-bordered table-striped" >
					<thead>
							...
							<tbody>
							<?php $no=0; foreach($list_tmp_po_mst as $row): $no++;?>
						<tr>
							...
							<a href="<?php 
									...
									echo site_url("ga/pembelian/input_supplier_po_mst/$enc_nodok");?>" onclick="return confirm('Anda Akan Masuk Input Ke Supplier?')" class="btn btn-primary  btn-sm-1" title="Ubah Supplier PO & Type PO"><i class="fa fa-cogs"></i> </a>
							</td>
						</tr>
						<?php endforeach;?>	
							</tbody>		
	...
	<div class="col-xs-12"> 
		<div class="box">
			<div class="box-header"  align="center">
			<h5><b><strong><?php echo 'DETAIL PERMINTAAN PER SATUAN STOCK';?></strong></b></h5>
			</div><!-- /.box-header -->	
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example2" class="table table-bordered table-striped" >
					<thead>
							...
							<tbody>
							<?php $no=0; foreach($list_tmp_po_dtl as $row): $no++;?>
						<tr>
							...
							<td width="10%">
									...
									echo site_url("ga/pembelian/remapping_po_dtl/$enc_rowid");?>" onclick="return confirm('Anda Akan Masuk Ke Menu Mapping Satuan Rekap?')" class="btn btn-primary  btn-sm-1" title="Ubah Rekap Per Item Barang"><i class="fa fa-cogs"></i></a>
									<a href="<?php 
									$enc_rowid=bin2hex($this->encrypt->encode(trim($row->id)));
									echo site_url("ga/pembelian/hapus_detail_inputpo/$enc_rowid");?>" onclick="return confirm('Hapus Detail Akan Menghapus Referensi Yang Bersangkutan?')" class="btn btn-danger  btn-sm-1" title="Hapus Rekap Per Item Barang"><i class="fa fa-cog"></i></a>
								...
								<div class="box box-danger">
									...
									<div class="box-body table-responsive" style='overflow-x:scroll;'>
										<table id="example3" class="table table-bordered table-striped" >
											...
											<tbody>
												<?php $no=0; foreach($list_tmp_po_dtlref_query as $lu): $no++;?>
												<tr>										
													<td width="2%"><?php echo $no;?></td>																							
													<td width="8%">
															 <input type="checkbox" name="centang[]" value="<?php echo trim($lu->strtrimref);?>" ><br>
													</td>
													<td><?php echo $lu->nodok;?></td>
													<td><?php echo $lu->nik;?></td>
													<td><?php echo $lu->desc_barang;?></td>
                                                    <?php if (trim($dtlmst['itemtype'])!='JSA') { ?>
													<td><?php echo $lu->qtyforpo;?></td>
													<!--td><?php echo $lu->qtypo;?></td--->
													<td><?php echo $lu->nmsatminta;?></td>
                                                    <?php } ?>
													<!--td><?php echo $lu->strtrimref;?></td-->							
													<td>
													<a href="#" data-toggle="modal" data-target="#DTLREVITEMQUERY<?php echo trim($lu->rowid);?>" class="btn btn-default  btn-sm-1" title="Detail Referensi Pembelian"><i class="fa fa-edit"></i></a>
													</td>							
												</tr>
												<?php endforeach;?>
											</tbody>
							...
							<div class="box box-danger">
								...
								<div class="box-body table-responsive" style='overflow-x:scroll;'>
									<table id="example4" class="table table-bordered table-striped" >
										...
										<tbody>
											<?php $no=0; foreach($list_tmp_po_dtlref as $lu): $no++;?>
											<tr>										
												<td width="2%"><?php echo $no;?></td>																							
												<td width="8%">
												...
												<td>
													<?php if ((trim($lu->stockcode)=='') and trim($lu->status)=='I' or (trim($lu->qtykecil)==0)) { ?>
															...
															echo site_url("ga/pembelian/mapping_po_dtlrev/$enc_rowid");?>" class="btn btn-primary  btn-sm-1"><i class="fa fa-cogs"></i></a>			
													<?php } else if(trim($lu->stockcode)<>'' and trim($lu->status)=='I' and trim($lu->qtyminta)>0) { ?>
													<a href="#" data-toggle="modal" data-target="#APPMAPING<?php echo trim($lu->rowid);?>"   class="btn btn-warning  btn-sm-1" title="Validasi Pembelian"><i class="fa fa-check-square"></i></a>
													<?php } else if (trim($lu->stockcode)<>'' and trim($lu->status)=='M') { ?>
													<a href="#" data-toggle="modal" data-target="#DTLREVITEM<?php echo trim($lu->rowid);?>"  class="btn btn-success  btn-sm-1" title="Mapping Pembelian"><i class="fa fa-check-square"></i></a>
													<?php } ?>
...
<div class="modal fade" id="DTLREVITEMQUERY<?php echo trim($lb->rowid);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="DTLREVITEMQUERY" class="form-control" style="text-transform:uppercase">								
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group ">
								...
								<div class="col-sm-8"> 
									<input type="input" name="kdbarang" id="kdbarang" value="<?php echo trim($lb->stockcode);?>" class="form-control " readonly>
							...
							<div class="form-group drst">
								...
								<div class="col-sm-8">    
									<input type="number" id="qtyminta" name="qtyminta"  value="<?php echo trim($lb->qtyminta);?>"   placeholder="0" class="form-control drst" readonly >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8"> 
									<input type="input" id="satminta" class="form-control drst" value="<?php echo trim($lb->nmsatminta);?>" readonly>
								</div>
							</div>
                            <?php } ?>
							<div class="form-group">
...
<?php foreach ($list_tmp_po_dtlref as $lb) { ?>
<div class="modal fade" id="APPMAPING<?php echo trim($lb->rowid);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($lb->nik); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="APPMAPING" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="nodok" name="nodok"  value="<?php echo trim($lb->nodok);?>" class="form-control" style="text-transform:uppercase">
									<input type="hidden"  name="nodokref"  value="<?php echo trim($lb->nodokref);?>" class="form-control" style="text-transform:uppercase">
									<input type="hidden"  name="kdgroup"  value="<?php echo trim($lb->kdgroup);?>" class="form-control" style="text-transform:uppercase">
									<input type="hidden"  name="kdsubgroup"  value="<?php echo trim($lb->kdsubgroup);?>" class="form-control" style="text-transform:uppercase">
									<input type="hidden"  name="stockcode"  value="<?php echo trim($lb->stockcode);?>" class="form-control" style="text-transform:uppercase">
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">Kode Barang</label>	
								<div class="col-sm-8"> 
									<input type="input" name="kdbarang" id="kdbarang" value="<?php echo trim($lb->stockcode);?>" class="form-control kdbarang "  readonly>
									<input type="hidden" name="kdgroup" id="kdgroup" value="<?php echo trim($lb->kdgroup);?>" class="form-control "  >
									<input type="hidden" name="kdsubgroup" id="kdsubgroup" value="<?php echo trim($lb->kdsubgroup);?>" class="form-control "  >
								</div>
							...
							<div class="form-group drst">
								<label class="col-sm-4">Quantity Permintaan</label>	
								<div class="col-sm-4">    
									<input type="number" id="qtyminta_appmapping<?php echo trim($lb->rowid);?>" name="qtyminta"  value="<?php echo trim($lb->qtyminta);?>"   placeholder="0" class="form-control drst">
								</div>
								<div class="col-sm-4">    
									<input type="number" id="qtyminta_appmapping_cek<?php echo trim($lb->rowid);?>" value="<?php echo trim($lb->qtyminta);?>"   placeholder="0" class="form-control drst" readonly>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="number" id="qtykecil_appmapping" name="qtykecil"  value="<?php echo trim($lb->qtykecil);?>"   placeholder="0" class="form-control drst" readonly >
								</div>
							</div>
							<div class="form-group drst">
								<label class="col-sm-4">SATUAN TERKECIL</label>	
								<div class="col-sm-8">    
									<input type="text" name="mpnmsatkecil" class="form-control" value="<?php echo trim($lb->nmsatkecil);?>" readonly >
									<input type="hidden" id="mpsatkecil" name="satkecil"   value="<?php echo trim($lb->satkecil);?>" class="form-control drst" readonly >
								</div>
							</div>
                            <?php } else { ?>
...
<!---------- DETAIL VIEW DTLREF PO -------------->
<?php foreach ($list_tmp_po_dtlref as $lb) { ?>
<div class="modal fade" id="DTLREVITEM<?php echo trim($lb->rowid);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">Kode Barang</label>	
								<div class="col-sm-8"> 
								<input type="text" name="kdbarang" id="kdbarang" value="<?php echo trim($lb->stockcode);?>" class="form-control kdbarang " readonly >
								</div>
							...
							<div class="form-group ">
								<label class="col-sm-4">Quantity Terkecil</label>	
								<div class="col-sm-8">    
									<input type="number" id="qtykecil" name="qtykecil"  value="<?php echo trim($lb->qtykecil);?>"   placeholder="0" class="form-control drst" readonly >
								</div>
							</div>
							<div class="form-group drst">
								<label class="col-sm-4">SATUAN TERKECIL</label>	
...
<div class="modal fade" id="FILTEROUTSTANDING" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
					<div class="form-horizontal">
						<form action="<?php echo site_url('ga/pembelian/input_po');?>" name="form" role="form" method="post">										
							...
							<div class="form-group"> 
								<div class="col-lg-12">
									<button type='submit' class='btn btn-primary pull-right' ><i class="glyphicon glyphicon-search"></i> FILTER</button>
