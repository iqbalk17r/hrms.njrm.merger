...
<div class="row">
    ...
    <a href="<?php echo site_url("ga/pembelian/final_input_po/$enc_nik")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;" title="SIMPAN UBAH DATA PO"><i class="fa fa-save"></i></a>
	<div class="col-xs-12">                            
		<div class="box">
					...
					<thead>
						...
						<tr>
							...
							<td width="10%">
									...
									echo site_url("ga/pembelian/remapping_po_dtl/$enc_rowid");?>" onclick="return confirm('Anda Akan Masuk Ke Menu Mapping Satuan Rekap?')" class="btn btn-primary  btn-sm-1"  title="Ubah Harga Barang PO"><i class="fa fa-cogs"></i></a>
