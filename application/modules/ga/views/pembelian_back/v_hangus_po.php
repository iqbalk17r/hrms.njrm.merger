...
<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/pembelian/clear_tmp_po/$enc_nik")?>"  onclick="return confirm('PERINGATAN KEMBALI AKAN MENGHAPUS SEMUA INPUTAN YG TELAH ANDA BUAT, TEKAN (OK) JIKA ANDA SETUJU, JIKA TIDAK TEKAN (BATAL)')" class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
			
		</div>
		<a href="<?php echo site_url("ga/pembelian/final_hangus_po/$enc_nik")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat Akan Dihanguskan Dan Qty Yg diterima akan sama?')" class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;">HANGUS PO</a>
	<div class="col-xs-12">                            
		<div class="box">
