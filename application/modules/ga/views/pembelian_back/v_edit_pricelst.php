...
<?PHP /*<legend><?php echo $title;?></legend>*/ ?>
<span id="postmessages"></span>

<div class="box">
	<div class="box-content">
	  <div class="box-header">
		<h4 class="box-title" id="myModalLabel">EDIT DAFTAR HARGA/PRICE LIST PEMBELIAN</h4>
	  </div>
...
<div class="box-body">										
			...
			<div class="col-sm-12">
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">	
									<input type="hidden" id="type" name="type"  value="EDIT_PRICELST" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="id" name="id"  value="<?php echo trim($pricelst['id']);?>" class="form-control" style="text-transform:uppercase" readonly>
				
							<div class="form-group drst">
								<label class="col-sm-4" for="inputsm">Kode Kategori Supplier</label>	
									<div class="col-sm-8">  
									<select class="form-control input-sm ch" name="kdgroupsupplier" id="kdgroupsupplier" readonly disabled>
									 <option value="">---PILIH KODE KATEGORI SUPPLIER--</option> 
									  <?php foreach($trxsupplier as $sc){?>					  
									  <option   <?php if (trim($sc->kdtrx)==trim($pricelst['kdgroupsupplier'])) { echo 'selected';}?>  value="<?php echo trim($sc->kdtrx);?>" ><?php echo trim($sc->kdtrx).' || '.trim($sc->uraian);?></option>						  
									  <?php }?>
									</select>
									</div>
							</div>
							<div class="form-group drst">
								<label class="col-sm-4" for="inputsm">Kode Supplier</label>	
									<div class="col-sm-8">  
									<select class="form-control input-sm ch" name="kdsupplier" id="kdsupplier" readonly disabled>
									 <option value="">---PILIH KODE SUPPLIER || NAMA SUPPLIER--</option> 
									  <?php foreach($list_msupplier as $sc){?>					  
									  <option   <?php if (trim($sc->kdsupplier)==trim($pricelst['kdsupplier'])) { echo 'selected';}?>  value="<?php echo trim($sc->kdsupplier);?>"  class="<?php echo trim($sc->kdgroup);?>"  ><?php echo trim($sc->kdsupplier).' || '.trim($sc->nmsupplier);?></option>						  
									  <?php }?>
									</select>
									</div>
							</div>
							<div class="form-group ">
								...
								<div class="col-sm-8"> 
									<select class="form-control input-sm ch" name="kdsubsupplier" id="kdsubsupplier"  readonly disabled>
									 <option  value="">---PILIH KODE SUB GROUP SUPPLIER--</option> 
									  <?php foreach($list_msubsupplier as $sc){?>					  
									  <option  <?php if (trim($sc->kdsubsupplier)==trim($pricelst['kdsubsupplier'])) { echo 'selected';}?>  value="<?php echo trim($sc->kdsubsupplier);?>"  class="<?php echo trim($sc->kdsupplier);?>" ><?php echo trim($sc->kdsubsupplier).' || '.trim($sc->nmsubsupplier);?></option>						  
									  <?php }?>
									</select>
								</div>
							</div>
							<!---- STOCK ------->
								...
								<label class="col-sm-4" for="inputsm">Kode Group Barang</label>	
									<div class="col-sm-8">  
									<select class="form-control input-sm ch" name="kdgroupbarang" id="mpkdgroup"  readonly disabled>
									 <option value="">---PILIH KODE GROUP--</option> 
									  <?php foreach($list_scgroupatk as $sc){?>					  
									  <option   <?php if (trim($sc->kdgroup)==trim($pricelst['kdgroup'])) { echo 'selected';}?>  value="<?php echo trim($sc->kdgroup);?>" ><?php echo trim($sc->kdgroup).' || '.trim($sc->nmgroup);?></option>						  
									  <?php }?>
									</select>
									</div>
							</div>
							<div class="form-group ">
								...
								<div class="col-sm-8"> 
									<select class="form-control input-sm ch" name="kdsubgroupbarang" id="mpkdsubgroup"  readonly disabled>
									 <option  value="">---PILIH KODE SUB GROUP--</option> 
									  <?php foreach($list_scsubgroup as $sc){?>					  
									  <option  <?php if (trim($sc->kdsubgroup)==trim($pricelst['kdsubgroup'])) { echo 'selected';}?>  value="<?php echo trim($sc->kdsubgroup);?>"  class="<?php echo trim($sc->kdgroup);?>" ><?php echo trim($sc->kdsubgroup).' || '.trim($sc->nmsubgroup);?></option>						  
									  <?php }?>
									</select>
								</div>
							</div>
							<div class="form-group ">
								...
								<div class="col-sm-8"> 
									<select class="form-control input-sm ch" name="stockcode" id="stockcode"  readonly disabled>
									 <option  value="">---PILIH KDBARANG || NAMA BARANG--</option> 
									  <?php foreach($list_stkgdw as $sc){?>					  
									  <option  <?php if (trim($sc->stockcode)==trim($pricelst['stockcode'])) { echo 'selected';}?>  value="<?php echo trim($sc->stockcode);?>"  class="<?php echo trim($sc->kdsubgroup);?>" ><?php echo trim($sc->stockcode).' || '.trim($sc->nmbarang);?></option>						  
									  <?php }?>
									</select>
								</div>
							</div>
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="text" id="kdcabangsupplier" name="kdcabangsupplier"   value="<?php echo trim($pricelst['kdcabangsupplier']);?>" class="form-control "  readonly >
								</div>
							</div>
							<div class="form-group ">
								<label class="col-sm-4">STATUS PKP</label>	
								<div class="col-sm-8">    
									<input type="text" id="pkp" name="pkp"   value="<?php echo trim($pricelst['pkp']);?>" class="form-control "  readonly >
								</div>
							</div>
							<div class="form-group ">
								<label class="col-sm-4">QTY KECIL PENGKALI</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtykecil" name="qtykecil"   value="<?php echo trim($pricelst['qtykecil']);?>" class="form-control "  readonly >
								</div>
							</div>	
							<div class="form-group ">
								<label class="col-sm-4">SATUAN QTY KECIL</label>	
								<div class="col-sm-8">    
									<input type="text" id="nmsatkecil" name="nmsatkecil"   value="<?php echo trim($pricelst['nmsatkecil']);?>" class="form-control "  readonly >
									<input type="hidden" id="satkecil" name="satkecil"   value="<?php echo trim($pricelst['satkecil']);?>" class="form-control "  readonly >
								</div>
							</div>
								<div class="form-group row">
								<label class="col-sm-4">Unit Price(Rp)</label>	
								<div class="col-sm-4"> 
									<input type="input"  id="unitprice" name="unitprice"  value="<?php echo trim($pricelst['unitprice']);?>"  onkeyup="formatangkaobjek(this)" placeholder="0" class="form-control ratakanan" readonly>
								</div>
								<!--span class="col-sm-4"> 
							...
							<!--div class="form-group row diskonform">
								...
								<span class="col-sm-2"> 
									...
									<input type="input" id="disc1" value="<?php echo trim($pricelst['disc1']);?>" name="disc1" placeholder="0" value="0" class="form-control col-sm-1 ratakanan" >
								</span>	                                                                                          
								<span class="col-sm-2">                                                                           
									<label class="col-sm-4">2+</label>                                                
									<input type="input" id="disc2"  value="<?php echo trim($pricelst['disc2']);?>" name="disc2" placeholder="0" value="0" class="form-control col-sm-1 ratakanan" >
								</span>	                                                                                           
								<span class="col-sm-2">                                                                            
									<label class="col-sm-4">3+</label>                                                 
									<input type="input" id="disc3" value="<?php echo trim($pricelst['disc3']);?>" name="disc3" placeholder="0" value="0" class="form-control col-sm-1 ratakanan" >
								</span>									
							</div---->
				<?PHP /*			<div class="form-group row">
								...
								<div class="col-sm-4">    
									...
									<input type="input" id="ttldpp" name="ttldpp" value="<?php echo trim($pricelst['ttldpp']);?>"  placeholder="0" class="form-control ratakanan" readonly >
								</div>	
								<span class="col-sm-4"> 	
									<label class="col-sm-4">PPN</label>
									<span class="col-sm-6"> 
										<input type="input" id="checkppn" name="checkppn" value="<?php echo trim($pricelst['pkp']);?>"  class="form-control col-sm-12" readonly >
									</span>
								</span>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">    
									<!--input type="input" id="qtytotalpriceview" name="qtytotalpriceview"  placeholder="0" class="form-control" readonly --->
									<input type="input" id="ttlppn" name="ttlppn"  value="<?php echo trim($pricelst['ttlppn']);?>"  placeholder="0" class="form-control ratakanan" readonly >
								</div>
								<span class="col-sm-4"> 	
									<label class="col-sm-4">INCLUDE/EXCLUDE</label>
									<span class="col-sm-6"> 
									<select class="form-control col-sm-12"  name="exppn" id="checkexppn">
									 <option  <?php if ('INC'==trim($pricelst['exppn'])) { echo 'selected';}?> value="INC"> INCLUDE </option> 
									 <option  <?php if ('EXC'==trim($pricelst['exppn'])) { echo 'selected';}?>  value="EXC"> EXCLUDE </option> 
									</select>
									</span>
								</span>								
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">    
									<!--input type="input" id="qtytotalpriceview" name="qtytotalpriceview"  placeholder="0" class="form-control" readonly --->
									<input type="input" id="ttlnetto" name="ttlnetto"  value="<?php echo trim($pricelst['ttlnetto']);?>"  placeholder="0" class="form-control ratakanan" readonly >
								</div>							
							</div> */ ?>
							<div class="form-group ">
								<label class="col-sm-4">JATUH TEMPO</label>	
								<div class="col-sm-2">    
									<input type="text" id="payterm" name="payterm"   value="<?php echo trim($pricelst['payterm']);?>" class="form-control "  readonly >
								</div>
								<span class="col-sm-2"> 	
							...
							<div class="form-group ">
								<label class="col-sm-4">NODOK REF</label>	
								<div class="col-sm-2">    
									<input type="text" id="nodokref" name="nodokref"   value="<?php echo trim($pricelst['nodokref']);?>" class="form-control "  readonly >
								</div>
							</div>
      ...
      <div class="box-footer">
			<a href="<?php echo site_url('ga/pembelian/history_pricelist');?>" type="button" class="btn btn-default"/> Kembali</a>
	
<?php /*
		<?php } else if (trim($pricelst['status'])=='E') { ?>	
			<a href="<?php $enc_nodoktmp=bin2hex($this->encrypt->encode(trim($pricelst['nodoktmp'])));
