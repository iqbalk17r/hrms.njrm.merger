...
<div class="col-sm-12">
	...
	<ul class="nav nav-tabs">					
		<li class="active"><a href="#tab_1" data-toggle="tab">LIST HISTORY HANGUS PERMINTAAN BARANG KELUAR</a></li>
							...
							<thead>
								...
								<tr>
									...
									<td width="15%">
										...
										echo site_url("ga/permintaan/detail_hanguspbk/$enc_nodok");?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL </a>
