...
<div class="col-sm-12">
	...
	<ul class="nav nav-tabs">					
		<li class="active"><a href="#tab_1" data-toggle="tab">FORM LIST PERMINTAAN BARANG KELUAR</a></li>
					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_pbk_final as $row): $no++;?>
								<tr>
									...
									<td width="15%">
										...
										echo site_url("ga/permintaan/input_bbk/$enc_nodok");?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> INPUT BBK </a>
