...
<h5><b><strong><?php echo '  PERSETUJUAN BBK OLEH :: '.TRIM($dtlnik['nmlengkap']);?></strong></b></h5>
<span id="postmessages"></span>
<?php echo $message;?>

<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/permintaan/clear_tmp_bbk_hangus/$enc_nik")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
						...
						<table id="example2" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td><?php echo $row->cqtybbk;?></td> <!-- view penghangusan -->
...
<div class="modal-body">										
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group">
								...
								<div class="col-sm-8">  
									<input type="text" id="keterangan" name="keterangan"  value="<?php echo trim($lb->keterangan);?>" class="form-control" style="text-transform:uppercase" readonly>
								</div>
							</div>								
						</div>
					</div><!-- /.box-body -->													
      ...
      <div class="modal-footer">
        <!--a href="<?php echo site_url('ga/permintaan/list_personalnikbbk');?>" type="button" class="btn btn-default"/> Kembali</a-->
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="submit" id="submit"  class="btn btn-danger">HANGUS INPUT BBK</button>
      </div>
	  </form>
</div></div></div>
<?php } ?>
