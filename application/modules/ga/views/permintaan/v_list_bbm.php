		...
		<!--div class="container"--->
			<div class="dropdown ">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
				  ...
				  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#ChoiceOfLetter"  href="#">Input BBM</a></li> 
				  <!--li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url("ga/pembelian/input_po")?>">Input BUKTI BBM</a></li-->		
				</ul>
			</div>
		<!--/div-->
	</div><!-- /.box-header -->
...
<form action="<?php echo site_url('ga/permintaan/chose_optionbbm')?>" method="post" name="inputformPbk">
