						...
						<thead>
							...
							<tr>
								...
								<?php if ($nodoktype!='AJS') { ?>								
									...
									<?php } ?>
								<?php } else { ?>	
										<a href="#" data-toggle="modal" data-target="#DELDTL<?php echo str_replace('.','',trim($row->nodok)).trim($row->kdgroup).trim($row->kdsubgroup).trim($row->stockcode).trim($row->id);?>" class="btn btn-danger  btn-sm"><i class="fa fa-edit"></i> HAPUS </a>		
								<?php } ?>
								</td>
						...
						<div class="form-horizontal">	
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="INPUTFINALBBM" class="form-control" readonly >
								</div>
							</div>
							<div class="form-group ">
									...
									<div class="form-horizontal">							
										<div class="form-group ">
											...
											<div class="col-sm-8">    
												...
												<input type="hidden" id="type" name="type"  value="INPUTTMPDTLBBM_NO_REFERENSI" class="form-control" readonly >
											</div>
										</div>
										<div class="form-group ">
						...
						<div class="form-horizontal">							
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="INPUTTMPDTLBBM" class="form-control" readonly >
								</div>
							</div>
							<div class="form-group ">
								<label class="col-sm-4">DOKUMEN REFERENSI</label>	
				...
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group ">
								<label class="col-sm-4">QTY SENT KECIL</label>	
								<div class="col-sm-4">    
							...
							<div class="form-group ">
								<label class="col-sm-4">QTY SENT MINTA</label>	
								<div class="col-sm-4">    
...
<?php foreach ($list_bbm_tmp_dtl as $lb) { ?>
<div class="modal fade" id="DELDTL<?php echo str_replace('.','',trim($lb->nodok)).trim($lb->kdgroup).trim($lb->kdsubgroup).trim($lb->stockcode).trim($lb->id);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM HAPUS BUKTI BARANG MASUK</h4>
	  </div>
<form action="<?php echo site_url('ga/permintaan/save_bbm')?>" method="post">
<div class="modal-body">										
		<div class="row">
						...
						<div class="form-horizontal">							
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="input" id="nodok" name="nodok"  value="<?php echo trim($lb->nodok);?>" placeholder="0" class="form-control" readonly >
									<input type="hidden" id="id" name="id"  value="<?php echo trim($lb->id);?>" placeholder="0" class="form-control" readonly >
									<input type="hidden" id="type" name="type"  value="DELETETMPDTLBBM_NO_REFERENSI" class="form-control" readonly >
								</div>
							</div>
							<div class="form-group ">
								<label class="col-sm-4">DOKUMEN REFERENSI</label>	
