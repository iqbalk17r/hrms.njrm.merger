...
<div class="row">
	<div class="col-sm-1">
		<a href="<?php echo site_url('ga/inventaris/edit_inputspk').'/'.trim($nodoktmp);?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
			...
			<thead>
				...
				<tr>
					...
					<td width="15%">
							...
							<a href="#" data-toggle="modal" data-target="#EDITRINCIAN<?php echo trim($row->id);?>" class="btn btn-success  btn-sm">
								<i class="fa fa-edit"></i> EDIT
							</a>
							<a href="#" data-toggle="modal" data-target="#DELRINCIAN<?php echo trim($row->id);?>" class="btn btn-danger  btn-sm">
	  ...
	  <div class="modal-body">
		...
		<div class='row'>
			...
			<div class="form-group">
				...
				<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDITDTLEDITFAKTUR">
			</div>
			<div class="form-group">
				<label for="inputsm">NO DOKUMEN REFERENSI</label>	
				<input type="text" class="form-control input-sm" id="nodokref" name="nodokref" style="text-transform:uppercase" maxlength="35" value="<?php echo trim($dtl_mst['nodokref']);?>" readonly>
	  ...
	  <div class="modal-body">
		...
		<div class='row'>
			...
			<div class="form-group">
				...
				<input type="hidden" class="form-control input-sm" id="strtrimref" name="strtrimref" style="text-transform:uppercase" maxlength="50" value="<?php echo bin2hex($this->encrypt->encode(trim($dtl_mst['strtrimref'])));?>" readonly>
				<input type="hidden" class="form-control input-sm" id="id" name="id" style="text-transform:uppercase" maxlength="50" value="<?php echo trim($ls->id);?>" readonly>
				<input type="hidden" class="form-control input-sm" id="type" name="type" value="DTLDTLEDITFAKTUR">
			</div>
			<div class="form-group">
				<label for="inputsm">NO DOKUMEN REFERENSI</label>	
				<input type="text" class="form-control input-sm" id="nodokref" name="nodokref" style="text-transform:uppercase" maxlength="35" value="<?php echo trim($dtl_mst['nodokref']);?>" readonly>
