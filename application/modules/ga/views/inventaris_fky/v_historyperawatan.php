		...
		<table id="example1" class="table table-bordered table-striped" >
				<thead>
					...
					<tr>
						...
						<a href="<?php echo site_url('ga/inventaris/history_spkperawatan/'.trim($row->nodok));?>" class="btn btn-default  btn-sm">
