					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_sckendaraan as $row): $no++;?>
								<tr>
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/kendaraan/input_sckendaraan');?>" method="post">
		  <div class="form-group">
			<label for="inputsm">Kode Skema Kendaraan</label>
			<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" placeholder="Input Kode Group Schema Kendaraan">
...
<!-- EDIT KENDARAAN -->
<?php foreach ($list_sckendaraan as $ls){ ?>
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
			<label for="inputsm">Group Reminder</label>
			<input type="text" class="form-control input-sm" id="groupreminder" style="text-transform:uppercase" name="groupreminder" value="KENDARAAN" readonly>
		</div>
		<div class="form-group">
			<label for="inputsm">Keterangan</label>
...
<div class="modal fade" id="DEL<?php echo trim($ls->kdgroup);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">HAPUS SKEMA KENDARAAN</h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/kendaraan/del_sckendaraan');?>" method="post">
			<div class="form-group">
					<label for="inputsm">Kode Skema Kendaraan</label>
