...
<div class="col-sm-12">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">					
			<li class="active"><a href="#tab_1" data-toggle="tab">Sub Schema Barang</a></li>
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="22%">
											<a href="#" data-toggle="modal" data-target="#DTL<?php echo trim($row->kdgroup).trim($row->kdsubgroup);?>" class="btn btn-default  btn-sm">
												<i class="fa fa-edit"></i> DETAIL
											</a>
											<?php if ($row->rowdtl==0) { ?>	
											<a href="#" data-toggle="modal" data-target="#EDIT<?php echo trim($row->kdgroup).trim($row->kdsubgroup);?>" class="btn btn-success  btn-sm">
												<i class="fa fa-edit"></i> EDIT
											</a>
											<a href="#" data-toggle="modal" data-target="#DEL<?php echo trim($row->kdgroup).trim($row->kdsubgroup);?>" class="btn btn-danger  btn-sm">
	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control input-sm" id="kdsubgroup" name="kdsubgroup" style="text-transform:uppercase" placeholder="Input Kode Group Schema Barang" maxlength="6" required>
...
<div class="modal fade" id="EDIT<?php echo trim($ls->kdgroup).trim($ls->kdsubgroup);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
			<label for="inputsm">Kode Sub Skema Barang & asset</label>
			<input type="text" class="form-control input-sm" id="kdsubgroup" name="kdsubgroup" style="text-transform:uppercase" value="<?php echo trim($ls->kdsubgroup);?>" placeholder="Input Kode Group Schema Barang & Asset" maxlength="6" readonly>
			<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDIT">
		  </div>
		  <div class="form-group">
			<label for="inputsm">Nama Skema</label>
			<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" value="<?php echo trim($ls->nmsubgroup);?>" placeholder="Input Nama Group Schema Barang & Asset">
		  </div>
		<div class="form-group">
			<label for="inputsm">Uji KIR</label>	
...
<?php foreach ($list_msubgroup as $ls){ ?>
<div class="modal fade" id="DTL<?php echo trim($ls->kdgroup).trim($ls->kdsubgroup);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
			<label for="inputsm">Nama Skema</label>
			<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" value="<?php echo trim($ls->nmsubgroup);?>" placeholder="Input Nama Group Schema Barang & Asset" readonly>
		  </div>
		<div class="form-group">
			<label for="inputsm">Uji KIR</label>	
...
<!-- DELETE BARANG-->
<?php foreach ($list_msubgroup as $ls){ ?>
<div class="modal fade" id="DEL<?php echo trim($ls->kdgroup).trim($ls->kdsubgroup);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
