...
<div class="col-sm-12">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">					
			<li class="active"><a href="#tab_1" data-toggle="tab">STNK</a></li>
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/kendaraan/input_sckendaraan');?>" method="post">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="nodok" name="nodok" style="text-transform:uppercase" placeholder="DOKUMEN SKEMA">
		  </div>
		  <div class="form-group">
