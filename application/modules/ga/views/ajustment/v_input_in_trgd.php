...
<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("ga/ajustment/clear_tmp_ajustment_in".'/'.trim($trg_mst['nodok']))?>"  onclick="return confirm('PERINGATAN KEMBALI AKAN MENGHAPUS SEMUA INPUTAN YG TELAH ANDA BUAT, TEKAN (OK) JIKA ANDA SETUJU, JIKA TIDAK TEKAN (BATAL)')" class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
			<a href="<?php echo site_url("ga/ajustment/final_input_ajustment_in")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat?')" class="btn btn-primary pull-right" style="margin:10px; color:#ffffff;">Simpan</a>
		</div>
<div class="col-sm-12">
		<div class="row">
			<div class="col-xs-12">                            
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">FORM PEMILIHAN TRANSFER ANTAR GUDANG</h4>
	  </div>
<form action="<?php echo site_url('ga/ajustment/save_ajustment')?>" method="post">
					...
					<div class="box-body">
						<div class="form-horizontal">
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm tgl" id="ajustment_date" name="ajustment_date"  data-date-format="dd-mm-yyyy"  value="<?php if (empty($lb->ajustment_date)) { echo ''; } else { echo date('d-m-Y', strtotime(trim($lb->ajustment_date))); } ?>" required>
								</div>
							</div>					
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">Ajustment Type</label>	
								<div class="col-sm-8"> 
									<select class="form-control input-sm  " readonly disabled>
									  <option  <?php if ('IN'==trim($lb->ajustment_type)) { echo 'selected';}?>  value="IN"><?php echo 'AJUSTMENT IN';?></option>						  
									  <option  <?php if ('OUT'==trim($lb->ajustment_type)) { echo 'selected';}?>  value="OUT"><?php echo 'AJUSTMENT OUT';?></option>						  
									</select>
								</div>
								<input type="hidden" name="ajustment_type" id="ajustment_type" value="IN" class="form-control "  >
							</div>
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">Ajustment Category</label>	
								<div class="col-sm-8"> 
									<select class="form-control input-sm "  name="ajustment_category" id="ajustment_category" required>
									  <option  <?php if ('TRG'==trim($lb->ajustment_category)) { echo 'selected';}?>  value="TRG"><?php echo 'AJUSTMENT TRANSFER ANTAR GUDANG';?></option>						  
									  <option  <?php if ('UMM'==trim($lb->ajustment_category)) { echo 'selected';}?>  value="UMM"><?php echo 'AJUSTMENT UMUM';?></option>						  
									</select>
								</div>
								<!--input type="hidden" name="ajustment_category" id="ajustment_category" value="TRG" class="form-control " --->
							</div>
							<div class="form-group">
								<label class="col-sm-4">Keterangan</label>	
								<div class="col-sm-8">    
									<textarea type="text" id="description" name="description"   style="text-transform:uppercase" class="form-control"></textarea>
								</div>
							</div>		
...
<div class="modal fade" id="INPUT_IN_TRGD_DTL" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM PEMILIHAN TRANSFER ANTAR GUDANG DETAIL BARANG</h4>
	  </div>
<form action="<?php echo site_url('ga/ajustment/save_ajustment')?>" method="post">
<div class="modal-body">										
		<div class="row">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group ">
								...
								<div class="col-sm-8"> 
									<select class="form-control input-sm  " readonly disabled>
									  <option  <?php if ('IN'==trim($trg_mst['ajustment_type'])) { echo 'selected';}?>  value="IN"><?php echo 'AJUSTMENT IN';?></option>						  
									  <option  <?php if ('OUT'==trim($trg_mst['ajustment_type'])) { echo 'selected';}?>  value="OUT"><?php echo 'AJUSTMENT OUT';?></option>						  
									</select>
								</div>
								<input type="hidden" name="ajustment_type" id="ajustment_type" value="<?php echo trim($trg_mst['ajustment_type']);?>" class="form-control "  >
							</div>
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">Ajustment Category</label>	
								<div class="col-sm-8"> 
									<select class="form-control input-sm  "  readonly disabled>
									  <option  <?php if ('TRG'==trim($trg_mst['ajustment_category'])) { echo 'selected';}?>  value="TRG"><?php echo 'AJUSTMENT TRANSFER ANTAR GUDANG';?></option>						  
									  <option  <?php if ('UMM'==trim($trg_mst['ajustment_category'])) { echo 'selected';}?>  value="UMM"><?php echo 'AJUSTMENT UMUM';?></option>						  
									</select>
								</div>
								<input type="hidden" name="ajustment_category" id="ajustment_category" value="<?php echo trim($trg_mst['ajustment_category']);?>" class="form-control "  >
							</div>
						</div>
					</div><!-- /.box-body -->													
				</div><!-- /.box -->													
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="input" id="nodok" name="nodok"  value="<?php echo trim($trg_mst['nodok']);?>"  class="form-control" readonly >
									<input type="hidden" id="type" name="type"  value="EDIT_IN_TRGD_DTL" class="form-control" readonly >
								</div>
							</div>
