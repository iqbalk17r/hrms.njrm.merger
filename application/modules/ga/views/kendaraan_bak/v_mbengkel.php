			...
			<div class="box-body table-responsive" style='overflow-x:scroll;'>
				<table id="example1" class="table table-bordered table-striped" >
					<thead>
							...
							<tbody>
							<?php $no=0; foreach($list_bengkel as $row): $no++;?>
						<tr>
							...
							<td width="15%">
									<a title="Detail Sub Bengkel"  href="<?php echo site_url('ga/kendaraan/form_msubbengkel').'/'.trim($row->kdbengkel);?>" class="btn btn-info  btn-sm">
										<i class="fa fa-bars"></i>
									</a>
									<?php if (trim($row->numdtl)==0) { ?>
									<a title="Detail Ubah Bengkel"  href="#" data-toggle="modal" data-target="#ED<?php echo trim($row->kdbengkel);?>" class="btn btn-success  btn-sm">
										<i class="fa fa-gear"></i>
									</a>
									<a title="DETAIL Cabang Bengkel"  href="#" data-toggle="modal" data-target="#DEL<?php echo trim($row->kdbengkel);?>" class="btn btn-danger  btn-sm">
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/kendaraan/input_mstbengkel');?>" method="post">
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
				<label for="inputsm">KODE BENGKEL</label>
				<input type="text" class="form-control input-sm" id="kdbengkel" name="kdbengkel" style="text-transform:uppercase" placeholder="INPUT KODE BENGKEL.." maxlength="12" required>
				<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT">
			  </div>
			  <div class="form-group">
				<label for="inputsm">NAMA GROUP BENGKEL</label>
				<input type="text" class="form-control input-sm" id="nmbengkel" style="text-transform:uppercase" name="nmbengkel" placeholder="INPUT NAMA BENGKEL..." maxlength="30" required>
			  </div>
			 <div class="form-group">
				<label for="inputsm">Kode Group Bengkel</label>	
					<select class="form-control input-sm" name="kdgroup" id="kdgroup"  required>
						<option value="">---PILIH KD JENIS || NAMA JENIS BENGKEL--</option> 
						<?php foreach($list_trxgbengkel as $sc){?>					  
...
<!-- EDIT KENDARAAN -->
<?php foreach ($list_bengkel as $ls){ ?>
<div class="modal fade" id="ED<?php echo trim($ls->kdbengkel);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
	  ...
	  <div class="modal-body">
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
				<label for="inputsm">KODE BENGKEL</label>
				<input type="text" value="<?php echo trim($ls->kdbengkel);?>" class="form-control input-sm" id="kdbengkel" name="kdbengkel" style="text-transform:uppercase" placeholder="INPUT KODE BENGKEL.." maxlength="12" readonly>
				<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDIT">
			  </div>
			  <div class="form-group">
				<label for="inputsm">NAMA GROUP BENGKEL</label>
				<input type="text" value="<?php echo trim($ls->nmbengkel);?>" class="form-control input-sm" id="nmbengkel" style="text-transform:uppercase" name="nmbengkel" placeholder="INPUT NAMA BENGKEL..." maxlength="30" >
			  </div>
			 <div class="form-group">
				<label for="inputsm">Kode Group Bengkel</label>	
					<select class="form-control input-sm" name="kdgroup" id="kdgroup"  required>
						<option <?php if (trim($ls->kdgroup)=='') { echo 'selected';}?> value="">---PILIH KD JENIS || NAMA JENIS BENGKEL--</option> 
						<?php foreach($list_trxgbengkel as $sc){?>					  
						<option <?php if (trim($ls->kdgroup)==trim($sc->kdtrx)) { echo 'selected';}?> value="<?php echo trim($sc->kdtrx);?>" ><?php echo trim($sc->kdtrx).' || '.trim($sc->uraian);?></option>						  
						<?php }?>
					</select> 
			</div>
			</div> <!---- col 1 -->
...
<!-- DETAIL KENDARAAN -->
<?php foreach ($list_bengkel as $ls){ ?>
<div class="modal fade" id="DTL<?php echo trim($ls->kdbengkel);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
			  ...
			  <div class="form-group">
				<label for="inputsm">NAMA GROUP BENGKEL</label>
				<input type="text" value="<?php echo trim($ls->nmbengkel);?>" class="form-control input-sm" id="nmbengkel" style="text-transform:uppercase" name="nmbengkel" placeholder="INPUT NAMA BENGKEL..." maxlength="30" readonly>
			  </div>
			 <div class="form-group">
				<label for="inputsm">Kode Group Bengkel</label>	
...
<!-- HAPUS BENGKEL -->
<?php foreach ($list_bengkel as $ls){ ?>
<div class="modal fade" id="DEL<?php echo trim($ls->kdbengkel);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
