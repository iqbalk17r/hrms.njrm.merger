...
<legend><?php echo $title.' ( '.$kdbengkel.' ) '.$dtlmst['nmbengkel'];?></legend>
<?php echo $message; ?>
				...
				<table id="example1" class="table table-bordered table-striped" >
					<thead>
						...
						<tr>
							...
							<td width="8%">
									<a title="DETAIL CABANG BENGKEL KENDARAAN"  href="#" data-toggle="modal" data-target="#DTL<?php echo str_replace('.','',trim($row->kdsubbengkel));?>" class="btn btn-default  btn-sm">
										<i class="fa fa-bars"></i>
									</a>
									<a title="UBAH CABANG BENGKEL KENDARAAN" href="#" data-toggle="modal" data-target="#ED<?php echo str_replace('.','',trim($row->kdsubbengkel));?>" class="btn btn-primary  btn-sm">
										<i class="fa fa-gear"></i>
									</a>
								<?php /*
                                <a title="HAPUS CABANG BENGKEL KENDARAAN" href="#" data-toggle="modal" data-target="#DEL<?php echo str_replace('.','',trim($row->kdsubbengkel));?>" class="btn btn-danger  btn-sm">
