			  ...
			  <div class="box-body">
					...
					<div class='row'>
						<div class='col-sm-6'>	
						 <div class="form-group">
						  ...
						  <div class="form-group">
							...
							<input type="text" class="form-control input-sm" style="text-transform:uppercase" placeholder="Nomor SKUM" value="<?php echo trim($dtlstnk['old_noskum']);?>"  maxlength="20" readonly>
						  </div>
						  <div class="form-group">
							<label for="inputsm">Nomor KOHIR</label>
							<input type="text" class="form-control input-sm" style="text-transform:uppercase" placeholder="Nomor KOHIR" value="<?php echo trim($dtlstnk['old_nokohir']);?>"  maxlength="20" readonly>
						  </div>
						</div> 
						<div class='col-sm-6'>	
						 <div class="form-group">
							...
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT_1T">
						...
						<div class="form-group">
							...
							<textarea  class="textarea" name="keterangan" placeholder="Keterangan"   maxlength ="159" style="width: 100%; height: 100px; font-size: 10px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"></textarea>
						  </div>
						</div> 
					</div>
					...
					<div class='row'>
						<div class='col-sm-4'>	
						 <div class="form-group">
							<label for="inputsm">Nomor Rangka</label>
							<input type="text" class="form-control input-sm" id="kdrangka" name="kdrangka" style="text-transform:uppercase" placeholder="Nomor Rangka Dari STNKB" maxlength="25" value="<?php echo trim($dtlstnk['kdrangka']) ;?>" readonly>
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT_5T">
						...
						<div class='col-sm-4'>	
						  ...
						  <div class="form-group">
							<label for="inputsm">Total BIAYA Pajak Kendaraan (PKB)</label>
							<input type="number" class="form-control input-sm" id="nominalpkb" name="nominalpkb"  min="0" max="999999999999" >
						  </div>
						  <div class="form-group">
							<label for="inputsm">Nomor SKUM</label>
