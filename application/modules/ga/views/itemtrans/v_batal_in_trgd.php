...
<div class="row">
		<div class="col-sm-12">		
			...
			<a href="<?php echo site_url("ga/itemtrans/final_input_itemtrans_in")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat?')" class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;">Batalkan</a>
		</div>
<div class="col-sm-12">
		<div class="row">
			<div class="col-xs-12">                            
