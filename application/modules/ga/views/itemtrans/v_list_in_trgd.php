		...
		<!--div class="container"--->
			<div class="dropdown ">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
				  ...
				  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url("ga/itemtrans/input_itemtrans_in_trgd")?>">Input Transfer Antar Gudang</a></li>		
				</ul>
			</div>
		<!--/div-->
	</div><!-- /.box-header -->
				...
				<div class="box">
					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example2" class="table table-bordered table-striped" >
							...
							<tbody>
									<?php $no=0; foreach($list_itemtrans_in_trgd as $row): $no++;?>
								<tr>									
									...
									<td width="15%">
											...
											<a href="<?php echo site_url("ga/itemtrans/detail_itemtrans_in_trgd".'/'.bin2hex($this->encrypt->encode(trim($row->nodok))))?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL </a>
											...
											<a href="<?php echo site_url("ga/itemtrans/edit_itemtrans_in_trgd".'/'.bin2hex($this->encrypt->encode(trim($row->nodok))))?>" class="btn btn-primary  btn-sm"><i class="fa fa-edit"></i> EDIT </a>						
											<a href="<?php echo site_url("ga/itemtrans/batal_itemtrans_in_trgd".'/'.bin2hex($this->encrypt->encode(trim($row->nodok))))?>" class="btn btn-danger  btn-sm"><i class="fa fa-edit"></i> BATAL </a>
											<a href="<?php echo site_url("ga/itemtrans/approv_itemtrans_in_trgd".'/'.bin2hex($this->encrypt->encode(trim($row->nodok))))?>" class="btn btn-success  btn-sm"><i class="fa fa-edit"></i> APPROV </a>
											<?php } ?>
									</td>
								</tr>
								<?php endforeach;?>	
