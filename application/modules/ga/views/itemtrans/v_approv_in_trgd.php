...
<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("ga/itemtrans/clear_tmp_itemtrans_in".'/'.trim($trg_mst['nodok']))?>"  onclick="return confirm('PERINGATAN KEMBALI AKAN MENGHAPUS SEMUA PROSES YG TELAH ANDA BUAT, TEKAN (OK) JIKA ANDA SETUJU, JIKA TIDAK TEKAN (BATAL)')" class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
			<a href="<?php echo site_url("ga/itemtrans/final_input_itemtrans_in")?>"  onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;">Approval</a>
		</div>
<div class="col-sm-12">
		<div class="row">
			<div class="col-xs-12">                            
