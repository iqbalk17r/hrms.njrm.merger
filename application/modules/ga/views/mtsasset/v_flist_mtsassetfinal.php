...
<div class="col-sm-1">
	<a href="<?php echo site_url('ga/mtsasset/form_st_mtsasset');?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
</div>
<div class="col-xs-12">                            
	<div class="box">
		<div class="box-body table-responsive" style='overflow-x:scroll;'>
			<table id="example1" class="table table-bordered table-striped" >
				<thead>
						...
						<tbody>
						<?php $no=0; foreach($list_mutasifinal as $row): $no++;?>
					<tr>
						...
						<td width="15%">
								<a href="<?php echo site_url('ga/mtsasset/serahterima_mtsassetfinal').'/'.trim($row->nodok);?>" class="btn btn-primary  btn-sm"><i class="fa fa-edit"></i> INPUT</a>
						</td>
					</tr>
					<?php endforeach;?>	
						</tbody>		
