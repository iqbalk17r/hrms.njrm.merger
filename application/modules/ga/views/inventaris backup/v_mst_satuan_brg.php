				...
				<table id="example1" class="table table-bordered table-striped" >
					<thead>
						...
						<tr>
							...
							<td width="8%">
									<a  title="Detail Satuan Barang" href="#" data-toggle="modal" data-target="#DTL<?php echo trim($row->kdtrx).trim($row->jenistrx);?>" class="btn btn-default  btn-sm">
										<i class="fa fa-bars"></i>
									</a>
									<a  title="Ubah Deskripsi Satuan" href="#" data-toggle="modal" data-target="#ED<?php echo trim($row->kdtrx).trim($row->jenistrx);?>" class="btn btn-primary  btn-sm">
										<i class="fa fa-gear"></i>
									</a>
                                <?php if ($row->kdmaprow == 0) { ?>
									<a  title="Hapus Satuan Barang"  href="#" data-toggle="modal" data-target="#DEL<?php echo trim($row->kdtrx).trim($row->jenistrx);?>" class="btn btn-danger  btn-sm">
...
<div class="modal fade" id="ED<?php echo trim($ls->kdtrx).trim($ls->jenistrx);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">Ubah Data Master Satuan Barang</h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_master_satuan_brg');?>" method="post">
		<div class='row'>
...
<div class="modal fade" id="DTL<?php echo trim($ls->kdtrx).trim($ls->jenistrx);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">DETAIL MASTER SATUAN BARANG</h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_master_satuan_brg');?>" method="post">
		<div class='row'>
...
<div class="modal fade" id="DEL<?php echo trim($ls->kdtrx).trim($ls->jenistrx);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">HAPUS MASTER SATUAN BARANG</h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_master_satuan_brg');?>" method="post">
		<div class='row'>
