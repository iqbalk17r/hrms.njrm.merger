...
<div class="row">
	<div class="col-sm-1">
		<a href="<?php echo site_url('ga/inventaris/history_spkperawatan/').'/'.trim($dtl_mst['nodok']);?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
