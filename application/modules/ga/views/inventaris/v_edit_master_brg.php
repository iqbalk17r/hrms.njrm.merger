	  ...
	  <div class="box-body">
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
			  ...
			  <div class="form-group">
				...
				<input type="text" value="<?php echo trim($dtl_mstbarang['nmbarang']);?>"  class="form-control input-sm" id="nmbarang" style="text-transform:uppercase" name="nmbarang" placeholder="Inputkan Nama Barang" maxlength="50" required>
			  </div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea  class="textarea" name="keterangan" placeholder="Keterangan"   maxlength ="159" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"><?php echo trim($dtl_mstbarang['keterangan']);?></textarea>
			  </div>
			</div> 
		</div>
