		...
		<div class='row'>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-4">  
						<input type="text" class="form-control input-sm" id="qty" name="qty" value="<?php echo trim($dtl_map['qty']); ?>" required>
					</div>
					<div class="col-sm-4"> 
						<input type="text" class="form-control input-sm" id="nmsatkecil" name="nmsatkecil"  value="<?php echo trim($dtl_map['nmsatkecil']); ?>" readonly>
					</div>
			...
			<div class="form-group">
				...
				<textarea  class="textarea" name="keterangan" placeholder="Keterangan"   maxlength ="159" style="text-transform: uppercase; width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"><?php echo trim($dtl_map['keterangan']);?></textarea>
			  </div>
			</div> 
		</div>
