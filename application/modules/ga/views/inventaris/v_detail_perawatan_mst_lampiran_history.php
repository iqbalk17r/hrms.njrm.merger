...
<div class="row">
    <div class="col-sm-1">
        ...
        $enc_nodok = $this->fiky_encryption->enkript(trim($dtl_mst['nodok']));
        echo site_url('ga/inventaris/history_spkperawatan').'/'.$enc_nodok;?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
        <!--form role="form" action="<?php echo site_url('ga/inventaris/history_spkperawatan');?>" method="post">
                    ...
                    <form role="form" action="<?php echo site_url('ga/inventaris/save_spk_lampiran');?>" method="post">
                        <div class='row'>
                            ...
                            <div class='col-sm-6'>
                                ...
                                <div class="form-group">
                                    <label for="inputsm">Diskon Item Barang</label>
