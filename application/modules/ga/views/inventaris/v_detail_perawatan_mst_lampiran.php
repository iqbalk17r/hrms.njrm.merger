...
<div class="row">
	<div class="col-sm-1">
		<a href="<?php echo site_url('ga/inventaris/detail_inputspk/') . '/' . trim($dtl_mst['nodok']); ?>" type="button"
...
<div class="row">
	...
	<div class="box col-lg-12">
		<div class="box-header">
			<legend>
				<?php echo 'MASTER FAKTUR DAN RINCIAN TOTAL HARGA'; ?>
			</legend>
		</div><!-- /.box-header -->
