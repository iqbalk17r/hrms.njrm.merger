...
<div class="row">
	...
	<div class="col-sm-3">	
	<a href="<?php echo site_url('ga/inventaris/index_spk');?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
		<!--div class="container">
			<div class="dropdown ">
				<button class="btn btn-primary dropdown-toggle " style="margin:10px; color:#ffffff;" id="menu1" type="button" data-toggle="dropdown">Menu<span class="caret"></span></button>
				<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
				  ...
				  <!--li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url("ga/inventaris/input_view_perawatanasset")?>">Input Perawatan</a></li---> 
										...
										<tr>
											...
											<?php if(trim($row->spk)>0) { ?>	
												<?php if(trim($row->status)=='P'){ ?>
													<a href="<?php echo site_url('ga/inventaris/final_spk/'.trim($row->nodok));?>" onClick="return confirm('Peringatan Final Ini Adalah Finalisasi Perawatan Dan Cetak Dokumen Akan Dihilangkan Dan Dokumen Dianggap FINAL')" class="btn btn-success  btn-sm">	<i class="fa fa-edit"></i> FINAL </a>	
												<?php } ?>
												
												<a href="<?php echo site_url('ga/inventaris/inputspk_view/'.trim($row->nodok));?>" class="btn btn-default  btn-sm">	<i class="fa fa-edit"></i> DETAIL SPK </a>
												<?php if(trim($row->status)!='X'){ ?>
												 <button class="button btn btn-warning  btn-sm" onClick="window.open('<?php echo site_url('ga/inventaris/sti_spk_perawatan/'.trim($row->nodok));?>');">CETAK</button>
												<!--a href="<?php echo site_url('ga/inventaris/sti_spk_perawatan/'.trim($row->nodok));?>" class="btn btn-warning  btn-sm">	<i class="fa fa-edit"></i> CETAK SPK </a--->
												<?php } ?>
