...
<script type="text/javascript">
	...
	$(document).ready(function () {
		$('#kdbengkeled').change(function () {
			var selectedBengkel = $(this).val();
			$('#kdsubbengkeled option').each(function () {
				if ($(this).hasClass(selectedBengkel) || selectedBengkel === "") {
					$(this).show();
				} else {
					$(this).hide();
				}
			});
			$('#kdsubbengkeled').val(''); // Reset sub-bengkel selection
		});
...
<div class="row">
	<div class="col-sm-1">
		<form role="form" action="<?php echo site_url('ga/inventaris/clear_tambahanspk'); ?>" method="post">
			<input type="hidden" class="form-control input-sm" id="nodok" name="nodok" style="text-transform:uppercase"
				maxlength="25" value="<?php echo trim($nodok); ?>" readonly>
			...
			<button type="submit" style="margin:10px; color:#000000;"
				onclick="return confirm('Kembali Akan Menghapus Inputan Anda , Apakah Anda Yakin....?')"
				class="btn btn-default">KEMBALI</button>
		</form>
	</div>
	<div class="col-sm-1  pull-right">
		<form role="form" action="<?php echo site_url('ga/inventaris/final_tambahanspk'); ?>" method="post">
			<input type="hidden" class="form-control input-sm" id="nodok" name="nodok" style="text-transform:uppercase"
				maxlength="25" value="<?php echo trim($nodok); ?>" readonly>
			<input type="hidden" class="form-control input-sm" id="nodokref" name="nodokref"
				style="text-transform:uppercase" maxlength="25" value="<?php echo trim($nodokref); ?>" readonly>
...
<div class="row">
	<div class="box col-lg-12">
		<div class="box-header">
			<legend><?php echo 'SPK YANG TELAH DISETUJUI'; ?></legend>
		</div><!-- /.box-header -->
	...
	<div class="box col-lg-12">
		<div class="box-header">
			<legend><?php echo 'INPUT TAMBAHAN SPK'; ?></legend>
		</div><!-- /.box-header -->
		<div class="box-body table-responsive" style='overflow-x:scroll;'>
...
<?php foreach ($list_spk_his as $ls) { ?>
<div class="modal fade" id="DTL<?php echo str_replace('.', '', (trim($ls->nodok) . trim($ls->nodokref))); ?>"
	tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
