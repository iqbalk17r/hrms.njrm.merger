...
<div class="row">
    ...
    <div class="col-sm-11">
        <a href="<?php
        $enc_nodoktmp = $this->fiky_encryption->enkript(trim($dtl_mst['nodokref']));
        echo site_url('ga/inventaris/inputspk_view').'/'.$enc_nodoktmp;?>" type="button"  style="margin:10px; color: #ffffff;" class="btn btn-success pull-right"/><i class="fa fa-"></i> Simpan </a>
    </div>
</div>
</br>
<div class="row">
                    ...
                    <tr><td>
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" class="form-control input-sm" name="type" value="SAVEINPUTDTLLAMPIRAN">
                        ...
                        <div class='row'>
                            ...
                            <div class='col-sm-6'>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm ratakanan fikyseparator" id="nservis" name="nservis" style="text-transform:uppercase" maxlength="20" placeholder="0" required>
                                </div>
                                <div class="form-group">
                                    <label for="inputsm">Potongan</label>
                                    <input type="text" class="form-control input-sm ratakanan fikyseparator" id="ndiskon" name="ndiskon" style="text-transform:uppercase" maxlength="20" placeholder="0" required>
                                </div>
                                <?php /*
			<div class="form-group">
                            ...
                            <div class='row'>
                                <div class='col-sm-6'>
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control input-sm" id="type" name="type" value="DELDTLINPUTFAKTUR">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputsm">NO DOKUMEN REFERENSI</label>
                                        <input type="text" class="form-control input-sm" id="nodokref" name="nodokref" style="text-transform:uppercase" maxlength="35" value="<?php echo trim($ls->nodokref);?>" readonly>
