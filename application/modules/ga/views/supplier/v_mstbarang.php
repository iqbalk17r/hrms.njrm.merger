...
<div class="col-sm-12">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">					
			<li class="active"><a href="#tab_1" data-toggle="tab">Inventaris Barang & ATK</a></li>
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="nodok" name="nodok" style="text-transform:uppercase" placeholder="Dokumen Barang" maxlength="25" required>
				<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT">
			  </div>
			  <div class="form-group">
				<label for="inputsm">NAMA BARANG</label>
				<input type="text" class="form-control input-sm" id="nmbarang" style="text-transform:uppercase" name="nmbarang" placeholder="Inputkan Nama Barang" maxlength="25" required>
			  </div>
			<div class="form-group">
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
			  ...
			  <div class="form-group">
				<label for="inputsm">NAMA BARANG</label>
				<input type="text" value="<?php echo trim($ls->nmbarang);?>"  class="form-control input-sm" id="nmbarang" style="text-transform:uppercase" name="nmbarang" placeholder="Inputkan Nama Barang" maxlength="25" required>
			  </div>
			<div class="form-group">
				<label for="inputsm">Kode Group Barang</label>	
			...
			<div class="form-group">
				<label for="inputsm">Keterangan</label>
				<textarea  class="textarea" name="keterangan" placeholder="Keterangan"   maxlength ="159" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"><?php echo trim($sc->keterangan);?></textarea>
			  </div>
			</div> 
		</div>
		</div>
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
			  ...
			  <div class="form-group">
				<label for="inputsm">NAMA BARANG</label>
				<input type="text" value="<?php echo trim($ls->nmbarang);?>"  class="form-control input-sm" id="nmbarang" style="text-transform:uppercase" name="nmbarang" placeholder="Inputkan Nama Barang" maxlength="25" readonly>
			  </div>
			<div class="form-group">
				<label for="inputsm">Kode Group Barang</label>	
			...
			<div class="form-group">
				<label for="inputsm">Keterangan</label>
				<textarea  class="textarea" name="keterangan" placeholder="Keterangan"   maxlength ="159" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;" disabled readonly><?php echo trim($sc->keterangan);?></textarea>
			</div>
			</div> 
		</div>
		</div>
