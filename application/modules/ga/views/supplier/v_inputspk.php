				...
				<thead>
					...
					<tr>
						...
						<td width="15%">
								...
								<a href="#" data-toggle="modal" data-target="#ED<?php echo trim($nodok);?>" class="btn btn-success  btn-sm">
...
<script type="text/javascript">
            $(function() {
				...
				$("#kdsubgroupin").chained("#kdgroupin");	
				$("#kdbarangin").chained("#kdsubgroupin");	
		...
		<div class='row'>
			...
			<div class="form-group">
				<label for="inputsm">Kode Sub Group Barang</label>	
					<select class="form-control input-sm " name="kdsubgroup" id="kdsubgroupin">
			...
			<div class="form-group">
				<label for="inputsm">Kode Sub Bengkel</label>	
					<select class="form-control input-sm " name="kdsubbengkel" id="kdsubbengkelin" >
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		<div class='row'>
			...
			<div class="form-group">
				<label for="inputsm">Kode Sub Group Barang</label>	
					<select class="form-control input-sm " name="kdsubgroup" id="kdsubgrouped">
					 <option  value="">---PILIH KODE SUB GROUP--</option> 
					  <?php foreach($list_scsubgroup as $sc){?>					  
			...
			<div class="form-group">
				<label for="inputsm">Kode Bengkel</label>	
					<select class="form-control input-sm " name="kdbengkel" id="kdbengkeled" >
					<option value="">---PILIH BENGKEL--</option> 
					<?php foreach($list_bengkel as $sc){?>					  
			...
			<div class="form-group">
				<label for="inputsm">Kode Sub Bengkel</label>	
					<select class="form-control input-sm " name="kdsubbengkel" id="kdsubbengkeled" >
					<option value="">---PILIH SUB BENGKEL--</option> 
					<?php foreach($list_subbengkel as $sc){?>					  
