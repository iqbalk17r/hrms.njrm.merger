	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control input-sm" id="kdsubgroup" name="kdsubgroup" style="text-transform:uppercase" placeholder="Input Kode Group Schema Barang" maxlength="6">
			<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT">
		  </div>
		  <div class="form-group">
			<label for="inputsm">Nama Skema</label>
			<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" placeholder="Input Nama Group Schema Barang & Asset">
		  </div>
		<div class="form-group">
