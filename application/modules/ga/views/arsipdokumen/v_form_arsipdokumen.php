						...
						<tr>
							...
							<td width="8%">
                                ...
                                <?php } else if (trim($row->status)=='P')  { ?>
                                    ...
                                    $enc_docno=bin2hex($this->encrypt->encode(trim($row->docno)));
                                    $enc_archives_id=bin2hex($this->encrypt->encode(trim($row->archives_id)));
                                    echo site_url('ga/arsipdokumen/detail_arsipdokumen').'/'.$enc_docno.'/'.$enc_archives_id;?>" class="btn btn-warning  btn-sm" target="_blank" title="Cetak Data Arsip">	<i class="fa fa-print"></i> </a>
                                <?php } ?>
