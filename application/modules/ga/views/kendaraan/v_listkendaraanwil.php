...
<div class="col-sm-12">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">					
			<li class="active"><a href="#tab_1" data-toggle="tab">PENGURUSAN PAJAK TAHUNAN STNK</a></li>
			<li><a href="#tab_2" data-toggle="tab">PENGURUSAN PERGANTIAN STNK 5 TAHUNAN</a></li>	
		</ul>
								...
								<thead>
									...
									<tr>
										...
										<td width="15%">
												...
												<a href="<?php echo site_url('ga/kendaraan/input_pkb_tahunan').'/'.trim($row->kdrangka).'/'.trim($row->kdmesin);?>" type="button" class="btn btn-sm btn-primary"/>Input PKB Tahunan</a>												
										</td>
									</tr>
									<?php endforeach;?>	
										</tbody>		
								...
								<thead>
									...
									<tr>
										...
										<td width="15%">
												...
												<a href="<?php echo site_url('ga/kendaraan/input_stnkbaru').'/'.trim($row->kdrangka).'/'.trim($row->kdmesin);?>" type="button" class="btn btn-sm btn-primary"/>Input Penggantian STNK</a>												
										</td>
									</tr>
									<?php endforeach;?>	
										</tbody>		
