				...
				<table id="example1" class="table table-bordered table-striped" >
					<thead>
						...
						<tr>
							...
							<td width="15%">
									<a href="<?php echo site_url('ga/kendaraan/form_msubasuransi').'/'.bin2hex($this->encrypt->encode(trim($row->kdasuransi)));?>" class="btn btn-default  btn-sm" title="Detail Asuransi">
										<i class="fa fa-bars"></i>
									</a>
									<?php if (trim($row->rowdtl)==0) { ?>
									<a href="#" data-toggle="modal" data-target="#ED<?php echo trim($row->kdasuransi);?>" class="btn btn-success  btn-sm" title="Ubah Master Global Asuransi">
										<i class="fa fa-gear"></i>
									</a>
									<a href="#" data-toggle="modal" data-target="#DEL<?php echo trim($row->kdasuransi);?>" class="btn btn-danger  btn-sm" title="Hapus Master Global Asuransi">
		...
		<div class='row'>
			<div class='col-sm-6'>	
			 <div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="kdasuransi" name="kdasuransi" style="text-transform:uppercase" placeholder="INPUT KODE ASURANSI SEBAGAI KODE PREFIX" maxlength="5" required>
				<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT">
			  </div>
			  <div class="form-group">
				<label for="inputsm">NAMA GROUP ASURANSI</label>
				<input type="text" class="form-control input-sm" id="nmasuransi" style="text-transform:uppercase" name="nmasuransi" placeholder="INPUT NAMA ASURANSI GLOBAL" maxlength="30" required>
			  </div>
			</div> <!---- col 1 -->
			<div class='col-sm-6'>	
			<!--div class="form-group">
