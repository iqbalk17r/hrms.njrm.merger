...
<div><a href="<?php echo site_url('ga/ujikir/clear_ujikir');?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
					...
					<div class='row'>
						<div class='col-sm-4'>	
						 <div class="form-group">
							...
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDITUJIKIR">
						  </div>
						  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm " id="docujikir" name="docujikir" style="text-transform:uppercase" value="<?php echo trim($dtlmst['docujikir']);?>"  placeholder="Nomor Dokumen Uji Kir" maxlength="30" required>
                        </div>
                        <div class="form-group">
                            <label for="inputsm">Tanggal Expired Uji Kir Baru</label>
                            <input type="text" class="form-control input-sm tgl" id="expkir" style="text-transform:uppercase" name="expkir" value="<?php echo trim($dtlmst['expkir']);?>"  placeholder="Expired Kir" data-date-format="dd-mm-yyyy" required>
                        </div>
                        <div class="form-group">
                            <label for="inputsm">Total Biaya Uji Kir</label>
                            <input type="text" class="form-control input-sm ratakanan" id="ttlvalue" name="ttlvalue" style="text-transform:uppercase" value="<?php echo trim($dtlmst['ttlvalue']);?>"  placeholder="Total Biaya Pengurusan Uji Kir" maxlength="12" required>
                        </div>
                        </div> <!---- col 2 -->
						<div class='col-sm-4'>	
                        <div class="form-group">
