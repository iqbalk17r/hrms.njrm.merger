...
<div class="row">
	<div class="col-xs-6">
		<div class="box">
			<div class="box-header">
				<div class="col-xs-12">
					<h4>Filter List Kendaraan LOG STNK</h4>
				</div>
			</div>
			<div class="box-body">
				<div class="form-horizontal">
					<form action="<?php echo site_url('ga/kendaraan/listmobil_inquirystnk');?>" name="form" role="form" method="post">										
	...
	<div class="col-xs-6">
		<div class="box">
			<div class="box-header">
				<div class="col-xs-12">
					<h4>Download Excel Historis STNK</h4>
				</div>
			</div>
			<div class="box-body">
				<div class="form-horizontal">
					<form action="<?php echo site_url('ga/kendaraan/excel_history_stnkb');?>" name="form" role="form" method="post">										
						<div class="form-group">
							<label class="col-lg-3">Wilayah</label>	
								<div class="col-lg-9">    
								<select class="form-control input-sm" name="kdcabang" id="kdcabang"  required>
