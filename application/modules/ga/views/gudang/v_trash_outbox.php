				...
				<div class="row">
                    <div class="col-xs-12">
						<div class="box">
							...
							<a button class="btn btn-primary"  href="<?php echo site_url('sms/empty_trash_outbox');?>" style="margin:10px" OnClick="return confirm('Anda Yakin Hapus semua?')"><i class="glyphicon glyphicon-trash"></i> EMPTY TRASH</a>
                            ...
                            <div class="box-body">
								...
								<tr>
									...
									<td><a href="<?php echo site_url('sms/hps_trash_outbox').'/'.$row->id;?>" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->id);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>
                                </table>
  ...
  <div class="modal-dialog modal-sm">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<form role="form" action="<?php echo site_url('sms/list_trash_outbox');?>" method="post">
