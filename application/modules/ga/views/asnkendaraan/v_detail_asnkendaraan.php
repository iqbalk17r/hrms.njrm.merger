...
<div><a href="<?php echo site_url('ga/asnkendaraan/form_asnkendaraan');?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
					...
					<div class='row'>
						<div class='col-sm-4'>	
						 <div class="form-group">
							...
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="APPROVALASNKENDARAAN"/>
						  </div>
						  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm tgl" id="docdate" style="text-transform:uppercase" name="docdate" value="<?php echo date('d-m-Y', strtotime(trim($dtlmst['docdate']))) ;?>"  placeholder="Tanggal Input" data-date-format="dd-mm-yyyy" required disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm tgl" id="expasuransi" style="text-transform:uppercase" name="expasuransi" value="<?php echo date('d-m-Y', strtotime(trim($dtlmst['docdate']))) ;?>"  placeholder="Tanggal Expired" data-date-format="dd-mm-yyyy" disabled>
                        </div>
                        <div class="form-group">
                            <label for="inputsm">Total Biaya</label>
                            <input type="text" class="form-control input-sm ratakanan currency" id="ttlvalue" name="ttlvalue" style="text-transform:uppercase" value="<?php echo trim($dtlmst['ttlvalue']);?>"  placeholder="Total Biaya Penggunaan Bahan Bakar" maxlength="12" disabled>
                        </div>
                        </div> <!---- col 2 -->
						<div class='col-sm-4'>
						<div class="form-group">
