...
<div><a href="<?php echo site_url('ga/bbmkendaraan/clear_bbmkendaraan');?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
	...
	<div class="col-xs-12">                            
		<div class="box">
			  <div class="box-body">
					...
					<div class='row'>
						<div class='col-sm-4'>	
						 <div class="form-group">
							...
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="CANCELBBMKENDARAAN">
						  </div>
						  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm " id="bahanbakar" name="bahanbakar" style="text-transform:uppercase" value="<?php echo trim($dtlmst['bahanbakar']);?>" placeholder="Bahan Bakar" maxlength="50" readonly>
                        </div>
						 <div class="form-group">
                            <label for="inputsm">Kilometer Awal</label>
                            <input type="number" class="form-control input-sm ratakanan" id="km_awal" name="km_awal" style="text-transform:uppercase" value="<?php echo trim($dtlmst['km_awal']);?>" placeholder="KM Awal" maxlength="50" readonly>
                          </div>
                          <div class="form-group">
                            <label for="inputsm">Kilometer Akhir</label>
                            <input type="number" class="form-control input-sm ratakanan" id="km_akhir" style="text-transform:uppercase" name="km_akhir"  value="<?php echo trim($dtlmst['km_akhir']);?>" placeholder="KM Akhir" data-date-format="dd-mm-yyyy" readonly>
                          </div>
                        <div class="form-group">
                            <label for="inputsm">Total Biaya</label>
                            <input type="text" class="form-control input-sm ratakanan currency" id="ttlvalue" name="ttlvalue" style="text-transform:uppercase" value="<?php echo trim($dtlmst['ttlvalue']);?>"  placeholder="Total Biaya Penggunaan Bahan Bakar" maxlength="12" readonly>
                        </div>
                        </div> <!---- col 2 -->
						<div class='col-sm-4'>
						<div class="form-group">
					...
					<button type="submit" class="btn btn-danger"> BATALKAN INPUT</button>
				    </div>
			</form>  
		</div><!-- /.box -->
	</div>
