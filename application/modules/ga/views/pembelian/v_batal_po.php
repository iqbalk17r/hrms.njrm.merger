...
<div class="row">
	...
	<a href="<?php echo site_url("ga/pembelian/final_batal_po/$enc_nik") ?>"
		onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat Akan Dibatalkan?')"
		class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;"><i class="fa fa-trash-o"></i> Batal PO</a>
	<div class="col-xs-12">
		<div class="box">
