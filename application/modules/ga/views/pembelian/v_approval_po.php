...
<div class="row">
	...
	<a href="<?php echo site_url("ga/pembelian/reject_approval_po/$enc_nik/$oldStatus") ?>"
		onclick="return confirm('TEKAN (OK) JIKA ANDA SETUJU, JIKA TIDAK TEKAN (CANCELs)?')"
		class="btn btn-warning pull-right" style="margin:10px; color:#ffffff;">Reject</a>
	<div class="col-xs-12">
		<div class="box">
...
<?php if (!in_array($oldStatus, array('A1', 'A2', 'A3', 'A4', 'A5', 'A6'))): ?>
	<div class="row">
		<div class="col-sm-12">
