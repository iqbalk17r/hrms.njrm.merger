...
<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/pembelian/clear_tmp_sppb_hangus/$enc_nik")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="10%">
									<a href="#" data-toggle="modal" data-target="#CANCEL<?php echo  str_replace('.','',trim($row->nodok)).trim($row->nodoktmp);?>" class="btn btn-danger  btn-sm"><i class="fa fa-edit"></i> HANGUS </a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
...
<div class="modal-body">										
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit"  class="btn btn-danger">PENGHANGUSAN</button>
      </div>
	  </form>
</div></div></div>
<?php } ?>
