...
<h5><b><strong><?php echo '  PEMBATALAN PERMINTAAN OLEH :: '.TRIM($dtlnik['nmlengkap']);?></strong></b></h5>
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="10%">
									<a href="#" data-toggle="modal" data-target="#CANCEL<?php echo  str_replace('.','',trim($row->nodok)).trim($row->nodoktmp);?>" class="btn btn-danger  btn-sm"><i class="fa fa-edit"></i> BATAL </a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
						...
						<table id="example2" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td><?php echo $row->qtypo;?></td>
									<td><?php echo $row->satminta;?></td>
									<td><?php echo $row->status;?></td>
									<td><?php echo $row->keterangan;?></td>
									<td width="10%">
										<a href="#" data-toggle="modal" data-target="#DTL<?php echo  str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i>DETAIL</a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">HAPUS PERMINTAAN BARANG KELUAR</h4>
	  </div>
...
<div class="modal-body">										
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="DELTRXMST" class="form-control" style="text-transform:uppercase">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit"  class="btn btn-danger">BATAL</button>
      </div>
	  </form>
</div></div></div>
<?php } ?>
...
<div class="modal fade" id="DTL<?php echo  str_replace('.','',trim($lb->nodok)).trim($lb->id);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($lb->nik); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="DELTRXDTL" class="form-control" style="text-transform:uppercase">								
