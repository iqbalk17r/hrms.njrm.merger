...
<legend><?php echo 'INPUT FAKTUR LAMPIRAN EXTERNAL        :  ' . trim($dtl_mst['idfaktur']); ?></legend>
<?php echo $message; ?>
<div class="row">
	<div class="col-sm-1">
		<a href="<?php echo site_url('ga/pembelian/inputpo_faktur') . '/' . bin2hex($this->encrypt->encode(trim($dtl_mst['nodok']))); ?>"
			type="button" style="margin:10px; color:#000000;" class="btn btn-default" /> Kembali</a>
...
<div class="row">
						...
						<tr>
							...
							<td width="15%">
								...
								<?php if (trim($row->status) == 'I' or trim($row->status) == 'E') { ?>
									...
									<a href="#" onclick="delete_lampiran_detail('<?php echo trim($row->id); ?>')"
	...
	<div class="box col-lg-12">
						...
						<tr>
							...
							<td>
								<a class="btn btn-danger btn-sm"
									onclick="deleteAttachment('<?php echo trim($at->id); ?>','<?php echo trim($at->file_name); ?>','<?php echo bin2hex($this->encrypt->encode(trim($dtl_mst['strtrimref']))); ?>')"><i
		...
		<div class="col-sm-6 ">
			<form role="form" enctype="multipart/form-data" id="inputfile"
				action="<?php echo site_url('ga/pembelian/add_attachment_po'); ?>" method="post">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">INPUT RINCIAN FAKTUR </h4>
				</div>
				<div class="modal-body">
					<form role="form" id="input-faktur-detail" method="post">
						<div class='row'>
							<div class='col-sm-6'>
								<div class="form-group">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span
								aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<h4 class="modal-title" id="myModalLabel">UBAH RINCIAN FAKTUR </h4>
					</div>
					<div class="modal-body">
						<form role="form" id="edit-faktur-detail" method="post">
							<div class='row'>
								<div class='col-sm-6'>
									<div class="form-group">
										<label for="inputsm">NO DOKUMEN SPK</label>
