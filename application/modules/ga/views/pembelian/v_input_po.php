...
<div class="row">
	<div class="col-sm-1">
		<a href="<?php echo site_url("ga/pembelian/clear_tmp_po/$enc_nik") ?>"
			...
			class="btn btn-default" style="margin:10px; color:#000000;" title="KEMBALI"><i class="fa fa-arrow-left"></i>
			Kembali </a>
									...
									<?php } ?>
										<td>
											<a href="#" data-toggle="modal"
												...
												class="btn btn-default  btn-sm-1" title="Detail Referensi Pembelian"><i
													class="fa fa-edit"></i></a>
										</td>
									</tr>
								<?php endforeach; ?>
										...
										<td>
											...
											<?php } else if (trim($lu->stockcode) <> '' and trim($lu->status) == 'I' and trim($lu->qtyminta) > 0) { ?>
													<a href="#" data-toggle="modal"
														...
														class="btn btn-warning  btn-sm-1" title="Validasi Pembelian"><i
															class="fa fa-check-square"></i></a>
											<?php } else if (trim($lu->stockcode) <> '' and trim($lu->status) == 'M') { ?>
														<a href="#" data-toggle="modal"
															data-target="#DTLREVITEM<?php echo trim($lu->rowid); ?>"
															class="btn btn-success  btn-sm-1" title="Mapping Pembelian"><i
																class="fa fa-check-square"></i></a>
											<?php } ?>
												...
												<div class="form-group drst">
													...
													<div class="col-sm-8">
														<input type="number" id="qtyminta" name="qtyminta"
															...
															min="1" class="form-control drst" readonly>
													</div>
												</div>
												...
												<div class="form-group drst">
													...
													<div class="col-sm-4">
														<input type="number"
															...
															min="1" placeholder="0" class="form-control drst">
													</div>
													<div class="col-sm-4">
														<input type="number"
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							<div class="box-body">
								<div class="form-horizontal">
									<form action="<?php echo site_url('ga/pembelian/input_po'); ?>" name="form"
