...
class M_pembelian extends CI_Model{
	...
	function q_tmp_po_dtl_param($param_tmp_dtl){
		return $this->db->query("select * from (
									...
									a.keterangan,a.inputdate,a.inputby,a.updatedate,a.updateby,a.approvaldate,a.approvalby,a.status,a.id,b.nmbarang,c.uraian as nmsatkecil,d.uraian as nmsatbesar,e.uraian as ketstatus,coalesce(round(a.unitprice),0) as unitprice from sc_tmp.po_dtl a
