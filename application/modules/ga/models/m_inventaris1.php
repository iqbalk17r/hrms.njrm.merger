...
class M_inventaris extends CI_Model{
    ...
    var $t_spk_p_column = array('nodok','nodokref','nmbarang','tgldok','nopol','nmbengkel','nmstatus'); //set column field database
    var $t_spk_p_default_order = array('nodok' => 'desc'); // default order
