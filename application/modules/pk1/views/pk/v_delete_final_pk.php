...
<div class="col-sm-11">		
	<a href="<?php echo site_url("pk/pk/form_report_final")?>"  class="btn btn-default" onclick="return confirm('Kembali Akan Mereset Inputan Yang Anda Buat, Apakah Anda Yakin....???')" style="margin:10px; color:#000000;">Kembali</a>
</div>		
<div class="col-sm-1 pull-right">	
	<a href="<?php echo site_url("pk/pk/delete_input_penilaian_karyawan".'/'.trim($dtlrow['nik']).'/'.trim($dtlrow['periode']))?>"  class="btn btn-danger" onclick="return confirm('Apakah Anda Akan Hapus Data Ini??')" style="margin:10px; color:#ffffff;"> Hapus </a>
</div>
</br>
<div class="row">
    <div class="col-sm-12">
