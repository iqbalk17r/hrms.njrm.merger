...
<button type="submit" id="submit"  class="btn btn-primary btn-sm pull-right"><i class="fa fa-gear"></i> SAVE ALL DETAIL</button>
	...
	<input type="hidden" name="type" id="type" value="INPUTDTLINSPEK"class="form-control input-sm"  readonly>
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
							...
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">KODE KRITERIA</label>
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" name="type" id="type" value="INPUTMSTINSPEK"class="form-control input-sm"  readonly>
