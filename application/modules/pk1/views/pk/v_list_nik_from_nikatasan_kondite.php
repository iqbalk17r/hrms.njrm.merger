...
<div class="row">
    <div class="col-sm-12">
        <a href="<?php echo site_url("pk/form_kondite")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
    </div>
    <div class="col-sm-12">
        <div class="box">
            ...
            <div class="box-body table-responsive" style='overflow-x:scroll;'>
                <table id="table" class="table table-bordered table-striped" >
                    ...
                    /*                                    $enc_nik=bin2hex($this->encrypt->encode(trim($lu->nik)));
                                    ...
                                    echo site_url('pk/pk/input_kondite').'/'.trim($enc_nik).'/'.trim($enc_periode);*/?>"  class="btn btn-info  btn-sm">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('pk/pk/list_paginate_input_nik_kondite').'/'.$startPeriode.'/'.$endPeriode?>",
                "type": "POST",
