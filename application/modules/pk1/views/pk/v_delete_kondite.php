...
<div class="col-sm-1 pull-right">
	...
	$enc_startperiode=bin2hex($this->encrypt->encode(trim($startPeriode)));
	$enc_endperiode=bin2hex($this->encrypt->encode(trim($endPeriode)));
	echo site_url("pk/pk/delete_input_kondite/$enc_nik/$enc_startperiode/$enc_endperiode"); ?>" class="btn btn-danger"
        onclick="return confirm('Apakah Hapus Data Ini??')" style="margin:10px; color:#ffffff;"> Hapus </a>
</div>
<?php } ?>
</br>
<div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive" style='overflow-x:scroll;'>
                        <table id="datarekap" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach ($kondite_trx_rekap as $row): ?>
                                <tr>
                                    <td>
