...
<div class="row">
    <div class="col-sm-11">
        <a href="<?php echo site_url("pk/pk/form_report_final_close")?>" class="btn btn-default"
                        ...
                        <table id="example3" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <?php if ($row->fs1_kpi==''){ echo '0'; } else { echo $row->fs1_kpi; } ?></td>
                                    <td align="right">
                                        <?php if ($row->fs1_kondite==''){ echo '0'; } else { echo $row->fs1_kondite; } ?>
                                    </td>
                                    <td align="right">
                                        <?php if ($row->fs1_pa==''){ echo '0'; } else { echo $row->fs1_pa; } ?></td>
                                    ...
                                    <td width="8%">
                                        ...
                                        echo site_url("pk/pk/detail_final_penilaian_karyawan_trx").'/'.$enc_nik.'/'.$enc_periode; ?>"
                                            class="btn btn-default  btn-sm" title="DETAIL FINAL PENILAIAN KARYAWAN"><i
                                                class="fa fa-bars"></i> </a>
                                        <?php if ((trim($row->statustx) == 'P') and $userhr > 0) { ?>
                                        <a href="<?php
															$enc_nik = bin2hex($this->encrypt->encode(trim($row->nik)));
															$enc_periode = bin2hex($this->encrypt->encode(trim($row->periode)));
															echo site_url("pk/pk/cetak") . '/' . $enc_nik . '/' . $enc_periode; ?>" class="btn btn-info  btn-sm"
                                            title="CETAK FINAL PENILAIAN KARYAWAN"><i class="fa fa-print"></i> </a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="8%">
                                <a href="#" onclick="return confirm('Maaf Tidak Ada Aksi !!! ')"
                                    class="btn btn-default  btn-sm" title="FINAL"><i class="fa fa-bars"></i> </a>
                                <!--a href="<!?php
                                $enc_periode=bin2hex($this->encrypt->encode(trim($row->periode)));
