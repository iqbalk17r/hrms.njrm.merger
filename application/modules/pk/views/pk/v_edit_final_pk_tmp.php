...
<div class="col-sm-11">		
    ...
    echo site_url("pk/pk/form_report_final_close_tmp".'/'.$enc_periode.'/'.$enc_dept)?>"  class="btn btn-default"  style="margin:10px; color:#000000;">Kembali</a>
</div>		
                        ...
                        <table id="datatableMaster" class="table table-bordered table-striped" >
                            ...
                            <?php $no=0; foreach($list_tmp_final_pk as $row): $no++;?>
                                <tr>
                                    ...
                                    <td width="8%">
										<a href="#" data-toggle="modal" data-target="#EDMST<?php echo str_replace('.','',trim($row->nodok)).str_replace('.','',trim($row->nik)).str_replace('.','',trim($row->periode));?>" class="btn btn-primary  btn-sm" title="Edit Master Final Score"><i class="fa fa-gear"></i></a>
										<a href="#" data-toggle="modal" data-target="#DTLMST<?php echo str_replace('.','',trim($row->nodok)).str_replace('.','',trim($row->nik)).str_replace('.','',trim($row->periode));?>" class="btn btn-default  btn-sm" title="Detail Master  Final Score"><i class="fa fa-bars"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
						...
						<div class="form-horizontal">
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">KODE KRITERIA</label>
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" name="type" id="type" value="EDITDESCFINALPK"class="form-control input-sm"  readonly>
							...
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">DESKIRPSI KATEGORI</label>
                                    <div class="col-sm-8">
                                        <textarea type="input" name="description" id="description" style="text-transform: uppercase;"class="form-control input-sm"  rows="4" cols="50"><?php echo trim($lb->description); ?></textarea>
                                    </div>
                            </div>
						</div>
					</div><!-- /.box-body -->
