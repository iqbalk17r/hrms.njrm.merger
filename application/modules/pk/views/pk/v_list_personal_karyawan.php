...
<legend><?php echo $title.' TYPE PDCA  '; if($inputfill=='ISD'){ ECHO 'ISIDENTIL'; } else if ($inputfill=='BRK'){ ECHO 'BERKALA'; } ?></legend>
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td><?php if($inputfill=='ISD'){ ECHO 'ISIDENTIL'; } else if ($inputfill=='BRK'){ ECHO 'BERKALA'; };?></td>
