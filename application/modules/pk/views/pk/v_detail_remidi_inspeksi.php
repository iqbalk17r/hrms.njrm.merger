...
<div class="row">
				<div class="col-sm-10">		
                    ...
                    $enc_periode=bin2hex($this->encrypt->encode($periode));
                    $enc_dept=bin2hex($this->encrypt->encode($dtlrow['kddept']));
                    echo site_url("pk/pk/history_remidi_inspeksi_pernik".'/'.$enc_periode.'/'.$enc_dept.'/'.$enc_nik)?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
				</div>
