...
<div class="row">
    <div class="col-sm-10">
        <a href="<?php echo site_url("pk/pk/filter_remidi_inspeksi")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
    </div>
</div>
</br>
<div class="row">
						...
						<table id="example1" class="table table-bordered table-striped" >
							...
							<tbody>
								...
								<tr>
									...
									<td width="8%">
									<a href="<?php
									$enc_dept=bin2hex($this->encrypt->encode(trim($dept)));
									$enc_nik=bin2hex($this->encrypt->encode(trim($row->nik)));
									$enc_periode=bin2hex($this->encrypt->encode(trim($row->periode)));
									echo site_url("pk/pk/history_remidi_inspeksi_pernik").'/'.$enc_periode.'/'.$enc_dept.'/'.$enc_nik; ?>" class="btn btn-default  btn-sm" title="DETAIL KATEGORI"><i class="fa fa-bars"></i> </a>
