...
<div class="row">
				<div class="col-sm-11">		
					<a href="<?php echo site_url("pk/pk/form_inspeksi")?>"  class="btn btn-default" onclick="return confirm('Kembali Akan Mereset Inputan Yang Anda Buat, Apakah Anda Yakin....???')" style="margin:10px; color:#000000;">Kembali</a>
				</div>
				<?php if (trim($dtlrow['status'])=='A') { ?>
				<div class="col-sm-1">		
					<a href="<?php echo site_url("pk/pk/delete_input_inspek".'/'.trim($dtlrow['nik']).'/'.trim($dtlrow['periode']))?>"  class="btn btn-danger" onclick="return confirm('Apakah Anda Akan Hapus Data Ini??')" style="margin:0px; color:#ffffff;"> HAPUS </a>
				</div>
				<?php } ?>
</div>
</br>
