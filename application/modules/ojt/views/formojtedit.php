            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <!--FORM PEMBUKA-->
                        <form action="<?php echo site_url('/ojt/save_penilaian_karyawanupd'); ?>" method="post">
                            ...
                            <?php foreach ($aspek_grouped as $group): 
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <textarea  class="form-control capital" name="aspek[<?= $parent['kd'] ?>]" style="width:100%; height:60px;" required><?= isset($parent['score']) ? htmlspecialchars($parent['score']) : '' ?></textarea>
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <textarea name="catatan" id="catatan" style="width: 100%; resize: none;"
                            class="form-control capital" required><?php echo isset($dtl) ? htmlspecialchars($dtl) : ''; ?></textarea>
                            <div class="text-center" style="margin-top: 20px;">
                        <input type="hidden" name="nik" value="<?php echo isset($_GET['nik']) ? htmlspecialchars($_GET['nik']) : ''; ?>">
                        <input type="hidden" name="kddok" value="<?php echo isset($_GET['kddok']) ? htmlspecialchars($_GET['kddok']) : ''; ?>">
