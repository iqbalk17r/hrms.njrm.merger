...
<div class="row">
						...
						<!--<p align='right' style='margin-right:10px'>Download Laporan MTC Cost:
						...
						<div class="box">
                                ...
                                <div class="box-body table-responsive" style='overflow-x:scroll;'>
                                    <table <?php if(!empty($list_mstccost))
												 {
												 echo 'id="example1"';
												 } 
                                        ...
                                        <thead>
											<tr>
												<th rowspan="2" align="center" valign="middle"><div align="center">No.</div></th>
												<th rowspan="2" valign="middle"><div align="center">Nopol Kendaraan</div></th>
												<th rowspan="2" valign="middle"><div align="center">Jenis Kendaraan</div></th>
												<th rowspan="2" valign="middle"><div align="center">User</div></th>
												<th colspan="14" align="justify"><div align="center">Biaya</div></th>
											</tr>
											
											<tr>
											  <th align="justify">Jan</th>
										      <th align="justify">Feb</th>
										      <th align="justify">March</th>
										      <th align="justify">April</th>
										      <th align="justify">May</th>
										      <th align="justify">June</th>
										      <th align="justify">July</th>
										      <th align="justify">Augst</th>
										      <th align="justify">Sept</th>
										      <th align="justify">Oct</th>
										      <th align="justify">Nov</th>
										      <th align="justify">Dec</th>
										      <th align="justify">Total</th>
										      <th align="justify">Rata2/Thn</th>
										  </tr>
										</thead>
                                        <tbody>
                                            <?php
												 //Menampilkan data turn over yang ada
												 if(empty($list_mstccost))
												 {
												 echo "<tr><td colspan=\"18\">Data tidak tersedia</td></tr>";
												 }else
												 $no=1;
												 {
												 foreach($list_mstccost as $column)
												 {
												?>
											  <tr>
												 
												<td><?php echo $no;?></td>
												<td><?php echo $column->no_pol;?></td>
												<td><?php echo $column->tipe;?></td>
												<td><?php echo $column->userkend;?></td>
												<td><?php echo $column->tglservis;?></td>
												<td><?php echo $column->tglrsk;?></td>
											  </tr>	
											<?php }} ?>
                                        </tbody>                                        
                                    </table>
