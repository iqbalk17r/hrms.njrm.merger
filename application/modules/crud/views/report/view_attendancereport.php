                                    ...
                                    <table <?php if(!empty($list_att))
                                        ...
                                        <thead>
											<tr>
												...
												<th align="justify">Surat Keterangan Dokter</th>
												<th align="justify">Datang Telat</th>
                                        ...
                                        <tbody>
                                            <?php
											  ...
											  <tr>
												...
												<td><?php echo $column->ijinkeluar;?></td>
												<td><?php echo $column->ijinpulang;?></td>
												<td><?php echo $column->suratdokter;?></td>
												<td><?php echo $column->datangtelat;?></td>
												<td><?php echo $column->pulangawal;?></td>
