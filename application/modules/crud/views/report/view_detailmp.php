...
<div class="row">
						...
						<!--<p align='right' style='margin-right:10px'>Download Laporan Detail MP:
						...
						<div class="box">
                                ...
                                <i class="glyphicon glyphicon-user"></i><font color="#00000"><h4>Data Karyawan Nusa</h4></font> 
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive" style='overflow-x:scroll;'>
                                    <table <?php if(!empty($list_detmp))
												 {
												 echo 'id="example1"';
												 } 
                                        ...
                                        <thead>
											<tr>
												<th align="justify">Nomor</th>
												<th align="justify">Departement</th>
												<th align="justify">Sub Departement</th>
												<th align="justify">Jabatan</th>												 
												<th align="justify">Nama</th>
												<th align="justify">Kantor</th>									
											</tr>
										</thead>
                                        <tbody>
                                            <?php
												 ...
												 {
												 $no=1;
												 foreach($list_detmp as $column)
												{
												?>
											  <tr>
												<td><?php echo $no;?></td>
												<td><?php echo $column->departement;?></td>
												<td><?php echo $column->subdepartement;?></td>
												<td><?php echo $column->deskripsi;?></td>												
												<td><?php echo $column->nmlengkap;?></td>
												<td><?php echo $column->desc_cabang;?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Filter Detail MP</h4> 
      </div>
      <div class="modal-body">     				
				<form class="form-horizontal" action="<?php echo site_url('hrd/report/filter');?>" method="post" name="frmGISRequest" onload="disableSelects(document.forms['frmGISRequest'])">
