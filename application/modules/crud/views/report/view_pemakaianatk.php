...
<div class="row">
						...
						<div class="box">
                                ...
                                <div class="box-body table-responsive" style='overflow-x:scroll;'>
                                    <table <?php if(!empty($list_pemakaianatk))
												 {
												 echo 'id="example1"';
												 } 
                                        ...
                                        <thead>
											<tr>
												...
												<th align="justify">Jenis Barang</th>
												<th align="justify">HR & GA</th>
												<th align="justify">Harga</th>
												<th align="justify">Marketing</th>
												<th align="justify">Harga</th>
												<th align="justify">Sales</th>
												<th align="justify">Harga</th>
												<th align="justify">A. Internal</th>
												<th align="justify">Harga</th>
												<th align="justify">Finance</th>
												<th align="justify">Harga</th>
												<th align="justify">Logistik</th>
												<th align="justify">Harga</th>
												<th align="justify">Total(Qty)</th>
												<th align="justify">Total(Rp)</th>											
											</tr>
										</thead>
                                        <tbody>
                                            <?php
												 //Menampilkan data turn over yang ada
												 if(empty($list_pemakaianatk))
												 {
												 echo "<tr><td colspan=\"16\">Data tidak tersedia</td></tr>";
												 }else
												 $no=1;
												 {
												 foreach($list_pemakaianatk as $column)
												 {
												?>
											  <tr>
												 
												<td><?php echo $no;?></td>
												<td><?php echo $column->nmbarang;?></td>
