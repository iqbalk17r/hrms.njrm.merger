						...
						<table id="example1" class="table table-bordered table-striped" >
							...
							<tbody>
								...
								<tr>
									...
									<td width='5%'><?php echo $row->kdjabatan;?></td>
									<td><?php echo $row->descjabatan;?></td>
									<td><?php echo $row->besaran;?></td>
									<td><a href="<?php echo site_url('hrd/uang/hps_um').'/'.$row->kdjabatan;?>" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->descjabatan);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
								</tr>
								<?php endforeach;?>
							</tbody>
						</table>
	...
	<div class="tab-pane" id="tab_2">
		...
		<div class="row">
			<div class="col-xs-8">                            
				<div class="box">
					<div class="box-header">
					   <button class="btn btn-primary" data-toggle="modal" data-target="#kantinmodal" style="margin:10px"><i class="glyphicon glyphicon-plus"></i> INPUT</a>
					</div><!-- /.box-header -->	
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="kantin" class="table table-bordered table-striped" >
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="<?php echo site_url('hrd/uang/hps_kantin').'/'.$lk->id;?>" OnClick="return confirm('Anda Yakin Hapus Kantin<?php echo trim($lk>desc_cabang);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
								</tr>
								<?php endforeach;?>
							</tbody>
						</table>
  ...
  <div class="modal-dialog modal-sm">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('hrd/uang/add_um');?>" method="post">
		  <div class="form-group">
			<label for="jabatan">Kode Level Jabatan</label>
			<input type="text" class="form-control" id="besaran" name="kdjabatan" style="text-transform: uppercase;">											
		  </div>
		  <div class="form-group">
			<label for="jabatan">Jabatan</label>
			<input type="text" class="form-control" id="besaran" name="jabatan" style="text-transform: uppercase;">											
		  </div>
		  <div class="form-group">
...
<div class="modal fade" id="kantinmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('hrd/uang/add_kantin');?>" method="post">
		  <div class="form-group">
