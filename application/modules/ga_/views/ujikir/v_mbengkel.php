					...
					<thead>
						...
						<tr>
							...
							<td width="15%">
									...
									<a href="#" data-toggle="modal" data-target="#ED<?php echo trim($row->kdbengkel);?>" class="btn btn-success  btn-sm">
										<i class="fa fa-edit"></i> EDIT
									</a>
									<a href="#" data-toggle="modal" data-target="#DEL<?php echo trim($row->kdbengkel);?>" class="btn btn-danger  btn-sm">
