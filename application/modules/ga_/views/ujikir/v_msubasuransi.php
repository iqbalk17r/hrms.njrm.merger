...
<legend><?php echo $title.' || '.$kdasuransi;?></legend>
<?php echo $message; ?>
				...
				<table id="example1" class="table table-bordered table-striped" >
					<thead>
						...
						<tr>
							...
							<td width="25%">
									<a href="#" data-toggle="modal" data-target="#DTL<?php echo str_replace('.','',trim($row->kdsubasuransi));?>" class="btn btn-default  btn-sm">
										<i class="fa fa-edit"></i> DETAIL
									</a>
									<a href="#" data-toggle="modal" data-target="#ED<?php echo str_replace('.','',trim($row->kdsubasuransi));?>" class="btn btn-success  btn-sm">
										<i class="fa fa-edit"></i> EDIT
									</a>
									<a href="#" data-toggle="modal" data-target="#DEL<?php echo str_replace('.','',trim($row->kdsubasuransi));?>" class="btn btn-danger  btn-sm">
	  ...
	  <div class="modal-body">
		...
		<div class='row'>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="nmsubasuransi" name="nmsubasuransi" style="text-transform:uppercase" placeholder="NAMA ASURANSI" maxlength="20" required>
			</div>
			<div class="form-group">
