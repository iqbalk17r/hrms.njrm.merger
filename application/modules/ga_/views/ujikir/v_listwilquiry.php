...
<div><a href="<?php echo site_url('ga/kendaraan/inquirystnk');?>" type="button"  style="margin:10px; color:#000000;" class="btn btn-default"/> Kembali</a>
								...
								<thead>
									...
									<tr>
										...
										<td width="15%">
												...
												<a href="<?php echo site_url('ga/kendaraan/detail_logstnk').'/'.trim($row->kdrangka).'/'.trim($row->kdmesin).'/'.trim($row->kdgudang);?>" type="button" class="btn btn-default btn-sm"/>DETAIL LOG STNK</a>												
										</td>
									</tr>
									<?php endforeach;?>	
										</tbody>		
