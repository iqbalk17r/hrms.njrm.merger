			...
			<thead>
				...
				<tr>
					...
					<td width="21%">
							...
							<a href="<?php echo site_url('ga/inventaris/approval_view_perawatanasset').'/'.trim($row->nodok);?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> APPROVAL1</a>
							<?php } else if (trim($row->status)=='A1' and (trim($userhr)>'0'))  { ?>
							<a href="<?php echo site_url('ga/inventaris/approval_view_perawatanasset').'/'.trim($row->nodok);?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> APPROVAL2</a>
							<?php } ?>
							...
							<a href="<?php echo site_url('ga/inventaris/hapus_view_perawatanasset').'/'.trim($row->nodok);?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> HAPUS</a>
							<?php } ?>
					</td>
				</tr>
				<?php endforeach;?>	
