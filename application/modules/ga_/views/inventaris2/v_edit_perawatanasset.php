		...
		<div class='row'>
			...
			<div class="form-group">
			 ...
			 <!--div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="descbarang" style="text-transform:uppercase" name="descbarang" placeholder="Deskripsi Barang"  maxlength="30" value="<?php echo trim($dtl_perawatan['descbarang']);?>" required>
			</div-->
			...
			<div class="form-group">
				...
				<textarea  class="textarea" name="keterangan" placeholder="Keterangan"   maxlength ="159" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"><?php echo trim($dtl_perawatan['keterangan']);?></textarea>
			</div>
			</div> <!---- col 1 -->
			<div class='col-sm-6'>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="km_awal" name="km_awal"  value="<?php echo trim($dtl_perawatan['km_awal']);?>" placeholder="0"  > <!--value=?php echo date('d-m-Y', strtotime(trim($ls->tglmasuk)));?-->
			</div>
			<div class="form-group">
				<label for="inputsm">KM Akhir</label>
				<input type="text" class="form-control input-sm" id="km_akhir" name="km_akhir"  value="<?php echo trim($dtl_perawatan['km_akhir']);?>" placeholder="0" > <!--value=?php echo date('d-m-Y', strtotime(trim($ls->tglmasuk)));?-->
			</div>
			<div class="form-group">
				<label for="inputsm">Penanganan Keluhan</label>
				<textarea  class="textarea" name="laporanpk" placeholder="Penanganan Keluhan"   maxlength ="159" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"><?php echo trim($dtl_perawatan['laporanpk']);?></textarea>
			</div>
			<div class="form-group">
				<label for="inputsm">Penggantian Spare Part</label>
				<textarea  class="textarea" name="laporanpsp" placeholder="Penggantian Spare Part"   maxlength ="159" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"><?php echo trim($dtl_perawatan['laporanpsp']);?></textarea>
			</div>
			<!--div class="form-group">
