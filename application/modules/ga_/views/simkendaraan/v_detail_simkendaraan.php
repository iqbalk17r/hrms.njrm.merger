                    ...
                    <div class='row'>
                        ...
                        <div class='col-sm-4'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm ratakanan currency " id="ttlvalue" name="ttlvalue"  value="<?php echo trim($dtlmst['ttlvalue']);?>"  placeholder="Total Biaya Pengurusan SIM" maxlength="12" readonly>
                            </div>
                        </div> <!---- col 2 -->
                        <div class='col-sm-4'>
                            <div class="form-group">
