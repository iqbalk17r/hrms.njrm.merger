					...
					<div class='row'>
						<div class='col-sm-4'>
						 <div class="form-group">
							...
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDITSIMKENDARAAN">
						  </div>
						  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm  ratakanan currency " id="ttlvalue" name="ttlvalue" style="text-transform:uppercase" value="<?php echo trim($dtlmst['ttlvalue']);?>"  placeholder="Total Biaya Pengurusan SIM" maxlength="12" required>
                        </div>
                        </div> <!---- col 2 -->
						<div class='col-sm-4'>	
                        <div class="form-group">
