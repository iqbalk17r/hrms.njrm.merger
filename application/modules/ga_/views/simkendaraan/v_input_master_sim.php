                    ...
                    <div class='row'>
                        ...
                        <div class='col-sm-4'>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm " id="typesim" name="typesim" style="text-transform:uppercase" value="<?php echo trim($typesim);?>" placeholder="Nomor SIM" maxlength="50" readonly>
                            </div>
                            <div class="form-group">
                                <label for="inputsm">Dokumen Surat Ijin Mengemudi</label>
                                <input type="text" class="form-control input-sm " id="docsim" name="docsim" style="text-transform:uppercase" placeholder="Nomor SIM" maxlength="50" required>
                            </div>
                            <div class="form-group">
                                <label for="inputsm">Tanggal Pembuatan SIM</label>
                                <input type="text" class="form-control input-sm tgl" id="datecreate" style="text-transform:uppercase" name="datecreate" placeholder="Create Sim" data-date-format="dd-mm-yyyy" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm tgl" id="expsim" style="text-transform:uppercase" name="expsim" placeholder="Expired Sim" data-date-format="dd-mm-yyyy" required>
                        ...
                        <div class='col-sm-4'>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" name="reminder" id="reminder" required>
                                    <option value="YES">YES</option>
                                    <option value="NO">NO</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea  class="textarea" name="description" placeholder="Keterangan"   maxlength ="159" style="text-transform: uppercase; width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;"></textarea>
