	...
	<div class="col-xs-12">                            
		<div class="box">
			  <div class="box-body">
					...
					<div class='row'>
						<div class='col-sm-4'>
						 <div class="form-group">
							...
							<input type="hidden" class="form-control input-sm" id="type" name="type" value="CANCELINPUTSIM">
						  </div>
						  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm ratakanan currency" id="ttlvalue" name="ttlvalue" style="text-transform:uppercase" value="<?php echo trim($dtlmst['ttlvalue']);?>"  placeholder="Total Biaya Pengurusan SIM" maxlength="12" readonly>
                        </div>
                        </div> <!---- col 2 -->
						<div class='col-sm-4'>	
                        <div class="form-group">
					...
					<button type="submit" class="btn btn-danger">Batalkan Inputan</button>
				    </div>
			</form>  
		</div><!-- /.box -->
	</div>
