	  ...
	  <div class="box-body">
		...
		<div class='row'>
			...
			<div class="form-group">
				...
				<input type="hidden" class="form-control input-sm"  name="kdbarang"  id="kdbaranged" value="<?php echo trim($dtl['nodok']);?>" >
					<select class="form-control input-sm "  readonly disabled>
					 <option value="">---PILIH KODE BARANG--</option> 
					  <?php foreach($list_barang as $sc){?>					  
					  <option <?php if (trim($dtl['nodok'])==trim($sc->nodok)) { echo 'selected';}?> value="<?php echo trim($sc->nodok);?>"  class="<?php echo trim($sc->kdsubgroup);?>" ><?php echo trim($sc->nodok).' || '.trim($sc->nmbarang).' || '.trim($sc->nopol);?></option>						  
					  <?php }?>
					</select>
			</div>	
			<div class="form-group">
				<label for="inputsm">NOPOL</label>
				<input type="text" class="form-control input-sm"  style="text-transform:uppercase"  value="<?php echo trim($dtl['nopol']);?>" placeholder="Input Nomor SK"  maxlength="20" readonly disabled>
				<input type="hidden" class="form-control input-sm" id="nopol" style="text-transform:uppercase"  value="<?php echo trim($dtl['nopol']);?>"  name="nopol" placeholder="Input Nomor SK"  maxlength="20" readonly >
			</div>			
			</div> <!---- col 1 -->
			<div class='col-sm-6'>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<select class="form-control input-sm usertau" name="usertau" id="usertau" >
