...
<div class="box-body">										
					...
					<div class="box-body">
						<div class="form-horizontal">	
							<div class="form-group">
								...
								<div class="col-sm-8">  
								<?php if(trim($po_dtl['status'])=='H') { ?>
									<input type="hidden" id="type" name="type"  value="UPDATE_HARGA_HANGUS" class="form-control" style="text-transform:uppercase">								
								<?php } ?>
						...
						<!---?php } ?---->	
							...
							<div class="form-group row">
								...
								<div class="col-sm-4"> 
									<input type="input"  id="ttlbrutto" name="ttlbrutto"  value="<?php echo trim($po_dtl['ttlbrutto']);?>"  onkeyup="formatangkaobjek(this)" placeholder="0" class="form-control ratakanan" >
								</div>
								<!--span class="col-sm-4"> 
	...
	<?php } else if (trim($po_mst['status'])=='C') { ?>		
			<a href="<?php $enc_nodoktmp=bin2hex($this->encrypt->encode(trim($po_mst['nodok'])));
			echo site_url("ga/pembelian/batal_po_atk/$enc_nodoktmp");?>" type="button" class="btn btn-default"/> Kembali</a>
	<?php } else if (trim($po_mst['status'])=='H') { ?>		
			<a href="<?php $enc_nodoktmp=bin2hex($this->encrypt->encode(trim($po_mst['nodok'])));
			echo site_url("ga/pembelian/hangus_po_atk/$enc_nodoktmp");?>" type="button" class="btn btn-default"/> Kembali</a>
	<?php } ?>
