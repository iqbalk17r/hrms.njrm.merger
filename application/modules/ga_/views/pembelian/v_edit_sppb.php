...
<h5><b><strong><?php echo TRIM($dtlnik['nmlengkap']).'  SILAHKAN UBAH PERMINTAAN PEMBELIAN BARANG/JASA';?></strong></b></h5>
<span id="postmessages"></span>
<?php echo $message;?>

<div class="row">
		<div class="col-sm-12">
			<a href="<?php echo site_url("ga/pembelian/clear_tmp_sppb/$enc_nodok")?>"  class="btn btn-default" style="margin:10px; color:#000000;" title="KEMBALI"><i class="fa fa-arrow-left"></i> Kembali</a>
			<a href="<?php echo site_url("ga/pembelian/final_input_sppb/$enc_nodok")?>"  class="btn btn-success pull-right" onclick="return confirm('Apakah Anda Simpan Data Ini??')" style="margin:0px; color:#ffffff;" title="SIMPAN SEMUA EDIT SPPB"><i class="fa fa-save"></i> </a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
			...
			<div class="col-xs-12"> 
				<div class="row">
					<?php// if ($sppb_mst=='A') { ?>
					<div class="col-sm-12">
						<a href="#" data-toggle="modal" data-target="#inputModal<?php echo str_replace('.','',trim($sppb_mst['nodok']));?>" style="margin:10px; color:#ffffff;"  class="btn btn-primary btninput" title="INPUT DETAIL SPPB"><i class="fa fa-plus"></i> </a>
							...
							<thead>
								...
								<tr>
									...
									<td width="8%">
											...
											<a href="#" data-toggle="modal" data-target="#ED<?php echo str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-primary  btn-sm"><i class="fa fa-gear"></i> </a>
											<a href="#" data-toggle="modal" data-target="#DEL<?php echo str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-danger  btn-sm"><i class="fa fa-trash-o"></i> </a>
											<?php// } ?>
									</td>
								</tr>
								<?php endforeach;?>	
...
<div class="modal fade" id="inputModal<?php echo str_replace('.','',trim($lb->nodok));?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="INPUTTMPDTLEDIT" class="form-control" style="text-transform:uppercase">	
...
$(function() {				 
	...
	/*.on('change', function() {
      ...
      <div class="modal-footer">
        <!--a href="<?php echo site_url('ga/pembelian/list_personalniksppb');?>" type="button" class="btn btn-default"/> Kembali</a-->
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($lb->nik); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="EDITTMPDTL" class="form-control" style="text-transform:uppercase">								
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($lb->nik); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="DELETETMPDTLEDIT" class="form-control" style="text-transform:uppercase">	
									<input type="hidden" id="nodok" name="nodok"  value="<?php echo trim($lb->nodok);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="id" name="id"  value="<?php echo trim($lb->id);?>" class="form-control" style="text-transform:uppercase">
								</div>
							</div>	
