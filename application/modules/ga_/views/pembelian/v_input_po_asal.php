...
<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/pembelian/clear_tmp_po/$enc_nik")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
	<div class="col-xs-12">                            
		<div class="box">
				...
				<table id="example2" class="table table-bordered table-striped" >
					<thead>
						...
						<tr>
							...
							<td><?php echo $row->qtysppbminta;?></td>
							<td><?php echo $row->satminta;?></td>
							<td><?php echo $row->status;?></td>
							<td><?php echo $row->keterangan;?></td>
							<td width="10%">
									...
									<a href="#" data-toggle="modal" data-target="#APPRDTL<?php echo  str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-success  btn-sm"><i class="fa fa-edit"></i> APP DTL </a>
									<a href="#" data-toggle="modal" data-target="#REJAPPDTL<?php echo  str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-warning  btn-sm"><i class="fa fa-edit"></i> REJ DTL </a>
									<?php } else if (trim($row->status)=='P' OR trim($row->status)=='C') { ?> 
									<a href="#" data-toggle="modal" data-target="#CAPPRDTL<?php echo  str_replace('.','',trim($row->nodok)).trim($row->id);?>" class="btn btn-danger  btn-sm"><i class="fa fa-edit"></i> RESET </a>
...
<div class="row">
							...
							<div class="col-sm-12">
								<div class="box box-danger">
									<div class="box-header">
										<h4 align="center"><?php echo 'TITLE 2';?></h4>
					...
					<form role="form" action="<?php echo site_url("ga/pembelian/kurang_itempo");?>" method="post">
						<div class="col-sm-12">
							<div class="box box-danger">
								<div class="box-header">
									<h4 align="center"><?php echo 'TITLE 1';?></h4>
									...
									<table id="table2" class="table table-bordered table-striped" >
										...
										<tbody>
											...
											<tr>										
												...
												<td><?php echo $lu->qtyminta;?></td>
												<td><?php echo $lu->satminta;?></td>							
												<td>
													<?php if (trim($lu->stockcode)=='' and trim($lu->status)=='I' ) { ?>
														<a href="#" data-toggle="modal" data-target="#MAPREVITEM<?php echo trim($lu->rowid);?>"  onclick="return confirm('Anda Akan Masuk Ke Menu Mapping Stock?')" class="btn btn-primary  btn-sm-1"><i class="fa fa-cogs"></i></a>			
													<?php } else if(trim($lu->stockcode)<>'' and trim($lu->status)=='I') { ?>
													...
													<a href="#" data-toggle="modal" data-target="#DTLREVITEM<?php echo trim($lu->rowid);?>"  onclick="return confirm('Lihat Detail ?')" class="btn btn-success  btn-sm-1"><i class="fa fa-check-square"></i></a>
													<?php } ?>
...
<div class="modal-body">										
      ...
      <div class="modal-footer">
        <!--a href="<?php echo site_url('ga/pembelian/list_niksppb');?>" type="button" class="btn btn-default"/> Kembali</a-->
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="submit" id="submit"  class="btn btn-success">SETUJUI PEMBELIAN</button>
      </div>
	  </form>
</div></div></div>
<?php } ?>
