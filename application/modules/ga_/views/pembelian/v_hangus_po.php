...
<div class="row">
	<div class="col-sm-1">
		<a href="<?php echo site_url("ga/pembelian/clear_tmp_po/$enc_nik/$oldStatus") ?>"
			...
			class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>

	</div>
	<a href="<?php echo site_url("ga/pembelian/final_hangus_po/$enc_nik") ?>"
		onclick="return confirm('Anda Yakin Dengan Inputan Yang Anda Buat Akan Dihanguskan Dan Qty Yg diterima akan sama?')"
		class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;">HANGUS PO</a>
	<div class="col-xs-12">
		<div class="box">
							...
							<tr>
								...
								<td width="12%">
									...
									echo site_url("ga/pembelian/detail_po_dtl_tmp/$enc_rowid"); ?>"
										...
										class="btn btn-default  btn-sm-1"><i class="fa fa-cogs"></i></a>
