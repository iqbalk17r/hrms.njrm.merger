                    ...
                    <div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<div class="col-xs-12">
									<h4>HISTORY PEMAKAIAN/PENGELUARAN BARANG KELUAR</h4>
								</div>
							</div>
                            <div class="box-body">
								<div class="form-horizontal">
									<form action="<?php echo site_url('ga/permintaan/history_bbk');?>" name="form" role="form" method="post">										
										<div class="form-group">
										 <label class="col-lg-3">Periode Pemakaian/Pengeluaran Barang </label>
											<div class="col-lg-9">
							...
							<div class="form-group ">
								<label class="col-sm-3" for="inputsm">Kode Group Barang</label>	
									<div class="col-sm-9">  
...
$(function() {
	 ...
	 $('#kdgroup').selectize({
        ...
        $('#kdsubgroup')[0].selectize.clearOptions();
							...
							<div class="form-group ">
								<label class="col-sm-3" for="inputsm">Kode Sub Group Barang</label>	
									<div class="col-sm-9">  
	...
	/// $('[name=\'kdsubgroup\']').selectize({
	 $('#kdsubgroup').selectize({
        ...
        $('#kdbarang')[0].selectize.clearOptions();
							...
							<div class="form-group ">
								<label class="col-sm-3" for="inputsm">Kode Barang</label>	
									<div class="col-sm-9">  
                                    <select name="kdbarang" class="form-control input-sm ch" placeholder="---KETIK KODE BARANG/ NAMA BARANG--" id="kdbarang">
                                        <option value="" class=""></option>
                                    </select>
									</div>
							</div>
