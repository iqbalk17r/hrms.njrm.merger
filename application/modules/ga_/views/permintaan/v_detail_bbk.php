...
<h5><b><strong><?php echo '  DETAIL BBK & PENGAJUAN BBK';?></strong></b></h5>
<?php echo $message;?>

<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("ga/permintaan/form_bbk")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								<tr>											
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_bbk_trx_mst as $row): $no++;?>
								<tr>
									...
									<td><?php echo date('d-m-Y', strtotime(trim($row->approvaldate)));?></td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
						</table>
					...
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example2" class="table table-bordered table-striped" >
							<thead>
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_bbk_trx_dtl as $row): $no++;?>
								<tr>
									...
									<td width="15%">
											...
											<a href="#" data-toggle="modal" data-target="#DTL<?php echo str_replace('.','',trim($row->nodok)).trim($row->kdgroup).trim($row->kdsubgroup).trim($row->stockcode);?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL </a>
...
<?php foreach ($list_bbk_trx_mst as $lb) { ?>
<div class="modal fade" id="APPROVALBBK<?php echo str_replace('.','',trim($lb->nodok)).trim($row->nodokref);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">SIMPAN UBAH QTY BBK</h4>
	  </div>
...
<div class="modal-body">										
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="APPROVALBBK" class="form-control" style="text-transform:uppercase">								
			...
			<div class="col-sm-6">
				<div class="box box-danger">
					<div class="box-body">
						<div class="form-horizontal">
							<div class="form-group ">
								<label class="col-sm-4">DOKUMEN BBK</label>	
								<div class="col-sm-8">    
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit"  class="btn btn-primary">APPROVE</button>
      </div>
	  </form>
</div></div></div>
<?php } ?>
...
<?php foreach ($list_bbk_trx_dtl as $lb) { ?>
<div class="modal fade" id="DTL<?php echo str_replace('.','',trim($lb->nodok)).trim($lb->kdgroup).trim($lb->kdsubgroup).trim($lb->stockcode);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM UBAH QTY BUKTI BARANG KELUAR</h4>
	  </div>
<form action="<?php echo site_url('ga/permintaan/save_bbk')?>" method="post" name="inputformPbk">
<div class="modal-body">										
		<div class="row">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($lb->nik); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="#" class="form-control" style="text-transform:uppercase">								
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="number" id="qtybbk" name="qtybbk"  value="<?php echo trim($lb->qtybbk1);?>"  placeholder="0" class="form-control" readonly >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-4">Keterangan</label>	
								<div class="col-sm-8">    
									<textarea type="text" id="keterangan" name="keterangan"   style="text-transform:uppercase" class="form-control" readonly><?php echo trim($lb->keterangan);?></textarea>
								</div>
							</div>		
