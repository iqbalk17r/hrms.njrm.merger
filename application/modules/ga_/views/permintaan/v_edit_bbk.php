...
<?php echo $message;?>
		...
		<div class="row">
			...
			<div class="col-xs-12"> 
				...
				<div class="col-sm-1 pull-right">		
					<a href="<?php echo site_url("ga/permintaan/cancel_tmp_bbk_dtl/$enc_nodok")?>"  class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Akan Reset Detail Data Ini??')" style="margin:0px; color:#ffffff;">CANCEL</a>
				</div>
				<?php// } ?>
				</div>			
				<div class="box">
							...
							<thead>
								...
								<tr>
									...
									<td width="15%">
										...
										<?php } else { ?>
											<a href="#" data-toggle="modal" data-target="#ED<?php echo str_replace('.','',trim($row->nodok)).trim($row->kdgroup).trim($row->kdsubgroup).trim($row->stockcode);?>" class="btn btn-success  btn-sm"><i class="fa fa-edit"></i> INPUT QTY BBK </a>
										<?php } ?>				
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($lb->nik); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="EDITTRXDTL" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="nodok" name="nodok"  value="<?php echo trim($lb->nodok);?>" class="form-control" style="text-transform:uppercase">
									<input type="hidden" id="nodokref" name="nodokref"  value="<?php echo trim($lb->nodokref); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="nodoktmp" name="nodoktmp"  value="<?php echo trim($lb->nodoktmp); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="nodoktype" name="nodoktype"  value="<?php echo trim($lb->nodoktype); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
								</div>
							</div>	
							<div class="form-group">
								<label class="col-sm-4">Nama Karyawan</label>	
