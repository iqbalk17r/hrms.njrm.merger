...
<h5><b><strong><?php echo 'HANGUS PERMINTAAN BARANG KELUAR';?></strong></b></h5>
<span id="postmessages"></span>
<?php echo $message;?>

<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("ga/permintaan/form_view_hangus_pbk")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td><?php echo date('d-m-Y', strtotime(trim($row->hangusdate)));?></td>
									<td><?php echo $row->hangusby;?></td>
...
<div class="modal fade" id="APPPBK1<?php echo trim($lb->nodok);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal-body">										
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm tgl" id="inputdate" name="inputdate"  data-date-format="dd-mm-yyyy"  value=<?php echo date('d-m-Y', strtotime(trim($lb->inputdate)));?> required>
								</div>
							</div>
						</div>		
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit"  class="btn btn-primary">APPROVAL</button>
      </div>
	  </form>
</div></div></div>	
<?php } ?>
