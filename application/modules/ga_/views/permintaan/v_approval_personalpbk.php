...
<div class="row">
		<div class="col-sm-1">		
			<a href="<?php echo site_url("ga/permintaan/clear_tmp_pbk/$enc_nik")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		</div>
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td>
									<a href="#" data-toggle="modal" data-target="#APPROVE<?php echo  str_replace('.','',trim($row->nodok)).trim($row->nodoktmp);?>" class="btn btn-success  btn-sm"><i class="fa fa-edit"></i> APPROVE </a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">PERSETUJUAN PERMINTAAN BARANG</h4>
	  </div>
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="APPROVETMP" class="form-control" style="text-transform:uppercase">
...
<div class="modal fade" id="APPRDTL<?php echo  str_replace('.','',trim($lb->nodok)).trim($lb->kdgroup).trim($lb->kdsubgroup).trim($lb->stockcode);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM APPROVAL DETAIL PERMINTAAN BARANG</h4>
	  </div>
<form action="<?php echo site_url('ga/permintaan/save_personalpbk')?>" method="post" name="inputformPbk">
<div class="modal-body">										
		<div class="row">
