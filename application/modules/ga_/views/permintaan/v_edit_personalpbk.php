					...
					<!--div class="container"--->
						<div class="dropdown ">
							...
							<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
							  ...
							  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#inputModal<?php echo str_replace('.','',trim($pbk_mst['nodok']));?>"  href="#">INPUT PERMINTAAN</a></li> 
							  <!--li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url("ga/permintaan/list_nikpbk")?>">Input PBK</a></li-->
							...
							<thead>
								...
								<tr>
									...
									<td width="15%">
											...
											<a href="#" data-toggle="modal" data-target="#ED<?php echo  str_replace('.','',trim($row->nodok)).trim($row->kdgroup).trim($row->kdsubgroup).trim($row->stockcode);?>" class="btn btn-success  btn-sm"><i class="fa fa-edit"></i> EDIT </a>
