						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td>
									<a href="#" data-toggle="modal" data-target="#INPUTTRX<?php echo str_replace('.','',trim($row->nodok)).trim($row->nodokref);?>" class="btn btn-danger  btn-sm"><i class="fa fa-edit"></i> BATALKAN </a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
...
<div class="modal-body">										
						...
						<div class="form-horizontal">	
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="BATALFINALBBM" class="form-control" readonly >
								</div>
							</div>
							<div class="form-group ">
						...
						<?php if ($nodoktype!='AJS') { ?>
							...
							<?php } else { ?>
								<div class="form-group ">
									...
									<div class="col-sm-8">    
										<input type="text" id="nodokfrom" name="nodokfrom"   value="<?php echo trim($lb->nodokfrom);?>" class="form-control " readonly >
									</div>
								</div>	
							<?php } ?>
							<div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="submit"  class="btn btn-danger">BATAL BBM</button>
      </div>
	  </form>
</div></div></div>
<?php } ?>
