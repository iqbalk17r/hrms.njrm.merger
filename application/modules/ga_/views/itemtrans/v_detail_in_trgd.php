...
<div class="row">
		<div class="col-sm-12">		
			<a href="<?php echo site_url("ga/itemtrans/form_itemtrans_in_trgd")?>"  onclick="return confirm('Anda yakin akan kembali ?')" class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
