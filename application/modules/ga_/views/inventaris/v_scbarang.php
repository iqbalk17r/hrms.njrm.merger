  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">MASTER SKEMA BARANG</h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_scbarang');?>" method="post">
		  <div class="form-group">
			...
			<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" placeholder="Input Kode Group Schema Barang" maxlength="6" required>
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_scbarang');?>" method="post">
		  <div class="form-group">
			<label for="inputsm">Kode Skema Barang</label>
			<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" value="<?php echo trim($ls->kdgroup);?>" placeholder="Input Kode Group Schema Barang & Asset" maxlength="6" readonly>
			<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDIT">
		  </div>
		  <div class="form-group">
			<label for="inputsm">Nama Skema</label>
			<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" value="<?php echo trim($ls->nmgroup);?>" placeholder="Input Nama Group Schema Barang & Asset" required>
		  </div>
		<div class="form-group">
			<label for="inputsm">Hold Schema</label>	
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/del_scbarang');?>" method="post">
			<div class="form-group">
					<label for="inputsm">Kode Skema Barang</label>
					<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" value="<?php echo trim($ls->kdgroup);?>" placeholder="Input Kode Group Schema Barang & Asset" readonly>
					<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDIT">
				  </div>
				  <div class="form-group">
					<label for="inputsm">Nama Skema</label>
					<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" value="<?php echo trim($ls->nmgroup);?>" placeholder="Input Nama Group Schema Barang & Asset" readonly>
				  </div>
				<div class="form-group">
					<label for="inputsm">Hold Schema</label>	
