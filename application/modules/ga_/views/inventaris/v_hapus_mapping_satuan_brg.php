	...
	<div class="col-xs-12">                            
		<div class="box">
			<div class="box-header">
			 <legend><?php echo 'HAPUS MAPPING SATUAN BARANG PERBANDINGAN DENGAN SATUAN DASAR ';?></legend>							
			</div><!-- /.box-header -->	
	  <div class="box-body">
	  ...
	  <button type="submit" class="btn btn-danger btn-sm pull-right"><i class="fa fa-trash-o"></i>Hapus</button>
		</div><!-- /.box -->
	</form>
	</div>
</div>
