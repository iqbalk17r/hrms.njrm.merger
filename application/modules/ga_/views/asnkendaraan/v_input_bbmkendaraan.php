					...
					<div class='row'>
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            ...
                            <input type="number" class="form-control input-sm ratakanan" id="km_awal" name="km_awal" style="text-transform:uppercase" value="<?php echo trim($dtlmst['km_awal']);?>" placeholder="KM Awal" maxlength="50" required>
                          </div>
                          <div class="form-group">
                            <label for="inputsm">Kilometer Akhir</label>
                            <input type="number" class="form-control input-sm ratakanan" id="km_akhir" style="text-transform:uppercase" name="km_akhir"  value="<?php echo trim($dtlmst['km_akhir']);?>" placeholder="KM Akhir" data-date-format="dd-mm-yyyy" required>
                          </div>
                        <div class="form-group">
