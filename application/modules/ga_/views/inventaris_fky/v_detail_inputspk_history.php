			...
			<thead>
				...
				<tr>
					...
					<td width="10%">
							...
							echo site_url('ga/inventaris/detail_perawatan_mst_lampiran_history').'/'.$enc_strtrimref;?>"  class="btn btn-default  btn-sm">
								<i class="fa fa-edit"></i> DETAIL
							</a>
							<?php /*
...
<div class="modal fade" id="DTLFAKTUR<?php echo trim($ls->id);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
