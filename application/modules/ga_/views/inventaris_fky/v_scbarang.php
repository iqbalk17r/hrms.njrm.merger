		...
		<!--div class="container"--->
			<div class="dropdown ">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
				  ...
				  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#myModal1"  href="#">Input Skema Barang</a></li> 
...
<div class="col-sm-12">
	...
	<ul class="nav nav-tabs">					
		<li class="active"><a href="#tab_1" data-toggle="tab">Skema Barang</a></li>
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">FORM INPUT MASTER SKEMA BARANG</h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_scbarang');?>" method="post">
		  <div class="form-group">
			...
			<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" placeholder="Input Kode Group Skema Barang" maxlength="6" required>
			<input type="hidden" class="form-control input-sm" id="type" name="type" value="INPUT">
		  </div>
		  <div class="form-group">
			<label for="inputsm">Nama Skema</label>
			<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" placeholder="Input Nama Group Skema Barang & Asset" required>
		  </div>
		<div class="form-group">
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/input_scbarang');?>" method="post">
		  <div class="form-group">
			<label for="inputsm">Kode Skema Barang</label>
			<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" value="<?php echo trim($ls->kdgroup);?>" placeholder="Input Kode Group Skema Barang & Asset" maxlength="6" readonly>
			<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDIT">
		  </div>
		  <div class="form-group">
			<label for="inputsm">Nama Skema</label>
			<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" value="<?php echo trim($ls->nmgroup);?>" placeholder="Input Nama Group Skema Barang & Asset" required>
		  </div>
		<div class="form-group">
			<label for="inputsm">Hold Skema</label>	
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('ga/inventaris/del_scbarang');?>" method="post">
			<div class="form-group">
					<label for="inputsm">Kode Skema Barang</label>
					<input type="text" class="form-control input-sm" id="kdgroup" name="kdgroup" style="text-transform:uppercase" value="<?php echo trim($ls->kdgroup);?>" placeholder="Input Kode Group Skema Barang & Asset" readonly>
					<input type="hidden" class="form-control input-sm" id="type" name="type" value="EDIT">
				  </div>
				  <div class="form-group">
					<label for="inputsm">Nama Skema</label>
					<input type="text" class="form-control input-sm" id="nmgroup" style="text-transform:uppercase" name="nmgroup" value="<?php echo trim($ls->nmgroup);?>" placeholder="Input Nama Group Skema Barang & Asset" readonly>
				  </div>
				<div class="form-group">
					<label for="inputsm">Hold Skema</label>	
