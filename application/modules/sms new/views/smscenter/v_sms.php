...
<div class="row">
	<div class="col-sm-12">
		...
		<button class="btn btn-danger" data-toggle="modal" data-target="#smsBroadcast">Broadcast SMS</button>
	</div>
</div>	
</br>
<div class="row">
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td><a href="<?php echo site_url('sms/smscenter/hps_sms').'/'.$row->id;?>" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->id);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
						...
						<table id="example2" class="table table-bordered table-striped" >
							 <thead>
								...
								<tr>
									...
									<td><a href="<?php echo site_url('sms/smscenter/hps_sentitem').'/'.trim($row->id);?>" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->id);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
...
<div class="tab-pane" id="tab_3" style="position: relative; height: 300px;" >
		...
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
					<div class="box-header">
					  <a button class="btn btn-primary"  href="<?php echo site_url('sms/smscenter/empty_trash_inbox');?>" style="margin:10px" OnClick="return confirm('Anda Yakin Hapus semua?')"><i class="glyphicon glyphicon-trash"></i> EMPTY TRASH</a>
					</div><!-- /.box-header -->	
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
...
<div class="tab-pane" id="tab_4" style="position: relative; height: 300px;" >
		...
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
					<div class="box-header">
					 <a button class="btn btn-primary"  href="<?php echo site_url('sms/smscenter/empty_trash_outbox');?>" style="margin:10px" OnClick="return confirm('Anda Yakin Hapus semua?')"><i class="glyphicon glyphicon-trash"></i> EMPTY TRASH</a>
					</div><!-- /.box-header -->	
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
						<table id="example4" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td><?php echo $row->isi_sms;?></td>									
									<td><?php echo $row->tanggal_kirim;?></td>
									<td><a href="<?php echo site_url('sms/smscenter/hps_trash_outbox').'/'.$row->id;?>" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->id);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>
						</table>
...
<div class="modal fade" id="<?php echo trim($lo->id);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">Kirim ULANG SMS <?php echo '</br>'. $lo->nama;?></h4>
	  </div>
	  <div class="modal-body">
		<form role="form" action="<?php echo site_url('sms/smscenter/input_sms');?>" method="post">
		  <div class="form-group">
			<label for="besaran">Nomer Penerima</label>
			<input type="text" class="form-control"  name="penerima" value="<?php echo trim($lo->no_penerima);?>" readonly>
		  </div>
            <div class="form-group">
                <label >Isi SMS</label>
                <textarea type="text" id="isi" name="isi" class="form-control " style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px ;" readonly><?php echo trim($lo->isi_sms);?></textarea>
            </div>
...
<div class="modal fade" id="filter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
	  ...
	  <form action="<?php site_url('sms/smscenter/index')?>" method="post">
      <div class="modal-body">
