...
<h5><b><strong><?php echo '  UBAH DATA PLAN DO CHECK ACTION (PDCA)';?></strong></b></h5>
<?php echo $message;?>

<div class="row">							
		<div class="col-sm-12">		
			<a href="<?php echo site_url("pdca/pdca/clear_tmp_pdca")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
			<a href="<?php echo site_url("pdca/pdca/final_input_pdca")?>" onclick="return confirm('Akan Disimpan Final Seluruh Detail Yang Anda Buat? Anda Yakin?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;">Final Edit</a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"   value="<?php echo trim($lb->do_c);?>" class="form-control clock" disabled readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"  max="100" value="<?php echo trim($lb->percentage);?>" class="form-control" disabled readonly >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Remark</label>	
