...
<h5><b><strong><?php echo '  INPUT (PLAN DO CHECK ACTION) ';?></strong></b></h5>
<?php echo $message;?>
...
<div class="row">
		...
		<div class="col-sm-12">		
			...
			<a href="<?php echo site_url("pdca/pdca/final_input_pdca")?>" onclick="return confirm('Akan Disimpan Final Seluruh Detail Yang Anda Buat? Anda Yakin?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;"><i class="fa fa-save"></i> Final Input </i></a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
		  ...
		  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#inputDetailPDCA"  href="#"><i class="fa fa-pencil">  Input Detail</i></a></li> 
			...
			<div class="col-xs-12"> 
				<div class="box">
					...
					<a href="<?php echo site_url("pdca/pdca/reset_dtl_tmp_pdca")?>"  class="btn btn-danger pull-right" onclick="return confirm('Reset Akan Menghapus Seluruh Detail Yang Anda Buat? Anda Yakin?')" style="margin:10px; color:#ffffff;"><i class="fa fa-repeat"> RESET </i></a>
					</div><!-- /.box-header -->	
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">INPUT MASTER PDCA <?php /*echo $lb->tglawal.$lb->tglakhir;*/?></h4>
	  </div>
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="INPUT_MST_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
				  ...
				  <tr><td>
					<div class="row">
								...
								<div class="col-sm-2 col-sm-offset-0"> <label>QTY/TIME</label>	
									<div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control tglrangetimeZZ#" maxlength="50" required >
<?php } else { ?>			
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control clock" required >
<?php } ?>			
									</div>
								...
								<div class="col-sm-2"><label>DO</label>	
								  <div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?> 
									<input type="text" id="do_c" name="do_c[]"  class="form-control tglrangetimeZZ#" readonly disabled>
<?php } else { ?>
									<input type="text" id="do_c" name="do_c[]"  class="form-control clock" readonly disabled>	
<?php } ?>						  
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($pdca_mst['nik']); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="EDIT_DTL_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docno" name="docno"  value="<?php echo trim($pdca_mst['docno']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docref" name="docref"  value="<?php echo trim($pdca_mst['docref']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="doctype" name="doctype"  value="<?php echo trim($pdca_mst['doctype']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden"  id="planperiod" name="planperiod"  value="<?php echo trim($pdca_mst['planperiod']);?>"  class="form-control" style="text-transform:uppercase">
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control tglrangetimeZZ#" maxlength="50" required >
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"   value="<?php echo trim($lb->do_c);?>" class="form-control tglrangetimeZZ"  readonly disabled>
								</div>
							</div>
<?php } else { ?>			
							<div class="form-group">
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control tglrangetimeZZ#" readonly disabled >
								</div>
							</div>
