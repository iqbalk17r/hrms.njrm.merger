            ...
            $(function() {
				...
				$('#daristock').on('click', function() {
					if ($(this).val()=='YES') {
						...
						$('.drst').prop('disabled readonly',true);
						$('.drst').show();
					} else if ($(this).val()=='NO') {
						console.log($(this).val());
						$('.drst').prop('disabled readonly',false);
						$('.drst').hide();
					}
				});
...
<h5><b><strong><?php echo '  HAPUS DETAIL DATA PLAN DO CHECK ACTION PER PERIODE MASTER';?></strong></b></h5>

<div class="row">
							
		<div class="col-sm-12">		
			<a href="<?php echo site_url("pdca/pdca/form_view_pdca_sub_detail/$enc_nik/$enc_doctype/$enc_planperiod")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
			<a href="<?php echo site_url("pdca/pdca/hapus_input_pdca/$enc_nik/$enc_doctype/$enc_planperiod/$enc_docdate")?>" onclick="return confirm('Akan Terhapus Seluruh Detail Yang Anda Buat? Anda Yakin?')" class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;">Hapus PDCA</a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="10%">
									<a href="#" data-toggle="modal" data-target="#INPUTMSTPDCA<?php echo str_replace('.','',trim($row->docno));?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL MASTER</a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="10%">
									<a href="#" data-toggle="modal" data-target="#INPUTMSTPDCA<?php echo str_replace('.','',trim($row->docno));?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> UBAH MASTER</a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm tglrange" id="docdaterange" name="docdaterange"   value="<?php if (empty($lb->tglawal) or empty($lb->tglakhir)) { echo ''; } else { echo date('d-m-Y', strtotime(trim($lb->tglawal))).' - '.date('d-m-Y', strtotime(trim($lb->tglakhir))); } ?>"  disabled readonly>									
								</div>
							</div>
...
<?php } else { ?>							
							<div class="form-group ">
								<label class="col-sm-4">TANGGAL </label>	
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm tgl" id="docdate" name="docdate"  data-date-format="dd-mm-yyyy"   value="<?php if (!empty($lb->docdate)) { echo date('d-m-Y', strtotime(trim($lb->docdate))); } else { echo '';} ;?>"  disabled readonly>
								</div>
							</div>
<?php } ?>
							<div class="form-group">
...
<?php } ?>							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="idbu" name="idbu"   class="form-control" style="text-transform:uppercase" maxlength="12" disabled readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PLAN</label>	
								<div class="col-sm-8">    
									<!--input type="text"  id="descplan" name="descplan"  class="form-control" style="text-transform:uppercase" maxlength="150" disabled readonly-->
									<textarea type="text" id="descplan" name="descplan"   style="text-transform:uppercase"  maxlength="100" class="form-control" disabled readonly></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  class="form-control clock" disabled readonly >
								</div>
							</div>
							<div class="form-group">
				  ...
				  <tr><td>
					<div class="row">
								...
								<div class="col-sm-2 col-sm-offset-0"> <label>QTY/TIME</label>	
									<div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control tglrangetime" disabled readonly >
<?php } else { ?>			
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control clock" disabled readonly >
<?php } ?>			
									</div>
								...
								<div class="col-sm-2"><label>DO</label>	
								  <div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?> 
									<input type="text" id="do_c" name="do_c[]"  class="form-control tglrangetime" readonly disabled>
<?php } else { ?>
									<input type="text" id="do_c" name="do_c[]"  class="form-control clock" readonly disabled>	
<?php } ?>						  
...
<?php } ?>
							<div class="form-group">
								<label class="col-sm-4">IDBU</label>	
								<div class="col-sm-8">    
									<input type="text" id="idbu" name="idbu" value="<?php echo trim($lb->idbu);?>" class="form-control" style="text-transform:uppercase" maxlength="12" disabled readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PLAN</label>	
								<div class="col-sm-8">    
									<!--input type="text"  id="descplan" name="descplan"  value="<?php echo trim($lb->descplan);?>"  class="form-control" style="text-transform:uppercase" maxlength="150" disabled readonly-->
									<textarea type="text" id="descplan" name="descplan"   style="text-transform:uppercase"  maxlength="100" class="form-control" disabled readonly><?php echo trim($lb->descplan);?></textarea>
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control tglrangetime" disabled readonly >
								</div>
							</div>
...
<?php } else { ?>			
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control clock" disabled readonly >
								</div>
							</div>
