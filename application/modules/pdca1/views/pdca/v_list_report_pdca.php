		...
		<!--div class="container"--->
			<div class="dropdown ">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
				  ...
				  <?php /*<li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#ChoiceOfLetter"  href="#"><i class="fa fa-plus"></i>INPUT TYPE PDCA</a></li> */ ?> 
						...
						<table id="example1" class="table table-bordered table-striped" >
							...
							<tbody>
								...
								<tr>									
									...
									echo site_url("pdca/pdca/report_month_recapitulation").'/'.$enc_nik.'/'.$enc_doctype.'/'.$enc_planperiod ?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL </a>
								
																	<a href="<?php 
									$enc_nik=bin2hex($this->encrypt->encode(trim($row->nik)));
									$enc_doctype=bin2hex($this->encrypt->encode(trim($row->doctype)));
									$enc_planperiod=bin2hex($this->encrypt->encode(trim($row->planperiod)));
									echo site_url("pdca/pdca/sti_pdca_isidentil_report").'/'.$enc_nik.'/'.$enc_doctype.'/'.$enc_planperiod ?>" class="btn btn-warning  btn-sm" target="_blank"><i class="fa fa-edit"></i> CETAK </a>
									</td>
								</tr>
								<?php endforeach;?>	
							</tbody>		
...
<form action="<?php echo site_url('pdca/pdca/form_report_pdca')?>" method="post" name="inputformPbk">
<div class="modal-body">										
		<div class="row">
			<div class="col-sm-12">
				<div class="box box-danger">
