...
<div class="row">
	<div class="col-sm-12">	
		<!--div class="container"--->
		<a ="<?php echo site_url("pdca/pdca/form_pdca")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
		<?php trim($withconfirm['withconfirm']); ?>
		<?php if (trim($dtlstatus['nik_atasan'])==$nama and trim($withconfirm['withconfirm'])=='0') { ?>
		<a ="<?php echo site_url("pdca/pdca/hapus_input_pdca_berkala/$nik/$periode")?>"  class="btn btn-danger pull-right" style="margin:10px; color:#ffffff;">Hapus PDCA 1 Periode</a>
		<?php } ?>
			<!--div class="dropdown ">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
				  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#Filter"  ="#"><i class="fa fa-search"></i>Filter Pencarian</a></li> 
				  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#ChoiceOfLetter"  ="#"><i class="fa fa-plus"></i>INPUT TYPE PDCA</a></li> 
				  <!--li role="presentation"><a role="menuitem" tabindex="-1" ="<?php echo site_url("ga/ajustment/input_ajustment_in_trgd")?>">Input Transfer Antar Gudang</a></li-->		
				<!--/ul>
			</div>
		<!--/div-->
	</div><!-- /.box-header -->
								...
								<tbody>
									<?php $no=0; foreach ($list_pdca as $ls): $no++ ?>
										<tr>																													
											...
											<!--td bgcolor="#70dbdb"><a <?php $nik=trim($ls->nik); $bln=substr(trim($ls->planperiod),-2); $thn=substr(trim($ls->planperiod),4); $tgl=$thn.'-'.$bln.'-01'; ?> ="<?php echo site_url("trans/jadwal_new/edit_detail/$nik/$tgl");?>"><?php echo $ls->tgl1;?></a></td-->
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl1'])!='FINAL')) { ?>
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='01'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl1;?></a></td>
<?php } ?>
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl2'])!='FINAL')) { ?>				
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='02'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl2;?></a></td>
<?php } ?>											
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl3'])!='FINAL')) { ?>	
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='03'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl3;?></a></td>
<?php } ?>	
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl4'])!='FINAL')) { ?>												
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='04'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl4;?></a></td>
<?php } ?>	
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl5'])!='FINAL')) { ?>												
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='05'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl5;?></a></td>
<?php } ?>												
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl6'])!='FINAL')) { ?>												
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='06'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl6;?></a></td>
<?php } ?>
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl7'])!='FINAL')) { ?>																								
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='07'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl7;?></a></td>
<?php } ?>
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl8'])!='FINAL')) { ?>			
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='08'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl8;?></a></td>
<?php } ?>				
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl9'])!='FINAL')) { ?>								
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='09'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl9;?></a></td>
<?php } ?>	
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl10'])!='FINAL')) { ?>									
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='10'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl10;?></a></td>
<?php } ?>		
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl11'])!='FINAL')) { ?>											
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='11'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl11;?></a></td>
<?php } ?>		
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl12'])!='FINAL')) { ?>												
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='12'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl12;?></a></td>
<?php } ?>		
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl13'])!='FINAL')) { ?>											
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='13'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl13;?></a></td>
<?php } ?>
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl14'])!='FINAL')) { ?>														
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='14'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl14;?></a></td>
<?php } ?>											
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl15'])!='FINAL')) { ?>	
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='15'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl15;?></a></td>
<?php } ?>
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A' or (trim($ls->nik)==$nama and trim($dtlstatus['tgl16'])!='FINAL')) { ?>																							
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='16'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl16;?></a></td>
<?php } ?>							
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl17'])!='FINAL')) { ?>					
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='17'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl17;?></a></td>
<?php } ?>		
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl18'])!='FINAL')) { ?>								
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='18'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl18;?></a></td>
<?php } ?>													
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl19'])!='FINAL')) { ?>
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='19'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl19;?></a></td>
<?php } ?>							
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl20'])!='FINAL')) { ?>																	
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='20'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl20;?></a></td>
<?php } ?>	
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl21'])!='FINAL')) { ?>									
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='21'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl21;?></a></td>
<?php } ?>												
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl22'])!='FINAL')) { ?>									
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='22'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl22;?></a></td>
<?php } ?>												
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl23'])!='FINAL')) { ?>	
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='23'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl23;?></a></td>
<?php } ?>												
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl24'])!='FINAL')) { ?>	
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='24'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl24;?></a></td>
<?php } ?>																							
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl25'])!='FINAL')) { ?>	
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='25'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl25;?></a></td>
<?php } ?>																							
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl26'])!='FINAL')) { ?>	
											<td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='26'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl26;?></a></td>
<?php } ?>																							
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl27'])!='FINAL')) { ?>	
											<td bgcolor="#70dbdb"><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='27'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl27;?></a></td>																
<?php } ?>	
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl28'])!='FINAL')) { ?>																				
											<?php $a_date=$tglperiod;$cekdate=date("t",strtotime($a_date)); if($cekdate>=28){ ?><td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='28'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl28;?></a></td><?php } ?>			<!-- Fleksibel tanggal bro-->					
<?php } ?>			
...
<?php } else if (trim($ls->nik_atasan)==$nama or $userhr>0 or $level_akses=='A'  or (trim($ls->nik)==$nama and trim($dtlstatus['tgl30'])!='FINAL')) { ?>								
											<?php $a_date=$tglperiod;$cekdate=date("t",strtotime($a_date)); if($cekdate>=30){ ?><td ><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='30'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->tgl30;?></a></td><?php } ?>			<!-- Fleksibel tanggal bro-->					
<?php } ?>
...
<?php } ?>											
											<td><a ="#" data-url="<?php $nik=trim($ls->nik); $planperiod=trim($ls->planperiod); $nomor=trim($ls->nomor); $urutcategory=trim($ls->urutcategory); $dy='XX'; echo site_url("pdca/pdca/edit_detail_pdca_berkala/$nik/$nomor/$planperiod/$urutcategory/$dy"); ?>" class="show" data-toggle="modal" data-target=".pp"><?php echo $ls->remark;?></a></td>		
										</tr>
									<?php endforeach ?>
								</tbody>
							</table>
