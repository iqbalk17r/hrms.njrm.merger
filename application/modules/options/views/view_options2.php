...
<div class="box-body">
								...
								<tr>
									...
									<td><?php echo $opti->tgl;?></td>
									<td><?php echo $opti->status;?></td>
									<td><a href="#" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($opti->kode);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
							...
							<div class="form-horizontal">								
								...
								<div class="form-group">
									...
									<label class="col-sm-4">Valdate</label>	
										<div class="col-sm-8">    
											<input type="text" name="valdate1" value="<?php echo $op->tgl;?>" required title="Masukan Config"></input>
										</div>
								</div>
								<div class="form-group">
