...
<h5><b><strong><?php echo '  UBAH DATA PLAN DO CHECK ACTION ';?></strong></b></h5>
<?php echo $message;?>
...
<div class="row">
		...
		<div class="col-sm-12">		
			...
			<a href="<?php echo site_url("pdca/pdca/final_input_pdca")?>" onclick="return confirm('Akan Disimpan Final Seluruh Detail Yang Anda Buat? Anda Yakin?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;"><i class="fa fa-save"> Final Ubah </i></a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="10%">
									<a href="#" data-toggle="modal" data-target="#INPUTMSTPDCA<?php echo str_replace('.','',trim($row->docno));?>" class="btn btn-primary  btn-sm"><i class="fa fa-edit"></i> UBAH MASTER</a>
									</td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>		
...
<div class="col-sm-12">	
	<div class="dropdown ">
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
		  <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#inputDetailPDCA"  href="#"><i class="fa fa-pencil"> Input Detail </i></a></li> 
		</ul>
	</div>
</div><!-- /.box-header -->
			...
			<div class="col-xs-12"> 
				<div class="box">
					...
					<!--a href="<?php echo site_url("pdca/pdca/reset_dtl_tmp_pdca")?>"  class="btn btn-danger pull-right" onclick="return confirm('Reset Akan Menghapus Seluruh Detail Yang Anda Buat? Anda Yakin?')" style="margin:10px; color:#ffffff;">RESET</a---->
					</div><!-- /.box-header -->	
					<div class="box-body table-responsive" style='overflow-x:scroll;'>
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>
						<table id="example2" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="15%">
									<a href="#" data-toggle="modal" data-target="#ED_DTL<?php echo str_replace('.','',trim($row->docno)).trim($row->nomor);?>" class="btn btn-primary  btn-sm"><i class="fa fa-edit"></i> UBAH </a>	
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">INPUT MASTER PDCA SESSION EDIT</h4>
	  </div>
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>
							<div class="form-group ">
								...
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm tglrange" id="docdaterange" name="docdaterange"   value="<?php if (empty($lb->tglawal) or empty($lb->tglakhir)) { echo ''; } else { echo date('d-m-Y', strtotime(trim($lb->tglawal))).' - '.date('d-m-Y', strtotime(trim($lb->tglakhir))); } ?>"  required>									
								</div>
							</div>
...
<?php } else { ?>							
							<div class="form-group ">
								<label class="col-sm-4">TANGGAL </label>	
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm tgl" id="docdate" name="docdate"  data-date-format="dd-mm-yyyy"   value="<?php if (!empty($lb->docdate)) { echo date('d-m-Y', strtotime(trim($lb->docdate))); } else { echo '';} ;?>"  required>
								</div>
							</div>
<?php } ?>
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<textarea type="text" id="global_desc" name="global_desc"   style="text-transform:uppercase" class="form-control"><?php echo trim($lb->global_desc);?></textarea>
								</div>
							</div>		
						</div>	
					</div><!-- /.box-body -->													
      ...
      <div class="modal-footer">
		...
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
         <button type="submit" id="submit"  class="btn btn-primary" <?php if ($pdca_dtl_row>0) { ?> disabled title="DETAIL SUDAH TERISI TIDAK DAPAT DI UBAH, RESET DETAIL UNTUK MERUBAH MASTER" <?php } ?> >SIMPAN</button>  
      </div>
	  </form>
</div></div></div>
<?php } ?>
...
<?php /*
<div class="modal fade" id="inputDetailPDCA" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM INPUT DETAIL (PDCA)</h4>
	  </div>
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="INPUT_DTL_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>					
							<div class="form-group ">
								<label class="col-sm-4">TANGGAL </label>	
								<div class="col-sm-8">    
									<input type="text" class="form-control input-sm" id="docdate" name="docdate"  data-date-format="dd-mm-yyyy"   value="<?php if (!empty($pdca_mst['docdate'])) { echo date('d-m-Y', strtotime($pdca_mst['docdate'])); } else { echo '';} ;?>"  readonly>
								</div>
							</div>
<?php } ?>							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="idbu" name="idbu"   class="form-control" style="text-transform:uppercase" maxlength="12" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PLAN</label>	
								<div class="col-sm-8">    
									<!--input type="text"  id="descplan" name="descplan"  class="form-control" style="text-transform:uppercase" maxlength="150" required-->
									<textarea type="text" id="descplan" name="descplan"   style="text-transform:uppercase"  maxlength="100" class="form-control" required></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  class="form-control clock" required >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"  class="form-control clock" readonly disabled>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"  class="form-control"  max="100"  placeholder="0" readonly disabled>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<textarea type="text" id="remark" name="remark"   style="text-transform:uppercase"  maxlength="100" class="form-control"></textarea>
								</div>
							</div>							
						</div>
							</div><!-- /.box-body -->													
...
<div class="modal fade" id="inputDetailPDCA" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
	<div class="modal-content">
	  ...
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM INPUT DETAIL (PDCA) SESSION EDIT</h4>
	  </div>
			<form action="<?php echo site_url('pdca/pdca/save_pdca')?>" method="post">
			<div class="modal-body">										
				<div class="box box-danger">
				  <div class="box-body">
								   ...
								   <button type="button" class="btn btn-primary btn-sm" onClick="addRow('dataDetailPDCA')"><i class="fa fa-plus"></i></button>
								  <button type="button" class="btn btn-danger btn-sm" onClick="deleteRow('dataDetailPDCA')"><i class="fa fa-minus"></i></button>
								 
								  </div>
				  <table id="dataDetailPDCA">
				  <tr><td>
					<div class="row">
								<div class="col-sm-2"> <label>IDBU</label>							
									<div class="form-group">
									      
										<input type="hidden" id="nik" name="nik"  value="<?php echo trim($pdca_mst['nik']); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
										<input type="hidden" id="type" name="type"  value="EDITINP_DTL_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
										<input type="hidden" id="docno" name="docno"  value="<?php echo trim($pdca_mst['docno']);?>" class="form-control" style="text-transform:uppercase">								
										<input type="hidden" id="docref" name="docref"  value="<?php echo trim($pdca_mst['docref']);?>" class="form-control" style="text-transform:uppercase">								
										<input type="hidden" id="doctype" name="doctype"  value="<?php echo trim($pdca_mst['doctype']);?>" class="form-control" style="text-transform:uppercase">								
										<input type="hidden"  id="planperiod" name="planperiod"  value="<?php echo trim($pdca_mst['planperiod']);?>"  class="form-control" style="text-transform:uppercase">
										<input type="hidden" class="form-control input-sm" id="docdate" name="docdate"  data-date-format="dd-mm-yyyy"   value="<?php if (!empty($pdca_mst['docdate'])) { echo date('d-m-Y', strtotime($pdca_mst['docdate'])); } else { echo '';} ;?>"  readonly>
										<input type="text" id="idbu" name="idbu[]"   class="form-control" style="text-transform:uppercase" maxlength="12" required>
									  
									</div>											
								</div>	
								<div class="col-sm-2 col-sm-offset-0"> <label>PLAN</label>								
									<div class="form-group">
								...
								<div class="col-sm-2 col-sm-offset-0"> <label>QTY/TIME</label>	
									<div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control" required >
<?php } else { ?>			
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control clock" required >
<?php } ?>			
									</div>
								</div>
								<div class="col-sm-2"><label>DO</label>	
								  <div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?> 
									<input type="text" id="do_c" name="do_c[]"  class="form-control" readonly disabled>
<?php } else { ?>
									<input type="text" id="do_c" name="do_c[]"  class="form-control clock" readonly disabled>	
<?php } ?>						  
								...
								<div class="col-sm-2"> <label>PERCENTAGE %</label>	  
								  <div class="form-group">
								...
								<div class="col-sm-2">   <label>Remark</label>	  
								  <div class="form-group">								  
									  <textarea type="text" id="remark" name="remark[]"   style="text-transform:uppercase"  maxlength="100" class="form-control"></textarea>
								  </div>	
								</div>  
...
<div class="modal fade" id="ED_DTL<?php echo str_replace('.','',trim($lb->docno)).trim($lb->nomor);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM UBAH DETAIL (PDCA)</h4>
	  </div>
			<form action="<?php echo site_url('pdca/pdca/save_pdca')?>" method="post">
			<div class="modal-body">										
			<div class="row">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($pdca_mst['nik']); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="EDIT_2EDIT_DTL_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docno" name="docno"  value="<?php echo trim($pdca_mst['docno']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docref" name="docref"  value="<?php echo trim($pdca_mst['docref']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="doctype" name="doctype"  value="<?php echo trim($pdca_mst['doctype']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden"  id="planperiod" name="planperiod"  value="<?php echo trim($pdca_mst['planperiod']);?>"  class="form-control" style="text-transform:uppercase">
...
<?php } ?>
							<div class="form-group">
								<label class="col-sm-4">IDBU</label>	
								<div class="col-sm-8">    
									<input type="text" id="idbu" name="idbu" value="<?php echo trim($lb->idbu);?>" class="form-control" style="text-transform:uppercase" maxlength="12" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PLAN</label>	
								<div class="col-sm-8">    
									...
									<textarea type="text" id="descplan" name="descplan"   style="text-transform:uppercase"  maxlength="100" class="form-control" required><?php echo trim($lb->descplan);?></textarea>
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control " required >
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"   value="<?php echo trim($lb->do_c);?>" class="form-control "  readonly disabled>
								</div>
							</div>
<?php } else { ?>			
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control clock" required >
								</div>
							</div>
...
<?php } ?>								
							...
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"  max="100" value="<?php echo trim($lb->percentage);?>" class="form-control"   readonly disabled>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Remark</label>	
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($pdca_mst['nik']); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="DEL_DTL_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docno" name="docno"  value="<?php echo trim($pdca_mst['docno']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docref" name="docref"  value="<?php echo trim($pdca_mst['docref']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="doctype" name="doctype"  value="<?php echo trim($pdca_mst['doctype']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden"  id="planperiod" name="planperiod"  value="<?php echo trim($pdca_mst['planperiod']);?>"  class="form-control" style="text-transform:uppercase">
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime" name="qtytime"  value="<?php echo trim($lb->qtytime);?>" class="form-control tglrangetime" readonly disabled >
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"   value="<?php echo trim($lb->do_c);?>" class="form-control tglrangetime"  readonly disabled>
								</div>
							</div>
<?php } else { ?>			
							<div class="form-group">
