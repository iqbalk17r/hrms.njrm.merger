...
<h5><b><strong><?php echo '  REALISASI DATA PLAN DO CHECK ACTION (PDCA)';?></strong></b></h5>
<?php echo $message;?>

<div class="row">							
		<div class="col-sm-12">		
			<a href="<?php echo site_url("pdca/pdca/clear_tmp_pdca")?>"  class="btn btn-default" style="margin:10px; color:#000000;">Kembali</a>
			<a href="<?php echo site_url("pdca/pdca/final_input_pdca")?>" onclick="return confirm('Akan Disimpan Final Seluruh Detail Yang Anda Buat? Anda Yakin?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;">Final REALISASI</a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">UBAH DATA MASTER PDCA</h4>
	  </div>
					...
					<div class="box-body">
						<div class="form-horizontal">	
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"  class="form-control clock"  disabled readonly >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"  class="form-control"  max="100"  disabled readonly >
...
<div class="modal fade" id="ED_DTL<?php echo str_replace('.','',trim($lb->docno)).trim($lb->nomor);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM UBAH REALISASI DETAIL (PDCA)</h4>
	  </div>
			<form action="<?php echo site_url('pdca/pdca/save_pdca')?>" method="post">
			<div class="modal-body">										
			<div class="row">
			...
			<div class="col-sm-6">
				<div class="box box-danger">
						...
						<div class="form-horizontal">	
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<textarea type="text" id="descplan" name="descplan"   style="text-transform:uppercase"  maxlength="100" class="form-control" readonly ><?php echo trim($lb->descplan);?></textarea>
							...
							<div class="form-group">
								<label class="col-sm-4">QTY/TIME</label>	
								<div class="col-sm-8">    
									<input type="text" id="qtytime"   value="<?php echo trim($lb->qtytime);?>" class="form-control clock" readonly disabled>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
							...
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"  max="100" value="<?php echo trim($lb->percentage);?>" class="form-control" required >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Remark</label>	
				  ...
				  <div class="modal-footer">
					<!--a href="<?php echo site_url('ga/permintaan/list_personalnikpbk');?>" type="button" class="btn btn-default"/> Kembali</a-->
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button> 
					<button type="submit" id="submit"  class="btn btn-primary">Ubah Realisasi</button>
				  </div>
			  </form>
		</div>
	</div>
			...
			<div class="col-sm-6">
				<div class="box box-danger">
				  ...
				  <div class="modal-footer">
					<!--a href="<?php echo site_url('ga/permintaan/list_personalnikpbk');?>" type="button" class="btn btn-default"/> Kembali</a-->
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button> 
					<!--?PHP /*<button type="submit" id="submit"  class="btn btn-danger">HAPUS</button>
					*/ ?-->
				  </div>
			  </form>
		</div>
