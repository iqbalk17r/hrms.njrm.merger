						...
						<table id="example1" class="table table-bordered table-striped" >
							...
							<tbody>
								...
								<tr>									
									...
									<td><strong><b><?php echo $row->nmdoctype;?></b></strong></td>
									...
									<!--a href="#" data-toggle="modal" data-target="#DTL<?php echo trim($row->docno);?>" class="btn btn-default  btn-sm"><i class="fa fa-edit"></i> DETAIL </a-->
							...
							<div class="form-group ">
								<label class="col-sm-4" for="inputsm">PILIH TIPE PDCA </label>	
									...
									<select class="form-control input-sm inputfill" name="inputfill"  required>
									 <option value="ISD"> INSIDENTAL </option> 
