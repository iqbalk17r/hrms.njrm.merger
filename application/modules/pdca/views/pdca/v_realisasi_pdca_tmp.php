...
<h5><b><strong><?php echo '  UBAH DATA & REALISASI PLAN DO CHECK ACTION (PDCA)';?></strong></b></h5>
<?php echo $message;?>
...
<div class="row">
		...
		<div class="col-sm-12">		
			...
			<a href="<?php echo site_url("pdca/pdca/final_input_pdca")?>" onclick="return confirm('Akan Disimpan Final Seluruh Detail Yang Anda Buat? Anda Yakin?')" class="btn btn-success pull-right" style="margin:10px; color:#ffffff;"><i class="fa fa-save"> Final Realisasi </i></a>
		</div>
		<div class="row">
			<div class="col-xs-12">                            
				<div class="box">
						...
						<table id="example1" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td align="right"><?php echo $row->nmstatus;?></td>
						...
						<table id="example2" class="table table-bordered table-striped" >
							<thead>
								...
								<tr>
									...
									<td width="10%"><?php echo trim($row->nmstatus);?></td>
  ...
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel">INPUT MASTER PDCA SESSION EDIT<?php echo $lb->tglawal.$lb->tglakhir;?></h4>
	  </div>
						...
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="type" name="type"  value="REALISASI_MST_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									...
									<input type="hidden" id="nik" name="atasan2"  value="<?php echo trim($lb->nik_atasan2); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly disabled>
								</div>
							</div>	
						</div>
					</div><!-- /.box-body -->													
...
<?php } ?>
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<textarea type="text" id="global_desc" name="global_desc"   style="text-transform:uppercase" class="form-control" readonly disabled><?php echo trim($lb->global_desc);?></textarea>
								</div>
							</div>		
						</div>	
					</div><!-- /.box-body -->													
				  ...
				  <tr><td>
					<div class="row">
								...
								<div class="col-sm-2 col-sm-offset-0"> <label>QTY/TIME</label>	
									<div class="form-group">
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control tglrangetime" required >
<?php } else { ?>			
											<input type="text" id="qtytime" name="qtytime[]"  class="form-control clock" required >
<?php } ?>			
									</div>
...
<div class="modal fade" id="ED_DTL<?php echo str_replace('.','',trim($lb->docno)).trim($lb->nomor);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		<h4 class="modal-title" id="myModalLabel">FORM UBAH DAN REALISASI DETAIL (PDCA)</h4>
	  </div>
			<form action="<?php echo site_url('pdca/pdca/save_pdca')?>" method="post">
			<div class="modal-body">										
			<div class="row">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nik" name="nik"  value="<?php echo trim($pdca_mst['nik']); ?>" class="form-control" style="text-transform:uppercase" maxlength="40" readonly>								
									<input type="hidden" id="type" name="type"  value="REALISASI_2EDIT_DTL_PDCA_ISL" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docno" name="docno"  value="<?php echo trim($pdca_mst['docno']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="docref" name="docref"  value="<?php echo trim($pdca_mst['docref']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden" id="doctype" name="doctype"  value="<?php echo trim($pdca_mst['doctype']);?>" class="form-control" style="text-transform:uppercase">								
									<input type="hidden"  id="planperiod" name="planperiod"  value="<?php echo trim($pdca_mst['planperiod']);?>"  class="form-control" style="text-transform:uppercase">
...
<?php if(trim($pdca_mst['lvl_jabatan'])=='C') { ?>										
							...
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"   value="<?php echo trim($lb->do_c);?>" class="form-control tglrangetimeZZ#" maxlength="50" required>
								</div>
							</div>
<?php } else { ?>			
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-4">DO</label>	
								<div class="col-sm-8">    
									<input type="text" id="do_c" name="do_c"   value="<?php echo trim($lb->do_c);?>" class="form-control clock"  required>
								</div>
							</div>
<?php } ?>								
							...
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"  max="100" min="0" max="100"  value="<?php echo trim($lb->percentage);?>" class="form-control"   required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Remark</label>	
...
<?php } ?>		
							<div class="form-group">
								<label class="col-sm-4">PERCENTAGE %</label>	
								<div class="col-sm-8">    
									<input type="number" id="percentage" name="percentage"   value="<?php echo trim($lb->percentage);?>" class="form-control" maxlength="3"  readonly disabled >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4">Remark</label>	
