...
<legend><?php echo $title.'  TIPE   '; if($inputfill=='ISD'){ ECHO 'INSIDENTAL'; } else if ($inputfill=='BRK'){ ECHO 'BERKALA'; } ?></legend>
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td><?php if($inputfill=='ISD'){ ECHO 'INSIDENTAL'; } else if ($inputfill=='BRK'){ ECHO 'BERKALA'; };?></td>
