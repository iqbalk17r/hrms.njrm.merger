...
<div class="box">
    <div class="box-header">
        ...
        <div class="col-sm-12">
            <button class="btn btn-success" onclick="add_pinjaman()"><i class="glyphicon glyphicon-plus"></i> Input </button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input onClick="this.select();" name="nominal" placeholder="BANYAK PINJAMAN NOMINAL" class="fikyseparator form-control inform ratakanan c_hold" type="text" MAXLENGTH="18" style="text-transform:uppercase;"  ">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input onClick="this.select();" name="tenor" placeholder="TENOR BERAPA KALI" class="fikyseparator form-control inform ratakanan c_hold" type="text" MAXLENGTH="18" style="text-transform:uppercase;">  <!-- onkeyup="formatangkaobjek(this)"-->
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input onClick="this.select();" name="npotong" placeholder="POTONGAN/TENOR NOMINAL" class="fikyseparator form-control inform ratakanan c_hold" type="text" MAXLENGTH="18" style="text-transform:uppercase;" >  <!-- onkeyup="formatangkaobjek(this)"-->
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input onClick="this.select();" name="sisa" placeholder="SISA / KURANG BAYAR" class="fikyseparator form-control inform ratakanan c_hold" type="text" MAXLENGTH="18" style="text-transform:uppercase;" >  <!-- onkeyup="formatangkaobjek(this)"-->
                                <span class="help-block"></span>
                            </div>
                        </div>
                       <!-- <div class="form-group">
...
//        live: 'disabled',
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('pinjaman/pinjaman/list_mpinjaman')?>",
                "type": "POST",
    ...
    function add_pinjaman()
    {
        ...
        $('.modal-title').text('Input Data Pinjaman'); // Set Title to Bootstrap modal title
        $('[name="type"]').val('INPUT');
        $('[name="docno"]').val('').prop("readonly", true);
        $('[name="nik"]').selectize()[0].selectize.setValue('',true);
        $('[name="description"]').val('').prop("readonly", false);
        $('[name="tgl"]').datepicker().datepicker("setDate", new Date()).prop("disabled", false);
        $('[name="nominal"]').val('').prop("readonly", false);
        $('[name="tenor"]').val('').prop("readonly", false);
        $('[name="npotong"]').val('').prop("readonly", false);
        $('[name="sisa"]').val('').prop("readonly", true);
        $('#nik').selectize()[0].selectize.enable();
    ...
    function ubah_pinjaman(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                var v_tenor = (data.tenor != null ? Math.round(data.tenor.replace(',','.')) : "0");
                ...
                $('[name="tenor"]').val(v_tenor).prop("readonly", false);
