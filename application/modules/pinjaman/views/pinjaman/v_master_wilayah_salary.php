                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">PILIH KODE WILAYAH</label>
                            <div class="col-md-9">
                                <select name="kdwilayah" class="form-control c_hold inform focusnya" style="text-transform:uppercase;" required>
                                    <option value="">--Pilih Wilayah--</option>
                                    <?php foreach($listwilayah as $lw){?>
                                    <option value="<?php echo trim($lw->kdwilayah);?>"> <?php echo trim($lw->nmwilayah);?> </option>
                                    <?php }?>
                                </select>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">KODE RANGE WILAYAH</label>
                            <div class="col-md-9">
                                <input name="kdwilayahnominal" placeholder="KODE RANGE WILAYAH" class="form-control " type="text" style="text-transform:uppercase;" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">NAMA RANGE WILAYAH</label>
                            <div class="col-md-9">
                                <input onClick="this.select();" name="nmwilayahnominal" placeholder="NAMA RANGEWILAYAH" class="form-control inform c_hold" type="text" MAXLENGTH="30" style="text-transform:uppercase;" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="golongan" class="form-control inform c_hold" style="text-transform:uppercase;" required>
...
//        live: 'disabled',
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('payroll/master/list_maswil_salary')?>",
                "type": "POST",
    ...
    function ubah_wilayah(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('payroll/master/show_edit_wilayah_salary/')?>/" + id,
            type: "GET",
            dataType: "JSON",
