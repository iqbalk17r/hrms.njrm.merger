                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input onClick="this.select();" name="nmmasakerja" placeholder="NAMA MASA KERJA" class="form-control inform c_hold" type="text" MAXLENGTH="30" style="text-transform:uppercase;" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                       <div class="form-group">
