							...
							<div class="col-sm-12">
									...
									<div class="col-sm-6 ">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
													<select type="text" name="neglahir" id='negara' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_neg as $lon){ ?>
																			<option value="<?php echo $dtlpel['neglahir'];?>"><?php echo trim($lon->namanegara);?></option>																																																			
																			<?php };?>
													</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
													<select type="text" name="provlahir" id='provinsi' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_prov as $lon){ ?>
																			<option value="<?php echo $dtlpel['provlahir'];?>" class="<?php echo trim($lon->kodenegara);?>"><?php echo trim($lon->namaprov);?></option>
																			<?php };?>
													</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
													<select type="text" name="kotalahir" id='kotakab' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_kotakab as $lon){ ?>
																			<option value="<?php echo $dtlpel['kotalahir'];?>" class="<?php echo trim($lon->kodeprov);?>"><?php echo trim($lon->namakotakab);?></option>																																																			
																			<?php };?>
													</select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-9">
													<select type="text" name="kdagama" id='kdagama' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_agama as $loa){ ?>
																			<option value="<?php echo $dtlpel['kd_agama'];?>" ><?php echo trim($loa->nmagama);?></option>																																																		
																			<?php };?>
													</select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-9">
													<select type="text" name="status_pernikahan" id='kdagama' class="form-control col-sm-12" readonly disabled>										
														<?php foreach ($list_opt_nikah as $lonikah){ ?>
														<option value="<?php echo $dtlpel['status_pernikahan'];?>" ><?php echo trim($lonikah->nmnikah);?></option>																																																			
														<?php };?>	
													</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
													<select type="text" name="provtinggal" id='provtinggal' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_prov as $lon){ ?>
																			<option value="<?php echo $dtlpel['provtinggal'];?>" class="<?php echo trim($lon->kodenegara);?>"><?php echo trim($lon->namaprov);?></option>
																			<?php };?>
													</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
													<select type="text" name="kotatinggal" id='kotakabtinggal' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_kotakab as $lon){ ?>
																			<option value="<?php echo $dtlpel['kotatinggal'];?>" class="<?php echo trim($lon->kodeprov);?>"><?php echo trim($lon->namakotakab);?></option>																																																			
																			<?php };?>
													</select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
													<select type="text" name="kecamatan" id='kecamatan' class="form-control col-sm-12" readonly disabled>										
																			<?php foreach ($list_opt_kecamatan as $lon){ ?>
																			<option value="<?php echo $dtlpel['kectinggal'];?>" class="<?php echo trim($lon->kodekotakab);?>"><?php echo trim($lon->namakec);?></option>																																																			
																			<?php };?>
													</select>
											</div>
										</div>
