...
<script>
$(function() {
$("#provinsilahir").chained("#negara");								
							
$("#kotakablahir").chained("#provinsilahir");								
$("#kotakabtinggal").chained("#provtinggal");								
$("#kecamatantinggal").chained("#kotakabtinggal");	
...
<div class="col-sm-6 ">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<select type="text" name="provlahir" id='provinsilahir' class="form-control col-sm-12" required>										
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<select type="text" name="kotalahir" id='kotakablahir' class="form-control col-sm-12" required>										
												<option value="9999999">--Tidak Ada Di Daftar--</option>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
						<select type="text" name="kotatinggal" id='kotakabtinggal' class="form-control col-sm-12" required>										
													<option value="99999">--Tidak Ada Di Daftar--</option>
												<?php foreach ($list_opt_kotakab as $lon){ ?>
												<option value="<?php echo trim($lon->kodekotakab);?>" class="<?php echo trim($lon->kodeprov);?>"><?php echo trim($lon->namakotakab);?></option>																																																			
												<?php };?>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
						<select type="text" name="kecamatan" id='kecamatantinggal' class="form-control col-sm-12" required>										
												<option value="9999999">--Tidak Ada Di Daftar--</option>
