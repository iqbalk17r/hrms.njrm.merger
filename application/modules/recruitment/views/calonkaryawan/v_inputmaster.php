...
<div class="col-sm-6 ">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<select type="text" name="status_pernikahan" id='stsnikah' class="form-control col-sm-12" required>										
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<select type="text" name="posisi_awal" id='posisi_awal' class="form-control col-sm-12" required>										
												<?php foreach ($list_jabatan as $lon){ ?>
												<option value="<?php echo trim($lon->kdjabatan);?>" class="<?php echo trim($lon->kdjabatan);?>"><?php echo trim($lon->nmjabatan);?></option>																																																			
												
												<?php };?>
												<option value="ZZ" >LAINNYA</option>
						</select>
				</div>
			</div>
			<div class="form-group lainnya">
				 <label class="control-label col-sm-3">Posisi Lainnya</label>
				<div class="col-sm-8">

						<input type="text" id="posisi_lain" name="posisi_lain"  maxlength="30" style="text-transform:uppercase" class="form-control">
					...
					<div class="form-group">
				 <label class="control-label col-sm-3">Tanggal Lowongan</label>
				<div class="col-sm-9">

						<input type="text" id="tgllowongan" name="tgllowongan" data-date-format="dd-mm-yyyy"  class="form-control tgl" required>
					
					<!-- /.input group -->
				</div>
			</div>
			<div class="form-group">
				 <label class="control-label col-sm-3">Tanggal Lamaran</label>
				<div class="col-sm-9">

						<input type="text" id="tgllamaran" name="tgllamaran" data-date-format="dd-mm-yyyy"  class="form-control tgl" required>
				...
				<div class="col-sm-12">
				  ...
				  <div class="col-sm-12">
								...
								<div class="form-group">
									  ...
									  <div class="col-sm-9">
										<input type="text" id="kddept" name="pdk_nmsekolah[]"  class="form-control" style="text-transform:uppercase" maxlength="40" >
									  </div>
								</div>
								<div class="form-group">
									  <label class="control-label col-sm-3">Kota/ Kab.</label>
									  <div class="col-sm-9">
										<input type="text" id="kddept" name="pdk_kotakab[]"  class="form-control" style="text-transform:uppercase" maxlength="30" >
									  </div>
								</div>
								<div class="form-group">
									  <label class="control-label col-sm-3">Jurusan</label>
									  <div class="col-sm-9">
										<input type="text" id="kddept" name="pdk_jurusan[]"  class="form-control" style="text-transform:uppercase" maxlength="30" >
									  </div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-8">    
											<input type="text" id="kddept" name="pdk_program_studi[]"  class="form-control" style="text-transform:uppercase" maxlength="30" >
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Tahun Masuk</label>	
										<div class="col-sm-8">    
											<input type="text" id="year" name="pdk_tahun_masuk[]" class="form-control year" >
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Tahun Lulus</label>	
										<div class="col-sm-8">    
											<input type="text" id="year" name="pdk_tahun_keluar[]" class="form-control year" >
										</div>
									</div>
									<div class="form-group">
									  <label class="control-label col-sm-3">Nilai/ IPK.</label>
									  <div class="col-sm-8">
										<input type="text" name="pdk_nilai[]"  class="form-control" placeholder="0" >
									  </div>
									</div>
									<div class="form-group">
				...
				<div class="col-sm-12">
				  ...
				  <div class="col-sm-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">    
									<input type="text" id="kddept" name="pkj_nmperusahaan[]"  class="form-control" style="text-transform:uppercase" maxlength="50" >
								</div>
							</div>		
							<div class="form-group">
								<label class="control-label col-sm-3">Bidang Usaha</label>	
								<div class="col-sm-9">    
									<input type="text" id="kddept" name="pkj_bidang_usaha[]"  class="form-control" style="text-transform:uppercase" maxlength="40" >
								</div>
							</div>		
							...
							<div class="form-group">
								...
								<div class="col-sm-9">    
									<input type="text" id="tgl" name="pkj_tahun_masuk[]" data-date-format="dd-mm-yyyy" class="form-control tgl" >
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3">Tanggal Keluar</label>	
								<div class="col-sm-9">    
									<input type="text" id="tgl" name="pkj_tahun_keluar[]" data-date-format="dd-mm-yyyy" class="form-control tgl" >
								</div>
							</div>
